/* Class38_Sub23 - Decompiled by JODE
...
class RS2Buffer extends Node {
        ...
        try {
            if (i_57_ != -9034)
                RS2Buffer.method758(55, -127, null, -60, 97, 62, null, 98, 81,
                        -15);
            if (i == -3) {
                Class77.method551(false, Class10.aClass19_175, Class38_Sub20_Sub11.aClass19_2932, Entity.aClass19_3509);
            } else {
                if (i == -2)
    ...
    final void writeString(RSString class19, byte i) {
        try {
            this.pos += class19.method138((byte) -126, this.pos, 0, class19.method143((byte) 59), this.buffer);
