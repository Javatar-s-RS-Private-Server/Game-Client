/* Class38_Sub20_Sub17 - Decompiled by JODE
...
final class Class38_Sub20_Sub17 extends NodeSub {
	...
	static final int method1033(int i, boolean bool, int i_4_) {
		try {
			...
			if (i_4_ >= 2) {
				int i_5_ = Class38_Sub20_Sub17.method1033(i * i, false, i_4_ >> 1);
				if ((i_4_ & 0x1) != 0)
					i_5_ *= i;
				return i_5_;
			}
					...
					for (int i_15_ = (regionY - 6) / 8; (regionY + 6) / 8 >= i_15_; i_15_++)
						for (int i_16_ = (regionX - 6) / 8; (regionX + 6) / 8 >= i_16_; i_16_++) {
							...
							if (!bool_13_ || i_16_ != 49 && i_16_ != 149 && i_16_ != 147 && i_15_ != 50 && (i_15_ != 49 || i_16_ != 47)) {
								...
								Class72.anIntArray1409[i_9_] = Class48.indexMaps.method104(3, Class9.method43(new RSString[] { Class38_Sub6.aClass19_1880, RuntimeException_Sub1.method1098(i_15_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_16_, 0) }, (byte) -20));
								Class51.anIntArray1131[i_9_] = Class48.indexMaps.method104(3, Class9.method43(new RSString[] { Class77.aClass19_1528, RuntimeException_Sub1.method1098(i_15_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_16_, 0) }, (byte) -20));
								i_9_++;
							}
						}
							...
							for (int i_32_ = 0; i_32_ < 13; i_32_++) {
								...
								if (i_33_ != -1) {
									...
									if (i_36_ != -1) {
										...
										Class72.anIntArray1409[i_26_] = Class48.indexMaps.method104(3, Class9.method43(new RSString[] { Class38_Sub6.aClass19_1880, RuntimeException_Sub1.method1098(i_39_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_38_, 0) }, (byte) -20));
										Class51.anIntArray1131[i_26_] = Class48.indexMaps.method104(3, Class9.method43(new RSString[] { Class77.aClass19_1528, RuntimeException_Sub1.method1098(i_39_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_38_, 0) }, (byte) -20));
										i_26_++;
									}
								}
							}
