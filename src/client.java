...
public final class client extends Applet_Sub1 {
	...
	static PacketBuffer secureBuffer = new PacketBuffer(5000);
	...
	static boolean method1229(int i, Class38_Sub6 class38_sub6) {
		try {
			...
			if (i_22_ == 326) {
				...
				Class38_Sub20_Sub15.aClass18_3072.method125(client.secureBuffer, -123);
				return true;
			}
			if (i >= -124)
				client.anInt3652 = -55;
	...
	static boolean parsePacket(int i) {
		try {
			...
			try {
				...
				if (Class23.packetId == 4) {
					...
					long l_164_ = Class15.inputStream.readLong(i - 30810);
	...
	private void method1230(boolean bool) {
		do {
			try {
