/* Class38_Sub21 - Decompiled by JODE
		...
		try {
			if (Class74.aBool1448)
				...
				if (client.lastMouseAction == 1 && Class73.anInt1429 >= 715 && RS2Buffer.anInt2416 >= 453) {
					...
					if (!Class17.aBool355)
						Class4.method24(Class51.aClass19_1132, Class67.indexTrack1, false, 255, Class38_Sub18.aClass19_2202, (byte) -122);
					else
									...
									while (Class32.method300((byte) 65)) {
										...
										if (Class50.anInt1106 == 0) {
											...
											if (bool && Class51.username.method143((byte) 50) < 12)
												Class51.username = Class51.username.method180(255, Class10.anInt181);
											...
											if (bool && Class51.password.method143((byte) 84) < 20)
												Class51.password = Class51.password.method180(255, Class10.anInt181);
										}
									}
								}
							}
