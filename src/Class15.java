				...
				if (i <= -65) {
					...
					try {
															...
															if (i_4_ < 4100) {
																...
																if (i_4_ == 5000)
																	...
																	if (class19.method165(Class48.aClass19_1065, true))
																		...
																		Class38_Sub4.method627(class19, (byte) -48, client.secureBuffer);
																	...
																	client.secureBuffer.writeLong(class19.method162(0));
																	Class38_Sub4.method627(class19_148_, (byte) -48, client.secureBuffer);
						...
						if (class38_sub20_sub10.aClass19_2894 != null) {
							...
							Class38_Sub20_Sub2.method813(exception, "CS2 - scr:" + class38_sub20_sub10.aLong898 + " op:" + i_4_ + new String(class19.method158(122)), 95);
						} else {
							if (Player.anInt3582 != 0)
								Class62.method464((byte) 98, Class74.aClass19_1464, 0, RuntimeException_Sub1.aClass19_3287);
							Class38_Sub20_Sub2.method813(exception, "CS2 - scr:" + class38_sub20_sub10.aLong898 + " op:" + i_4_, 95);
						}
					}
				}
			}
