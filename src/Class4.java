...
final class Class4 {
	...
	static final void method25(int i) {
		try {
			...
			Class38_Sub14.indexFrames.method117(-4134);
			Class38_Sub11.indexFramemaps.method117(-4134);
			RS2Buffer.indexWidgets.method117(-4134);
			Class33.soundEffects.method117(-4134);
			Class48.indexMaps.method117(-4134);
			Class67.indexTrack1.method117(-4134);
			Class30.indexModels.method117(-4134);
			Class17.indexSprites.method117(-4134);
			Applet_Sub1.indexTextures.method117(-4134);
			Class52.indexBinary.method117(-4134);
			Class38_Sub1.indexTrack2.method117(-4134);
			Class38_Sub1.indexScripts.method117(-4134);
			int i_7_ = 27 / ((i + 44) / 40);
		} catch (RuntimeException runtimeexception) {
		...
		do {
			try {
				if (i == -1 && !Class76.aBool1490)
					...
					Class23.method203(true, Class67.indexTrack1, Class15.anInt302, false, 0, 2, i);
