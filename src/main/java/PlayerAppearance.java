/* PlayerAppearance - Decompiled by JODE
...
final class PlayerAppearance {
	...
	static final void method129(int i, int i_3_, int i_4_) {
		try {
			long l = (i_3_ << -1182681456) + i_4_;
			int i_5_ = 36 / ((i + 3) / 35);
			Class38_Sub20_Sub2 class38_sub20_sub2 = (Class38_Sub20_Sub2) Class40.aClass14_914.method75(l, (byte) -106);
		...
		do {
			try {
				...
				if (anIntArray398[0] >= 256)
					aLong392 += anIntArray398[0] - 256 >> -1667928188;
				if (anIntArray398[1] >= 256)
					aLong392 += anIntArray398[1] - 256 >> 1548443752;
				...
				if (l == 0L || aLong392 == l)
					break;
				Class38_Sub11.aClass83_2105.method592(l, false);
			} catch (RuntimeException runtimeexception) {
	...
	final void method132(byte i, int i_13_, boolean bool) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "eb.I(" + i + ',' + i_13_ + ',' + bool + ')');
		}
	}
	...
	final Class38_Sub20_Sub3_Sub1 method136(Class38_Sub20_Sub4 class38_sub20_sub4, int i, Class38_Sub20_Sub4 class38_sub20_sub4_28_, int i_29_, int i_30_) {
		try {
			if (anInt404 != -1)
			...
			if (class38_sub20_sub4 != null && (class38_sub20_sub4.anInt2582 >= 0 || class38_sub20_sub4.anInt2558 >= 0)) {
				...
				if (class38_sub20_sub4.anInt2582 >= 0) {
					l += class38_sub20_sub4.anInt2582 - anIntArray398[5] << 1367436648;
					is[5] = class38_sub20_sub4.anInt2582;
				}
				if (class38_sub20_sub4.anInt2558 >= 0) {
					l += -anIntArray398[3] + class38_sub20_sub4.anInt2558 << -1544658064;
			...
			if (class38_sub20_sub3_sub1 == null) {
				...
				for (int i_32_ = 0; i_32_ < 12; i_32_++) {
					...
					if (i_33_ >= 256 && i_33_ < 512 && !Class48.method387((byte) 98, i_33_ - 256).method1021(125))
						bool = true;
					if (i_33_ >= 512 && !Node.forId(i_33_ - 512, 87).method934(this.aBool410, i_29_ ^ 0x7b08))
						bool = true;
				}
				if (bool) {
					if (aLong405 != -1L)
				...
				if (class38_sub20_sub3_sub1 == null) {
					...
					for (int i_35_ = 0; i_35_ < 12; i_35_++) {
						...
						if (i_36_ >= 512) {
							Model class38_sub20_sub3_sub3 = Node.forId(i_36_ - 512, i_29_ + 5836).method924(-19319, this.aBool410);
							if (class38_sub20_sub3_sub3 != null)
								class38_sub20_sub3_sub3s[i_34_++] = class38_sub20_sub3_sub3;
						}
					}
	...
	final int method137(int i) {
		try {
			...
			if (anInt404 == -1)
				return (anIntArray398[0] << 1127741711) + (anIntArray401[0] << 1009931065) + (anIntArray401[4] << 1190665620) + (anIntArray398[8] << -1790373782) - (-(anIntArray398[11] << 1984383237) - anIntArray398[1]);
	...
	static {
		...
		for (int i = 0; i < 256; i++) {
			...
			for (int i_41_ = 0; i_41_ < 8; i_41_++)
				if ((i_40_ & 0x1) == 1)
					i_40_ = ~0x12477cdf ^ i_40_ >>> -2090217535;
				else
					i_40_ >>>= 1;
