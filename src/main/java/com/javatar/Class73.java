package com.javatar;/* Class73 - Decompiled by JODE
...
abstract class Class73 {
	...
	static final void method515(byte i) {
		do {
			try {
				int i_0_ = Class15.inputStream.method785(8);
				...
				for (int i_2_ = 0; i_0_ > i_2_; i_2_++) {
					...
					if (i_4_ == 0) {
						...
						int i_5_ = Class15.inputStream.method785(2);
						if (i_5_ == 0) {
							Class47.anIntArray1055[ItemDefinition.anInt2783++] = i_3_;
							entity.anInt3459 = Class45.anInt1016;
	...
	static final void method516(Class17 class17) {
		try {
			if (8 != 8)
