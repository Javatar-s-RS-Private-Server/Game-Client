package com.javatar;/* Class38_Sub20_Sub2 - Decompiled by JODE
...
final class Class38_Sub20_Sub2 extends NodeSub {
	...
	static final void method813(Throwable throwable, String string) {
		do {
			try {
				String string_0_ = "";
				if (throwable != null)
					string_0_ = Class79.method577(throwable);
				if (string != null) {
					if (throwable != null)
						string_0_ += " | ";
					string_0_ += string;
				...
				string_0_ = string_0_.replace('@', (char) 95);
				...
				if (Class23.aClass56_552.anApplet1242 != null) {
					...
					while (class65.anInt1368 == 0)
						Canvas_Sub1.method809(1L, 95 ^ ~0x6a42);
	...
	static final void method814() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "pf.E(" + -4 + ')');
			}
			break;
		} while (false);
	}

	static final void method815() {
		do {
			try {
				if (false)
				...
				throw Class38_Sub1.method607(runtimeexception, "pf.G(" + false + ')');
			}
			break;
		} while (false);
	}
