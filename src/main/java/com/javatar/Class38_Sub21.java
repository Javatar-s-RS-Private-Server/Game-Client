package com.javatar;/* Class38_Sub21 - Decompiled by JODE
...
final class Class38_Sub21 extends Node {
	...
	static final void method712(long l) {
		try {
			if (l != 0L)
				if (Class38_Sub20_Sub3_Sub2.anInt3250 >= 100)
					Class62.method464(Class38_Sub3.aClass19_1789, 0, Class38_Sub22.aClass19_2312);
				else {
					...
					for (int i_1_ = 0; i_1_ < Class38_Sub20_Sub3_Sub2.anInt3250; i_1_++)
						if (Class5.aLongArray97[i_1_] == l) {
							Class62.method464(Class9.method43(new RSString[]{class19, Class38_Sub20_Sub17.aClass19_3116}, (byte) -20), 0, Class38_Sub22.aClass19_2312);
							return;
						}
			...
			throw Class38_Sub1.method607(runtimeexception, "da.F(" + 31 + ',' + l + ')');
		}
	}

	static final void method713(Applet_Sub1 applet_sub1) {
		try {
						...
						if ((byte) 93 == 93) {
							...
							if (Class55.anInt1228 == 0) {
								...
								if (i_7_ == 1 && i_14_ - 75 <= i_9_ && i_14_ + 75 >= i_9_ && i_16_ - 20 <= i_8_ && i_8_ <= i_16_ + 20) {
									Class51.username = Class51.username.method147((byte) 117).method167((byte) 52);
									if (Class51.username.method143((byte) 15) == 0)
										Class77.method551(Class38_Sub20_Sub11.aClass19_2970, Class38_Sub20_Sub11.aClass19_2913, Class38_Sub9.aClass19_2068);
									else if (Class51.password.method143((byte) 107) == 0)
										Class77.method551(Class38_Sub20_Sub11.aClass19_2959, Class38_Sub20_Sub11.aClass19_2971, Class38_Sub20_Sub3_Sub5.aClass19_3387);
									else {
										Class77.method551(Class38_Sub20_Sub11.aClass19_2927, Class38_Sub20_Sub11.aClass19_2953, Class11.aClass19_201);
									...
									if (i_7_ == 1 && i_14_ - 75 <= i_9_ && i_14_ + 75 >= i_9_ && i_16_ - 20 <= i_8_ && i_16_ + 20 >= i_8_) {
										...
										Class55.anInt1228 = 0;
										Class51.username = Class51.aClass19_1132;
									}
									while (Class32.method300((byte) 65)) {
										...
										if (Class50.anInt1106 == 0) {
											if (NodeSub.anInt2256 == 85 && Class51.username.method143((byte) 99) > 0)
												Class51.username = Class51.username.method144((byte) 32, 0, Class51.username.method143((byte) 104) - 1);
											if (NodeSub.anInt2256 == 84 || NodeSub.anInt2256 == 80)
												Class50.anInt1106 = 1;
											if (bool && Class51.username.method143((byte) 50) < 12)
												Class51.username = Class51.username.method180(Class10.anInt181);
										} else if (Class50.anInt1106 == 1) {
											if (NodeSub.anInt2256 == 85 && Class51.password.method143((byte) 85) > 0)
												Class51.password = Class51.password.method144((byte) 4, 0, Class51.password.method143((byte) 52) - 1);
											if (NodeSub.anInt2256 == 84 || NodeSub.anInt2256 == 80)
												Class50.anInt1106 = 0;
											if (Player.anInt3582 == 2 && NodeSub.anInt2256 == 84) {
												Class51.username = Class51.username.method147((byte) 121).method167((byte) 52);
												if (Class51.username.method143((byte) 115) == 0)
													Class77.method551(Class38_Sub20_Sub11.aClass19_2970, Class38_Sub20_Sub11.aClass19_2913, Class38_Sub9.aClass19_2068);
												else {
													if (Class51.password.method143((byte) 82) == 0)
														Class77.method551(Class38_Sub20_Sub11.aClass19_2959, Class38_Sub20_Sub11.aClass19_2971, Class38_Sub20_Sub3_Sub5.aClass19_3387);
													else {
														Class77.method551(Class38_Sub20_Sub11.aClass19_2927, Class38_Sub20_Sub11.aClass19_2953, Class11.aClass19_201);
														Canvas_Sub1.method808(0, 20);
											...
											if (bool && Class51.password.method143((byte) 84) < 20)
												Class51.password = Class51.password.method180(Class10.anInt181);
										}
									}
								}
							}
			...
			throw Class38_Sub1.method607(runtimeexception, "da.E(" + (byte) 93 + ',' + (applet_sub1 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final void method715() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "da.C(" + (byte) -120 + ')');
		}
	}

	static final int method716(int i_19_, int i_20_) {
		try {
			int i_21_ = -35 / ((111 - 51) / 39);
			int i_22_ = 0;
			for (/**/; i_20_ > 0; i_20_--) {
				i_22_ = i_19_ & 0x1 | i_22_ << 1;
				i_19_ >>>= 1;
			}
			return i_22_;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "da.D(" + 111 + ',' + i_19_ + ',' + i_20_ + ')');
		}
	}
}
