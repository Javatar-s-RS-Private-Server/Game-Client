package com.javatar;/* NodeSub - Decompiled by JODE
...
class NodeSub extends Node {
	...
	static final void method710(boolean bool, int i_2_) {
		try {
			...
			Class38_Sub20_Sub7.anInt2852 = 22050;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "be.D(" + bool + ',' + 22050 + ',' + i_2_ + ',' + 2 + ')');
		}
	}

	final void method707() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "be.A(" + false + ')');
		}
	}
}
