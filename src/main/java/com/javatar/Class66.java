package com.javatar;/* Class66 - Decompiled by JODE
...
final class Class66 {
	...
	static final void method476(Class17 class17, Class17 class17_0_, boolean bool, Class38_Sub20_Sub9_Sub1_Sub1 class38_sub20_sub9_sub1_sub1) {
		try {
			...
			Class38_Sub10_Sub3.aClass17_2833.method103(10);
			Canvas_Sub1.aClass38_Sub20_Sub9_Sub1_Sub1_2525 = class38_sub20_sub9_sub1_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "cd.B(" + (class17 != null ? "{...}" : "null") + ',' + (class17_0_ != null ? "{...}" : "null") + ',' + bool + ',' + (class38_sub20_sub9_sub1_sub1 != null ? "{...}" : "null") + ',' + (byte) 78 + ')');
		}
	}
}
