package com.javatar;/* Class17_Sub1 - Decompiled by JODE
...
final class Class17_Sub1 extends Class17 {
	...
	private final Class48 aClass48_1699;
	...
	final void method597(boolean bool, int i, boolean bool_0_, byte[] is) {
		do {
			try {
				if (bool_0_) {
					if (aBool1692)
					...
					if (aClass48_1703 != null)
						Class21.method194(aClass48_1703, anInt1693, is);
					method112(is);
					method603(-93);
				} else {
					is[is.length - 2] = (byte) (this.anIntArray349[i] >> 8);
					is[is.length - 1] = (byte) this.anIntArray349[i];
					if (aClass48_1699 != null) {
						Class21.method194(aClass48_1699, i, is);
						aBoolArray1715[i] = true;
					}
					if (bool)
						this.anObjectArray346[i] = Class38_Sub18.method697(-127, is, false);
				}
				if (!false)
					break;
				aClass48_1703 = null;
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "ga.G(" + bool + ',' + i + ',' + bool_0_ + ',' + false + ',' + (is != null ? "{...}" : "null") + ')');
			}
			break;
		} while (false);
	}
	...
	@Override
	final void method108(int i_2_) {
		do {
			try {
				PlayerAppearance.method129(anInt1693, i_2_);
				if ((byte) -99 == -99)
					break;
				Class17_Sub1.method604(-12, -99);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "ga.C(" + (byte) -99 + ',' + i_2_ + ')');
			}
			break;
		} while (false);
	}
	...
	final int method600(int i) {
		try {
			if (aBool1692)
				return 100;
			if (this.anObjectArray346 != null)
				return 99;
			if (i != 20181)
				Class17_Sub1.method604(-89, -15);
			int i_8_ = ItemDefinition.method933(anInt1693, 255);
			if (i_8_ >= 100)
				i_8_ = 99;
			return i_8_;
		} catch (RuntimeException runtimeexception) {
	...
	private int method601(int i_9_) {
		try {
			if (this.anObjectArray346[i_9_] != null)
				return 100;
			int i_10_ = 71 / (((byte) -110 + 49) / 33);
			if (aBoolArray1715[i_9_])
				return 100;
			return ItemDefinition.method933(i_9_, anInt1693);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ga.K(" + (byte) -110 + ',' + i_9_ + ')');
		}
	}

	final void method602(boolean bool_11_, byte[] is, int i, Class48 class48) {
		try {
			if (false)
				method603(55);
			if (aClass48_1703 != class48) {
				...
				if (is == null || is.length <= 2) {
					...
					if (aBool1702 || bool_11_)
						Class61.method458(bool_11_, (byte) -128, (byte) 2, i, anInt1693, this, this.anIntArray368[i]);
				} else {
					Class48.aCRC32_1075.reset();
					Class48.aCRC32_1075.update(is, 0, is.length - 2);
					int i_12_ = (int) Class48.aCRC32_1075.getValue();
					int i_13_ = (is[is.length - 1] & 0xff) + (is[is.length - 2] << 8 & 0xff00);
					if (this.anIntArray368[i] != i_12_ || this.anIntArray349[i] != i_13_) {
						aBoolArray1715[i] = false;
						if (aBool1702 || bool_11_)
							Class61.method458(bool_11_, (byte) -126, (byte) 2, i, anInt1693, this, this.anIntArray368[i]);
					} else {
						aBoolArray1715[i] = true;
						if (bool_11_)
							this.anObjectArray346[i] = Class38_Sub18.method697(67, is, false);
					}
				}
			} else {
				if (aBool1692)
			...
			throw Class38_Sub1.method607(runtimeexception, "ga.A(" + false + ',' + bool_11_ + ',' + (is != null ? "{...}" : "null") + ',' + i + ',' + (class48 != null ? "{...}" : "null") + ')');
		}
	}

	private void method603(int i) {
		do {
			try {
				aBoolArray1715 = new boolean[this.anObjectArray346.length];
		...
		do {
			try {
				if (aClass48_1699 != null && aBoolArray1715 != null && aBoolArray1715[i])
					Class28.method271(5 ^ 0x6b, i, this, aClass48_1699);
				else
					Class61.method458(true, (byte) -107, (byte) 2, i, anInt1693, this, this.anIntArray368[i]);
				if (5 == 5)
					break;
				method605(89);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "ga.J(" + i + ',' + 5 + ')');
			}
			break;
		} while (false);
	}
	...
	final int method605(int i) {
		try {
			int i_21_ = 0;
			int i_22_ = i;
			for (int i_23_ = 0; i_23_ < this.anObjectArray346.length; i_23_++)
				if (this.anIntArray352[i_23_] > 0) {
					i_21_ += method601(i_23_);
					i_22_ += 100;
				}
			if (i_22_ == 0)
				return 100;
			return i_21_ * 100 / i_22_;
		} catch (RuntimeException runtimeexception) {
