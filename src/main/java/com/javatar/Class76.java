package com.javatar;/* Class76 - Decompiled by JODE
...
final class Class76 {
	...
	static final Class38_Sub20_Sub9_Sub1_Sub1 method542(byte i, Class17 class17, Class17 class17_0_, RSString class19, RSString class19_1_) {
		try {
			int i_2_ = class17.method104(class19_1_);
			if (i > -7)
	...
	static final void method544(Class17 class17, Class17 class17_4_, Component component) {
		try {
			if (!Class38_Sub20_Sub3_Sub5.aBool3389) {
				...
				Class38_Sub1.aClass38_Sub20_Sub9_Sub2_1740 = Class38_Sub20_Sub3_Sub5.method1160(Class51.aClass19_1132, class17_4_, RSString.aClass19_436);
				Class38_Sub20_Sub17.aClass38_Sub20_Sub9_Sub2_3128 = Class38_Sub20_Sub3_Sub5.method1160(Class51.aClass19_1132, class17_4_, Class79.str_titleBox);
				Class60.aClass38_Sub20_Sub9_Sub2_1317 = Class38_Sub20_Sub3_Sub5.method1160(Class51.aClass19_1132, class17_4_, Entity.aClass19_3506);
				...
				Class17.aBool355 = Class15.anInt302 == 0;
				Class55.anInt1228 = 0;
				...
				if (Class17.aBool355)
					...
					Class52.method408(Class67.indexTrack1, Class38_Sub18.aClass19_2202, Class51.aClass19_1132);
				Class44.method367((byte) -106 + 106, false);
			...
			throw Class38_Sub1.method607(runtimeexception, "qa.E(" + (class17 != null ? "{...}" : "null") + ',' + (byte) -106 + ',' + (class17_4_ != null ? "{...}" : "null") + ',' + (component != null ? "{...}" : "null") + ')');
		}
	}

	static final void method545(int i) {
		do {
			try {
				Applet_Sub1.method1218((byte) -93);
				Class42.method358();
				if (-2 == -2) {
					int i_18_ = Class37.method326(i).anInt3063;
					if (i_18_ != 0) {
						...
						if (i_18_ == 1) {
							...
							if (i_19_ == 2) {
								...
								((Class45) Class38_Sub20_Sub9_Sub4.anInterface3_3533).method376(-2 ^ 0x77, 0.8);
							}
							if (i_19_ == 3) {
						...
						if (i_18_ == 3) {
							...
							if (Class15.anInt302 != i_20_) {
								if (Class15.anInt302 == 0 && Class38_Sub19.anInt2238 != -1) {
									Class38_Sub4.method628(Class67.indexTrack1, -1, Class38_Sub19.anInt2238, i_20_, false, 0);
									Class76.aBool1490 = false;
								} else if (i_20_ != 0)
									Class79.method574(i_20_);
								else {
									Class79.method571();
									Class76.aBool1490 = false;
								}
				...
				throw Class38_Sub1.method607(runtimeexception, "qa.A(" + i + ',' + -2 + ')');
			}
			break;
		} while (false);
	}
	...
	static final int method546() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "qa.B(" + -104 + ')');
		}
	}

	static final synchronized byte[] method547(int i) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "qa.F(" + true + ',' + i + ')');
		}
	}
}
