package com.javatar;/* Class38_Sub20_Sub3_Sub4 - Decompiled by JODE
...
final class Class38_Sub20_Sub3_Sub4 extends SceneModel {
	...
	static final int method1151(int i, int i_0_) {
		try {
			if (i < i_0_) {
				int i_2_ = i;
				i = i_0_;
			...
			throw Class38_Sub1.method607(runtimeexception, "cb.F(" + i + ',' + i_0_ + ',' + -103 + ')');
		}
	}
	...
	static final void method1154() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "cb.I(" + 122 + ')');
			}
			break;
		} while (false);
	}
	...
	static final void method1155(int i, int i_8_, int i_10_, int i_11_) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "cb.J(" + i + ',' + i_8_ + ',' + 12504 + ',' + i_10_ + ',' + i_11_ + ')');
			}
			break;
		} while (false);
	}
	...
	static final Sequence method1156(int i, int i_16_) {
		try {
			...
			if (is != null)
				class38_sub20_sub5.method916(new RS2Buffer(is));
			class38_sub20_sub5.method920();
	...
	final Class38_Sub20_Sub3_Sub1 method820() {
		try {
			if ((byte) 109 != 109)
				Class38_Sub20_Sub3_Sub4.anIntArray3358 = null;
			return Node.forId(this.anInt3348, (byte) 109 - 2).method925(this.anInt3351, 0);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "cb.E(" + (byte) 109 + ')');
		}
	}
}
