package com.javatar;/* Class10 - Decompiled by JODE
	...
	static final void method53(SceneGraph class27, int i, int i_0_, int i_1_, int i_2_, Class74 class74, int i_3_, int i_4_, byte i_5_) {
		try {
			if (!Class38_Sub4.aBool1811 || (Class82.aByteArrayArrayArray1648[0][i_4_][i] & 0x2) != 0 || (Class82.aByteArrayArrayArray1648[i_3_][i_4_][i] & 0x10) == 0 && Class38_Sub20_Sub8.method949(i_3_, 115, i, i_4_) == Entity.anInt3489) {
				...
				int i_12_ = (i_6_ << 6) + (i_4_ << 7);
				int i_13_ = (i_7_ << 6) + (i << 7);
				int i_14_ = (i_1_ << 14) + (i << 7) + i_4_ + 1073741824;
				if (class38_sub20_sub1.anInt2440 == 0)
					i_14_ -= -2147483648;
				int i_15_ = is[i_8_][i_10_] + is[i_9_][i_10_] + is[i_9_][i_11_] + is[i_8_][i_11_] >> 2;
				int i_16_ = i_0_ + (i_2_ << 6);
				if (class38_sub20_sub1.anInt2499 == 1)
					i_16_ += 256;
				if (class38_sub20_sub1.method794())
				...
				if (i_0_ == 22) {
					if (!Class38_Sub4.aBool1811 || class38_sub20_sub1.anInt2440 != 0 || class38_sub20_sub1.anInt2482 == 1 || class38_sub20_sub1.aBool2451) {
						...
						if (class38_sub20_sub1.anInt2472 != -1 || class38_sub20_sub1.anIntArray2498 != null)
							...
							class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, 22);
						class27.method241(i_3_, i_4_, i, i_15_, class38_sub20_sub3, i_14_, i_16_);
						if (class38_sub20_sub1.anInt2482 == 1 && class74 != null)
							class74.method538(i_4_, i);
					}
				} else if (i_0_ == 10 || i_0_ == 11) {
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null)
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, 10);
					else
					...
					if (class38_sub20_sub1.anInt2482 != 0 && class74 != null)
						class74.method521(i_7_, class38_sub20_sub1.aBool2466, i_4_, i, i_6_);
				} else if (i_0_ >= 12) {
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null)
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, i_0_);
					else
					...
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null)
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, 0);
					else
					...
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null)
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, 1);
					else
					...
					if (class38_sub20_sub1.anInt2472 != -1 || class38_sub20_sub1.anIntArray2498 != null) {
						...
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_ + 4, is, i_12_, 2);
						class38_sub20_sub3_21_ = class38_sub20_sub1.method804(i_13_, i_15_, i_20_, is, i_12_, 2);
					}
					...
					if (class38_sub20_sub1.anInt2472 != -1 || class38_sub20_sub1.anIntArray2498 != null)
						...
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, 3);
					class27.method220(i_3_, i_4_, i, i_15_, class38_sub20_sub3, null, Class38_Sub20_Sub13.anIntArray3024[i_2_], 0, i_14_, i_16_);
					if (class38_sub20_sub1.aBool2500)
						if (i_2_ == 0)
							Class25.aByteArrayArrayArray583[i_3_][i_4_][i + 1] = (byte) 50;
					...
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null)
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_, is, i_12_, 4);
					else
					...
					if (i_23_ != 0)
						i_22_ = Class80.method581(123, i_23_ >> 14 & 0x7fff).anInt2492;
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 != -1 || class38_sub20_sub1.anIntArray2498 != null)
						class38_sub20_sub3 = new Class38_Sub20_Sub3_Sub2(i_1_, 4, i_2_, i_3_, i_4_, i, class38_sub20_sub1.anInt2472, true, null);
					else
					...
					if (i_25_ != 0)
						i_24_ = Class80.method581(i_5_ - 51, (i_25_ & 0x1fffc442) >> 14).anInt2492 / 2;
					SceneModel class38_sub20_sub3;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null)
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_ + 4, is, i_12_, 4);
					else
					...
					if (class38_sub20_sub1.anInt2472 != -1 || class38_sub20_sub1.anIntArray2498 != null)
						...
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_26_ + 4, is, i_12_, 4);
					...
					if (i_28_ != 0)
						i_27_ = Class80.method581(118, i_28_ >> 14 & 0x7fff).anInt2492 / 2;
					int i_29_ = i_2_ + 2 & 0x3;
					SceneModel class38_sub20_sub3;
					SceneModel class38_sub20_sub3_30_;
					if (class38_sub20_sub1.anInt2472 == -1 && class38_sub20_sub1.anIntArray2498 == null) {
						class38_sub20_sub3 = class38_sub20_sub1.method804(i_13_, i_15_, i_2_ + 4, is, i_12_, 4);
						class38_sub20_sub3_30_ = class38_sub20_sub1.method804(i_13_, i_15_, i_29_ + 4, is, i_12_, 4);
					} else {
						class38_sub20_sub3 = new Class38_Sub20_Sub3_Sub2(i_1_, 4, i_2_ + 4, i_3_, i_4_, i, class38_sub20_sub1.anInt2472, true, null);
