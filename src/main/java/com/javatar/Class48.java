package com.javatar;/* Class48 - Decompiled by JODE
...
final class Class48 {
	...
	static final Class38_Sub20_Sub16 method387(int i_9_) {
		try {
			if ((byte) 98 != 98)
				return null;
			...
			if (is != null)
				class38_sub20_sub16.method1023(new RS2Buffer(is));
			Class38_Sub9.aClass83_2062.method590(i_9_, (byte) -128, class38_sub20_sub16);
			return class38_sub20_sub16;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "tb.G(" + (byte) 98 + ',' + i_9_ + ')');
		}
	}
	...
	static final void method390(byte i, int i_12_, Player class38_sub20_sub3_sub7_sub2, int i_13_) {
		try {
			if (i_13_ != class38_sub20_sub3_sub7_sub2.currentAnimationId || i_13_ == -1) {
				if (i_13_ == -1 || class38_sub20_sub3_sub7_sub2.currentAnimationId == -1 || Sequence.forID((byte) 123, i_13_).anInt2576 >= Sequence.forID((byte) 119, class38_sub20_sub3_sub7_sub2.currentAnimationId).anInt2576) {
					class38_sub20_sub3_sub7_sub2.anInt3494 = class38_sub20_sub3_sub7_sub2.walkQueueLocationIndex;
					class38_sub20_sub3_sub7_sub2.anInt3461 = i_12_;
					class38_sub20_sub3_sub7_sub2.anInt3471 = 0;
					class38_sub20_sub3_sub7_sub2.anInt3460 = 0;
					class38_sub20_sub3_sub7_sub2.anInt3483 = 0;
					class38_sub20_sub3_sub7_sub2.currentAnimationId = i_13_;
				}
			} else {
			...
			if (i_28_ == -32565)
				if (i_31_ < 0 || i_31_ >= 104 || i_30_ < 0 || i_30_ >= 104)
					...
					for (;;) {
						...
						if (i_34_ == 0) {
							if (i == 0)
								Player.anIntArrayArrayArray3566[0][i_31_][i_30_] = -Class53.method417(i_27_ + 556238 + i_30_, i_31_ + 932731 + i_32_) * 8;
							else {
	...
	private boolean method386(int i, int i_0_, boolean bool_1_, byte[] is) {
		try {
			synchronized (aClass16_1074) {
				try {
					int i_2_;
					if (bool_1_) {
						if (i * 6 + 6 > aClass16_1085.method87())
							return false;
						aClass16_1085.method97((byte) 94, i * 6);
						aClass16_1085.method93(6, ItemDefinition.aByteArray2817, 0);
						i_2_ = ((ItemDefinition.aByteArray2817[3] & 0xff) << 16) - (-((ItemDefinition.aByteArray2817[4] & 0xff) << 8) - (ItemDefinition.aByteArray2817[5] & 0xff));
						if (i_2_ <= 0 || aClass16_1074.method87() / 520L < i_2_)
							return false;
					} else {
						i_2_ = (int) ((aClass16_1074.method87() + 519L) / 520L);
						if (i_2_ == 0)
							i_2_ = 1;
					}
					if (false)
						Class48.aClass19_1065 = null;
					ItemDefinition.aByteArray2817[3] = (byte) (i_2_ >> 16);
					ItemDefinition.aByteArray2817[4] = (byte) (i_2_ >> 8);
					ItemDefinition.aByteArray2817[0] = (byte) (i_0_ >> 16);
					ItemDefinition.aByteArray2817[5] = (byte) i_2_;
					ItemDefinition.aByteArray2817[2] = (byte) i_0_;
					int i_3_ = 0;
					ItemDefinition.aByteArray2817[1] = (byte) (i_0_ >> 8);
					int i_4_ = 0;
					aClass16_1085.method97((byte) -128, i * 6);
					aClass16_1085.method88(ItemDefinition.aByteArray2817, 6, 0);
					int i_5_;
					for (/**/; i_0_ > i_3_; i_3_ += i_5_) {
						...
						if (bool_1_) {
							...
							try {
								aClass16_1074.method93(8, ItemDefinition.aByteArray2817, 0);
							} catch (java.io.EOFException eofexception) {
								break;
							}
							i_6_ = (ItemDefinition.aByteArray2817[4] << 16 & 0xff0000) + (ItemDefinition.aByteArray2817[5] << 8 & 0xff00) + (ItemDefinition.aByteArray2817[6] & 0xff);
							i_5_ = ((ItemDefinition.aByteArray2817[0] & 0xff) << 8) + (ItemDefinition.aByteArray2817[1] & 0xff);
							int i_7_ = (ItemDefinition.aByteArray2817[3] & 0xff) + ((ItemDefinition.aByteArray2817[2] & 0xff) << 8);
							int i_8_ = ItemDefinition.aByteArray2817[7] & 0xff;
							if (i_5_ != i || i_4_ != i_7_ || anInt1072 != i_8_)
								return false;
							if (i_6_ < 0 || i_6_ > aClass16_1074.method87() / 520L)
								return false;
						}
						if (i_6_ == 0) {
							bool_1_ = false;
							i_6_ = (int) ((aClass16_1074.method87() + 519L) / 520L);
							if (i_6_ == 0)
								i_6_++;
							if (i_6_ == i_2_)
								i_6_++;
						}
						ItemDefinition.aByteArray2817[2] = (byte) (i_4_ >> 8);
						...
						i_4_++;
						ItemDefinition.aByteArray2817[0] = (byte) (i >> 8);
						if (i_5_ > 512)
							i_5_ = 512;
						if (-i_3_ + i_0_ <= 512)
							i_6_ = 0;
						ItemDefinition.aByteArray2817[6] = (byte) i_6_;
						ItemDefinition.aByteArray2817[5] = (byte) (i_6_ >> 8);
						ItemDefinition.aByteArray2817[4] = (byte) (i_6_ >> 16);
						aClass16_1074.method97((byte) -89, i_2_ * 520);
						aClass16_1074.method88(ItemDefinition.aByteArray2817, 8, 0);
						aClass16_1074.method88(is, i_5_, i_3_);
						i_2_ = i_6_;
					}
					return true;
			...
			throw Class38_Sub1.method607(runtimeexception, "tb.C(" + i + ',' + i_0_ + ',' + false + ',' + bool_1_ + ',' + (is != null ? "{...}" : "null") + ')');
		}
	}

	final byte[] method391(int i_16_) {
		try {
			synchronized (aClass16_1074) {
				try {
					if (i_16_ * 6 + 6 > aClass16_1085.method87())
						return null;
					aClass16_1085.method97((byte) 94, i_16_ * 6);
					aClass16_1085.method93(6, ItemDefinition.aByteArray2817, 0);
					int i_17_ = ((ItemDefinition.aByteArray2817[0] & 0xff) << 16) + ((ItemDefinition.aByteArray2817[1] & 0xff) << 8) + (ItemDefinition.aByteArray2817[2] & 0xff);
					int i_18_ = ((ItemDefinition.aByteArray2817[4] & 0xff) << 8) + ((ItemDefinition.aByteArray2817[3] & 0xff) << 16) + (ItemDefinition.aByteArray2817[5] & 0xff);
					if (i_17_ < 0 || i_17_ > anInt1073)
						return null;
					if (i_18_ <= 0 || i_18_ > aClass16_1074.method87() / 520L)
						return null;
					...
					while (i_19_ < i_17_) {
						...
						if (i_21_ > 512)
							i_21_ = 512;
						aClass16_1074.method93(i_21_ + 8, ItemDefinition.aByteArray2817, 0);
						int i_22_ = (ItemDefinition.aByteArray2817[2] << 8 & 0xff00) + (ItemDefinition.aByteArray2817[3] & 0xff);
						int i_23_ = (ItemDefinition.aByteArray2817[1] & 0xff) + (ItemDefinition.aByteArray2817[0] << 8 & 0xff00);
						int i_24_ = (ItemDefinition.aByteArray2817[6] & 0xff) + ((ItemDefinition.aByteArray2817[4] & 0xff) << 16) + ((ItemDefinition.aByteArray2817[5] & 0xff) << 8);
						int i_25_ = ItemDefinition.aByteArray2817[7] & 0xff;
						if (i_16_ != i_23_ || i_20_ != i_22_ || i_25_ != anInt1072)
							return null;
						if (i_24_ < 0 || i_24_ > aClass16_1074.method87() / 520L)
							return null;
						i_18_ = i_24_;
						i_20_++;
			...
			throw Class38_Sub1.method607(runtimeexception, "tb.A(" + 0 + ',' + i_16_ + ')');
		}
	}
	...
	final boolean method393(byte i, int i_36_, int i_37_, byte[] is) {
		try {
			synchronized (aClass16_1074) {
				...
				boolean bool = method386(i_36_, i_37_, true, is);
				if (i != -80)
					method393((byte) 121, -90, 10, null);
				if (!bool)
					bool = method386(i_36_, i_37_, false, is);
				return bool;
			}
		} catch (RuntimeException runtimeexception) {
