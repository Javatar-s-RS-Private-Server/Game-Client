package com.javatar;/* Class38_Sub20_Sub9_Sub4 - Decompiled by JODE
...
final class Class38_Sub20_Sub9_Sub4 extends Class38_Sub20_Sub9 {
	...
	private static void method1182(int[] is, int[] is_2_, int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_) {
	...
	private static void method1183(int[] is, int i, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_) {
		if (Class38_Sub20_Sub9_Sub4.aBool3524) {
	...
	static final void method1184(double d) {
		Class38_Sub20_Sub9_Sub4.method1197(d);
	}
	...
	private static void method1189(int i, int i_111_, int i_112_, int i_113_) {
	...
	private static void method1190(int[] is, int i, int i_116_, int i_117_, int i_118_, int i_119_) {
		if (Class38_Sub20_Sub9_Sub4.aBool3524) {
	...
	private static void method1195(int[] is, int[] is_185_, int i, int i_186_, int i_187_, int i_188_, int i_189_, int i_190_, int i_191_, int i_192_, int i_193_, int i_194_, int i_195_, int i_196_, int i_197_) {
		if (Class38_Sub20_Sub9_Sub4.aBool3524) {
	...
	private static void method1197(double d) {
		d += Math.random() * 0.03 - 0.015;
		int i_216_ = 0 * 128;
		for (int i_217_ = 0; i_217_ < 512; i_217_++) {
			...
			for (int i_220_ = 0; i_220_ < 128; i_220_++) {
				...
				if (d_219_ != 0.0) {
					...
					if (d_227_ * 6.0 < 1.0)
						...
						d_222_ = d_226_;
					if (d_218_ * 6.0 < 1.0)
						d_223_ = d_226_ + (d_225_ - d_226_) * 6.0 * d_218_;
					else if (d_218_ * 2.0 < 1.0)
						d_223_ = d_225_;
					else if (d_218_ * 3.0 < 2.0)
						d_223_ = d_226_ + (d_225_ - d_226_) * (0.6666666666666666 - d_218_) * 6.0;
					else
						d_223_ = d_226_;
					if (d_229_ * 6.0 < 1.0)
	...
	private static int method1199(int i, int i_238_) {
