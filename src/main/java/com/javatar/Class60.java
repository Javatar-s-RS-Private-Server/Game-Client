package com.javatar;/* Class60 - Decompiled by JODE
...
final class Class60 implements KeyListener, FocusListener {
	...
	static final void method452() {
		try {
			if (Class23.packetId == 164) {
				...
				int i_1_ = Class15.inputStream.method755(7 ^ 0x7);
				...
				int i_9_ = Class15.inputStream.readByteCAdd();
				int i_10_ = Class15.inputStream.readUnsignedShortLE();
				...
				if (class38_sub20_sub3_sub7_sub2 != null) {
					...
					Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1 = class38_sub20_sub1.method795(i_22_, i_4_, i_23_, 7 ^ ~0x3216, is, i_6_, i_21_);
			...
			if (Class23.packetId == 26) {
				...
				int i_48_ = Class15.inputStream.readUnsignedShortLE();
				...
				int i_61_ = Class15.inputStream.readUnsignedShortLE();
				int i_62_ = Class15.inputStream.getUByte();
				int i_63_ = Class15.inputStream.readUnsignedShortLE();
				...
				int i_66_ = Class15.inputStream.method756(7 + 13278);
				...
				if (Class23.packetId == 105) {
					...
					if (Class23.packetId == 195) {
						...
						int i_81_ = Class15.inputStream.readUnsignedShortLE();
					...
					if (Class23.packetId == 82) {
						...
						int i_93_ = Class15.inputStream.readUnsignedShortLE();
						int i_94_ = Class15.inputStream.getUByte() * 4;
						int i_95_ = Class15.inputStream.getUByte() * 4;
						int i_96_ = Class15.inputStream.readUnsignedShortLE();
						int i_97_ = Class15.inputStream.readUnsignedShortLE();
			...
			throw Class38_Sub1.method607(runtimeexception, "ld.D(" + 7 + ')');
		}
	}

	static final void method453(int i_100_, int i_101_, int i_102_) {
		try {
			Class38_Sub6 class38_sub6 = Class38_Sub20_Sub12.method987(i_100_, i_101_);
			...
			throw Class38_Sub1.method607(runtimeexception, "ld.A(" + (byte) -28 + ',' + i_100_ + ',' + i_101_ + ',' + i_102_ + ')');
		}
	}

	static final Class38_Sub8 method454(int i, int i_104_, int i_105_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ld.E(" + i + ',' + i_104_ + ',' + i_105_ + ',' + 22878 + ')');
		}
	}

	static final void method455(int i, SceneGraph class27, byte[] is, Class74[] class74s, int i_108_) {
		try {
			if (-123 > -108)
			...
			for (; ; ) {
				int i_110_ = class38_sub23.method726();
				if (i_110_ == 0)
					break;
				i_109_ += i_110_;
				int i_111_ = 0;
				for (;;) {
					int i_112_ = class38_sub23.method726();
					if (i_112_ == 0)
						break;
					i_111_ += i_112_ - 1;
					int i_113_ = i_111_ >> 6 & 0x3f;
					int i_114_ = i_111_ & 0x3f;
					int i_115_ = i_111_ >> 12;
					...
					if (i_119_ > 0 && i_120_ > 0 && i_119_ < 103 && i_120_ < 103) {
						...
						Class10.method53(class27, i_120_, i_117_, i_109_, i_118_, class74, i_115_, i_119_, (byte) -76);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ld.F(" + i + ',' + (class27 != null ? "{...}" : "null") + ',' + (is != null ? "{...}" : "null") + ',' + (class74s != null ? "{...}" : "null") + ',' + -123 + ',' + i_108_ + ')');
		}
	}
	...
	static final Class38_Sub20_Sub17 method457(int i, byte i_123_) {
		try {
			...
			if (is != null)
				class38_sub20_sub17.method1031(new RS2Buffer(is));
	...
	public final void keyTyped(KeyEvent keyevent) {
		try {
			int i = Class38_Sub22.method723(keyevent);
			if (i >= 0) {
