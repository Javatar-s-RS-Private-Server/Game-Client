package com.javatar;/* Class38_Sub20_Sub3_Sub2 - Decompiled by JODE
...
final class Class38_Sub20_Sub3_Sub2 extends SceneModel {
	...
	static final void method1092(int i, Class38_Sub6[] class38_sub6s, int i_0_) {
		try {
			...
			for (/**/; i_1_ < class38_sub6s.length; i_1_++) {
				...
				if (class38_sub6 != null && class38_sub6.anInt1977 == i && (!class38_sub6.aBool1961 || !Class43.method362(class38_sub6))) {
	...
	static final void method1093() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "pb.G(" + 100 + ')');
			}
			break;
		} while (false);
	}
	...
	final Class38_Sub20_Sub3_Sub1 method820() {
		try {
			...
			ObjectDefinition class38_sub20_sub1 = Class80.method581((byte) 109 - 237, anInt3261);
			...
			if ((byte) 109 != 109)
				return null;
			return class38_sub20_sub1.method798(aClass38_Sub20_Sub4_3255, i_14_, anInt3259, is, i_13_, anInt3254, i_12_, anInt3263);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "pb.E(" + (byte) 109 + ')');
		}
	}
}
