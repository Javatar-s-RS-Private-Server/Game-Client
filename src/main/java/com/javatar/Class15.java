package com.javatar;/* Class15 - Decompiled by JODE
...
final class Class15 {
	...
	static {
		...
		Class15.inputStream = new PacketBuffer();
		Class15.anInt301 = 0;
			...
			try {
				...
				try {
					if (Class38_Sub1.anInt1741 != 1)
						break;
					int i = Class35.aClass38_Sub10_Sub1_849.method861();
				...
				throw Class38_Sub1.method607(runtimeexception, "we.A(" + true + ')');
			}
		while (false);
	}
				...
				if (i <= -65) {
					...
					try {
						...
						for (int i_8_ = 1; i_8_ < objects.length; i_8_++)
							if (!(objects[i_8_] instanceof Integer)) {
								if (objects[i_8_] instanceof RSString) {
									...
									if (class19.method175(Class5.aClass19_96))
						...
						for (;;) {
							...
							if (i_4_ < 100) {
								...
								if (i_4_ == 25) {
									...
									Class38_Sub11.anIntArray2096[i_2_++] = Player.method1206(i_13_);
									continue;
								}
								if (i_4_ == 27) {
									int i_14_ = is_3_[i_5_];
									RuntimeException_Sub1.method1097(Class38_Sub11.anIntArray2096[--i_2_], i_14_);
									continue;
								}
								if (i_4_ == 31) {
									i_2_ -= 2;
							...
							if (i_4_ < 1000) {
								if (i_4_ == 100) {
									...
									Class38_Sub6 class38_sub6 = Class38_Sub20_Sub12.method987(i_36_, i_37_);
								...
								if (i_4_ >= 1100 && i_4_ < 1200 || i_4_ >= 2100 && i_4_ < 2200) {
									...
									if (i_4_ == 1200) {
										...
										class38_sub6.anInt1899 = Class38_Sub11.anIntArray2096[i_2_ + 1];
									...
									if (i_4_ >= 1400 && i_4_ < 1500 || i_4_ >= 2400 && i_4_ < 2500) {
										...
										for (int i_44_ = objects_43_.length - 1; i_44_ >= 1; i_44_--)
											if (class19.method163(8, i_44_ - 1) == 115)
												...
												objects_43_[i_44_] = Class38_Sub11.anIntArray2096[--i_2_];
										...
										if (i_4_ < 1700) {
											...
											if (i_4_ < 2600) {
												...
												if (i_4_ < 2800) {
													...
													if (i_4_ == 2800)
														Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub1.method610(Class30.method283(-113, class38_sub6));
													else if (i_4_ == 2801) {
													...
													if (i_4_ >= 3300) {
														if (i_4_ < 3400) {
															if (i_4_ == 3300)
																...
																Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub18.method703(i_49_, i_48_);
															} else if (i_4_ == 3302) {
																i_2_ -= 2;
																...
																Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub7.method655(i_53_, i_52_);
															} else if (i_4_ == 3304) {
																int i_54_ = Class38_Sub11.anIntArray2096[--i_2_];
																Class38_Sub11.anIntArray2096[i_2_++] = Class41.method351(i_54_).anInt2848;
															} else if (i_4_ == 3305) {
																...
																Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub10_Sub3.method941(16383, i_61_ >> 14);
															} else if (i_4_ == 3310) {
																int i_62_ = Class38_Sub11.anIntArray2096[--i_2_];
																Class38_Sub11.anIntArray2096[i_2_++] = i_62_ >> 28;
															} else if (i_4_ == 3311) {
																...
																Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub18.method703(i_65_, i_64_);
															} else if (i_4_ == 3314) {
																i_2_ -= 2;
																...
																Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub7.method655(i_68_, i_69_);
															} else if (i_4_ == 3316) {
															...
															if (i_4_ < 4100) {
																...
																if (i_4_ == 4100) {
																	...
																	Class37.aClass19Array875[i_1_++] = Class9.method43(new RSString[]{class19, Class32.method301(i_113_)}, (byte) -20);
																} else if (i_4_ == 4103) {
																	RSString class19 = Class37.aClass19Array875[--i_1_];
																	...
																	byte[] is_122_ = Class13.indexFonts.method109(i_121_, 0, -117);
																	...
																	byte[] is_125_ = Class13.indexFonts.method109(i_123_, 0, -73);
																	...
																	RSString class19 = Class37.aClass19Array875[--i_1_];
																	Class37.aClass19Array875[i_1_++] = class19.method180(i_127_);
																} else if (i_4_ == 4113) {
																	...
																	Class38_Sub11.anIntArray2096[i_2_++] = !Class13.method66(i_129_) ? 0 : 1;
																} else if (i_4_ == 4115) {
																	int i_130_ = Class38_Sub11.anIntArray2096[--i_2_];
																	Class38_Sub11.anIntArray2096[i_2_++] = !Class62.method462(i_130_) ? 0 : 1;
																} else if (i_4_ == 4116) {
																	...
																	RSString class19 = Class37.aClass19Array875[--i_1_];
																	RSString class19_134_ = Class78.method564(class19.method143((byte) 111));
																	...
																	Class38_Sub11.anIntArray2096[i_2_++] = class19.method166(i_138_);
																}
															} else if (i_4_ >= 4300) {
																if (i_4_ >= 5100)
																	break;
																if (i_4_ == 5000)
																	...
																	RSString class19 = Class37.aClass19Array875[--i_1_];
																	if (class19.method165(Class48.aClass19_1065))
																		Class16.method99(class19);
																	else {
																		RSString class19_144_ = class19.method173(false);
																		int i_145_ = 0;
																		int i_146_ = 0;
																		if (class19_144_.method165(Projectile.aClass19_3408)) {
																			i_146_ = 0;
																			class19 = class19.method171((byte) -118, Projectile.aClass19_3408.method143((byte) 75));
																		} else if (!class19_144_.method165(Class44.aClass19_1005)) {
																			if (class19_144_.method165(Class38_Sub11.aClass19_2086)) {
																				class19 = class19.method171((byte) -80, Class38_Sub11.aClass19_2086.method143((byte) 121));
																				i_146_ = 2;
																			} else if (class19_144_.method165(Class26.aClass19_609)) {
																				i_146_ = 3;
																				class19 = class19.method171((byte) -107, Class26.aClass19_609.method143((byte) 23));
																			} else if (!class19_144_.method165(Class38_Sub20_Sub12.aClass19_3001)) {
																				if (!class19_144_.method165(Class80.aClass19_1610)) {
																					if (class19_144_.method165(Class21.aClass19_512)) {
																						i_146_ = 6;
																						class19 = class19.method171((byte) -48, Class21.aClass19_512.method143((byte) 109));
																					} else if (class19_144_.method165(Class38_Sub12.aClass19_2111)) {
																						i_146_ = 7;
																						class19 = class19.method171((byte) -35, Class38_Sub12.aClass19_2111.method143((byte) 107));
																					} else if (!class19_144_.method165(Class80.aClass19_1587)) {
																						if (class19_144_.method165(Class3.aClass19_68)) {
																							i_146_ = 9;
																							class19 = class19.method171((byte) -78, Class3.aClass19_68.method143((byte) 120));
																						} else if (!class19_144_.method165(Class47.aClass19_1056)) {
																							if (!class19_144_.method165(Class43.aClass19_974)) {
																								if (Class64.anInt1361 != 0)
																									if (class19_144_.method165(Projectile.aClass19_3423)) {
																										i_146_ = 0;
																										class19 = class19.method171((byte) -29, Projectile.aClass19_3423.method143((byte) 12));
																									} else if (!class19_144_.method165(Class44.aClass19_991)) {
																										if (class19_144_.method165(Class38_Sub11.aClass19_2098)) {
																											i_146_ = 2;
																											class19 = class19.method171((byte) -85, Class38_Sub11.aClass19_2098.method143((byte) 122));
																										} else if (!class19_144_.method165(Class26.aClass19_616)) {
																											if (class19_144_.method165(Class38_Sub20_Sub12.aClass19_2995)) {
																												i_146_ = 4;
																												class19 = class19.method171((byte) -49, Class38_Sub20_Sub12.aClass19_2995.method143((byte) 25));
																											} else if (class19_144_.method165(Class80.aClass19_1612)) {
																												i_146_ = 5;
																												class19 = class19.method171((byte) -116, Class80.aClass19_1612.method143((byte) 12));
																											} else if (class19_144_.method165(Class21.aClass19_513)) {
																												class19 = class19.method171((byte) -8, Class21.aClass19_513.method143((byte) 56));
																												i_146_ = 6;
																											} else if (class19_144_.method165(Class38_Sub12.aClass19_2122)) {
																												class19 = class19.method171((byte) -65, Class38_Sub12.aClass19_2122.method143((byte) 32));
																												i_146_ = 7;
																											} else if (!class19_144_.method165(Class80.aClass19_1586)) {
																												if (!class19_144_.method165(Class3.aClass19_69)) {
																													if (class19_144_.method165(Class47.aClass19_1060)) {
																														class19 = class19.method171((byte) -63, Class47.aClass19_1060.method143((byte) 80));
																														i_146_ = 10;
																													} else if (class19_144_.method165(Class43.aClass19_968)) {
																														i_146_ = 11;
																		...
																		if (class19_144_.method165(ItemDefinition.aClass19_2818)) {
																			class19 = class19.method171((byte) -40, ItemDefinition.aClass19_2818.method143((byte) 49));
																			i_145_ = 1;
																		} else if (class19_144_.method165(Class15.aClass19_282)) {
																			i_145_ = 2;
																			class19 = class19.method171((byte) -14, Class15.aClass19_282.method143((byte) 40));
																		} else if (!class19_144_.method165(Class38_Sub20_Sub3_Sub2.aClass19_3270)) {
																			if (class19_144_.method165(Class67.aClass19_1379)) {
																				i_145_ = 4;
																				class19 = class19.method171((byte) -66, Class67.aClass19_1379.method143((byte) 97));
																			} else if (!class19_144_.method165(Class38_Sub20_Sub3_Sub2.aClass19_3269)) {
																				if (Class64.anInt1361 != 0)
																					if (class19_144_.method165(ItemDefinition.aClass19_2812)) {
																						i_145_ = 1;
																						class19 = class19.method171((byte) -119, ItemDefinition.aClass19_2812.method143((byte) 115));
																					} else if (class19_144_.method165(Class15.aClass19_292)) {
																						i_145_ = 2;
																						class19 = class19.method171((byte) -6, Class15.aClass19_292.method143((byte) 63));
																					} else if (class19_144_.method165(Class38_Sub20_Sub3_Sub2.aClass19_3277)) {
																						class19 = class19.method171((byte) -17, Class38_Sub20_Sub3_Sub2.aClass19_3277.method143((byte) 36));
																						i_145_ = 3;
																					} else if (!class19_144_.method165(Class67.aClass19_1386)) {
																						if (class19_144_.method165(Class38_Sub20_Sub3_Sub2.aClass19_3273)) {
															...
															RSString class19 = Class37.aClass19Array875[--i_1_];
															Class38_Sub6.method640(class19.method162(0));
														} else if (i_4_ == 3607) {
															RSString class19 = Class37.aClass19Array875[--i_1_];
															Class38_Sub21.method712(class19.method162(0));
														} else if (i_4_ == 3608) {
															RSString class19 = Class37.aClass19Array875[--i_1_];
															Class21.method193(121, class19.method162(0));
														} else if (i_4_ == 3609) {
															RSString class19 = Class37.aClass19Array875[--i_1_];
															if (class19.method165(Class38_Sub2.aClass19_1763) || class19.method165(Class49.aClass19_1099))
											...
											if (i_4_ == 1800)
												Class38_Sub11.anIntArray2096[i_2_++] = Class38_Sub1.method610(Class30.method283(-108, class38_sub6));
											else if (i_4_ == 1801) {
									...
									if (i_4_ == 1300) {
										...
										if (i_179_ < 0 || i_179_ > 9)
											...
											class38_sub6.method636(Class37.aClass19Array875[--i_1_], i_179_);
									} else if (i_4_ == 1301) {
										i_2_ -= 2;
										int i_180_ = Class38_Sub11.anIntArray2096[i_2_ + 1];
										int i_181_ = Class38_Sub11.anIntArray2096[i_2_];
										class38_sub6.aClass38_Sub6_1937 = Class38_Sub20_Sub12.method987(i_180_, i_181_);
									} else if (i_4_ == 1302)
						...
						if (class38_sub20_sub10.aClass19_2894 != null) {
							RSString class19 = Class78.method564(30);
							...
							if (Player.anInt3582 != 0)
								Class62.method464(Class9.method43(new RSString[]{Class54.aClass19_1196, class38_sub20_sub10.aClass19_2894}, (byte) -20), 0, RuntimeException_Sub1.aClass19_3287);
							Class38_Sub20_Sub2.method813(exception, "CS2 - scr:" + class38_sub20_sub10.aLong898 + " op:" + i_4_ + new String(class19.method158()));
						} else {
							if (Player.anInt3582 != 0)
								Class62.method464(Class74.aClass19_1464, 0, RuntimeException_Sub1.aClass19_3287);
							Class38_Sub20_Sub2.method813(exception, "CS2 - scr:" + class38_sub20_sub10.aLong898 + " op:" + i_4_);
						}
					}
				}
			}
	...
	static final void method86(int i_185_, byte[] is, int i_186_, int i_187_, int i_188_, int i_189_, SceneGraph class27, int i_190_, Class74[] class74s, int i_191_) {
		try {
			if (1 != 1)
			...
			int i_192_ = -1;
			for (; ; ) {
				int i_193_ = class38_sub23.method726();
				if (i_193_ == 0)
					break;
				i_192_ += i_193_;
				int i_194_ = 0;
				for (;;) {
					int i_195_ = class38_sub23.method726();
					if (i_195_ == 0)
						break;
					int i_196_ = class38_sub23.getUByte();
					i_194_ += i_195_ - 1;
					int i_197_ = (i_194_ & 0xff2) >> 6;
					...
					if (i_186_ == i_200_ && i_191_ <= i_197_ && i_197_ < i_191_ + 8 && i_187_ <= i_198_ && i_198_ < i_187_ + 8) {
						ObjectDefinition class38_sub20_sub1 = Class80.method581(1 + 99, i_192_);
						int i_202_ = i_189_ + Class38_Sub20_Sub10.method978(i_198_ & 0x7, class38_sub20_sub1.anInt2480, i_199_, class38_sub20_sub1.anInt2469, i_197_ & 0x7, i_190_);
			...
			throw Class38_Sub1.method607(runtimeexception, "we.D(" + 1 + ',' + i_185_ + ',' + (is != null ? "{...}" : "null") + ',' + i_186_ + ',' + i_187_ + ',' + i_188_ + ',' + i_189_ + ',' + (class27 != null ? "{...}" : "null") + ',' + i_190_ + ',' + (class74s != null ? "{...}" : "null") + ',' + i_191_ + ')');
		}
	}
}
