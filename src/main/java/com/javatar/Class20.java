package com.javatar;/* Class20 - Decompiled by JODE
...
final class Class20 {
	...
	Class20(int i, int i_26_) {
		try {
			if (i_26_ != i) {
				int i_27_ = Class38_Sub20_Sub3_Sub4.method1151(i, i_26_);
				i /= i_27_;
	...
	static final void method187() {
		try {
			...
			Class83.aClass13_1676.method58();
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ed.G(" + false + ')');
		}
	}
	...
	static final boolean method189(byte i, int i_17_, int i_18_) {
		try {
			...
			if (i_18_ >= 5 && i_18_ <= 8)
				i_18_ = 4;
			return class38_sub20_sub1.method806(i_18_);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ed.E(" + i + ',' + i_17_ + ',' + i_18_ + ')');
		}
	}

	static final Class38_Sub20_Sub13 method190(Class17 class17, Class17 class17_19_, int i_20_) {
		try {
			if ((byte) 79 < 77)
				return null;
			...
			for (int i : is) {
				byte[] is_23_ = class17_19_.method120(i, -50, i_20_);
				if (is_23_ == null)
					bool_21_ = false;
				else {
					int i_24_ = is_23_[1] & 0xff | is_23_[0] << 8 & 0xff00;
					byte[] is_25_;
					if (!false)
			...
			if (!bool_21_)
				return null;
			try {
				return new Class38_Sub20_Sub13(class17_19_, class17, i_20_, false);
			} catch (Exception exception) {
				return null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ed.D(" + (byte) 79 + ',' + (class17 != null ? "{...}" : "null") + ',' + (class17_19_ != null ? "{...}" : "null") + ',' + false + ',' + i_20_ + ')');
		}
	}

	final byte[] method184(byte[] is) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ed.C(" + (is != null ? "{...}" : "null") + ',' + (byte) -105 + ')');
		}
	}

	final int method186(int i) {
		try {
			if (-111 >= 0)
				return 0;
			if (anIntArrayArray493 != null)
			...
			throw Class38_Sub1.method607(runtimeexception, "ed.H(" + i + ',' + -111 + ')');
		}
	}
