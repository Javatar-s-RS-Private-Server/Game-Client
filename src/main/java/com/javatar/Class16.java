package com.javatar;/* Class16 - Decompiled by JODE
...
final class Class16 {
	...
	private final byte[] aByteArray321;
	private final Class63 aClass63_335;
	...
	Class16(Class63 class63, int i) throws IOException {
		try {
			aClass63_335 = class63;
			aLong329 = aLong334 = class63.method469(82);
			aLong315 = 0L;
			aByteArray310 = new byte[0];
			aByteArray321 = new byte[i];
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "vf.<init>(" + (class63 != null ? "{...}" : "null") + ',' + i + ',' + 0 + ')');
		}
	}
	...
	static final Class38_Sub20_Sub8 method90(int i, int i_6_) {
		try {
			...
			if (is != null)
				class38_sub20_sub8.method953(i_6_, new RS2Buffer(is));
			class38_sub20_sub8.method954();
	...
	static final void method99(RSString class19) {
		try {
			if (Class32.anInt772 >= 2) {
				...
				if (class19.method165(Class45.aClass19_1022)) {
					...
					Class62.method464(Class9.method43(new RSString[]{Class83.aClass19_1651, RuntimeException_Sub1.method1098(Class38_Sub14.anInt2139, 0)}, (byte) -20), 0, null);
				}
	...
	static final void method100() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "vf.G(" + 7965 + ')');
		}
	}
	...
	final long method87() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "vf.E(" + 31274 + ')');
		}
	}

	final void method88(byte[] is, int i_0_, int i_1_) throws IOException {
		try {
			try {
				...
				if (i_0_ > aByteArray310.length) {
					...
					aClass63_335.method470(is, (byte) 90 - 206, i_1_, i_0_);
					long l = -1L;
					aLong317 += i_0_;
					long l_3_ = -1L;
			...
			throw Class38_Sub1.method607(runtimeexception, "vf.F(" + (is != null ? "{...}" : "null") + ',' + (byte) 90 + ',' + i_0_ + ',' + i_1_ + ')');
		}
	}

	private File method91() {
		try {
			if (0 != 0)
				return null;
			return aClass63_335.method466(-92);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "vf.J(" + 0 + ')');
		}
	}

	final void method92() throws IOException {
		do {
			try {
				method94(-16279 ^ ~0x3fdd);
				aClass63_335.method471(0);
				if (-16279 == -16279)
					break;
				Class16.method89(-81, (byte) 26);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "vf.I(" + -16279 + ')');
			}
			break;
		} while (false);
	}

	final void method93(int i, byte[] is, int i_8_) throws IOException {
		try {
			try {
				if (i + i_8_ > is.length)
			...
			throw Class38_Sub1.method607(runtimeexception, "vf.H(" + i + ',' + 7975 + ',' + (is != null ? "{...}" : "null") + ',' + i_8_ + ')');
		}
	}

	private void method94(int i) throws IOException {
		do {
			try {
				if (aLong316 != -1L) {
					long l = -1L;
	...
	final void method95(byte[] is) throws IOException {
		try {
			method93(is.length, is, 0);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "vf.A(" + (is != null ? "{...}" : "null") + ',' + 0 + ')');
		}
	}

	private void method96() throws IOException {
		try {
			anInt313 = 0;
			int i_20_ = -29 % ((-75 - (byte) 79) / 45);
			if (aLong317 != aLong315) {
			...
			throw Class38_Sub1.method607(runtimeexception, "vf.L(" + (byte) 79 + ')');
		}
	}
	...
	final void method97(byte i, long l) throws IOException {
		try {
			if (l < 0L)
				throw new IOException("Invalid seek to " + l + " in file " + method91());
