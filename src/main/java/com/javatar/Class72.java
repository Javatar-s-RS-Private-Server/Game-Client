package com.javatar;/* Class72 - Decompiled by JODE
...
final class Class72 {
	...
	static final void method512(Applet_Sub1 applet_sub1) {
		try {
			if ((byte) 33 != 33)
						...
						if (i_2_ <= Class73.anInt1429 && i_2_ + 14 >= Class73.anInt1429 && RS2Buffer.anInt2416 >= 4 && RS2Buffer.anInt2416 <= 18)
							...
							if (i_3_ <= Class73.anInt1429 && i_3_ + 14 >= Class73.anInt1429 && RS2Buffer.anInt2416 >= 4 && RS2Buffer.anInt2416 <= 18)
								...
								if (Node.aBool889 == class4.aBool83) {
									byte[] is = Class9.method43(new RSString[]{class4.aClass19_73, Class78.aClass19_1559}, (byte) -20).method158();
			...
			throw Class38_Sub1.method607(runtimeexception, "ra.B(" + (byte) 33 + ',' + (applet_sub1 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final Class38_Sub20_Sub12 method514(int i, byte i_4_) {
		try {
			...
			if (is != null)
				class38_sub20_sub12.method986(new RS2Buffer(is));
