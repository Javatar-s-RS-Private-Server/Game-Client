package com.javatar;/* Class38_Sub10_Sub1 - Decompiled by JODE
...
final class Class38_Sub10_Sub1 extends Class38_Sub10 {
	...
	private final int[] anIntArray2595;
	private final int[] anIntArray2603 = new int[16];
	private final int[] anIntArray2605;
	private final Class38_Sub22[][] aClass38_Sub22ArrayArray2608;
	private final int[] anIntArray2609;
	private final Class70 aClass70_2624;
	private final int[] anIntArray2632;
	private final int[] anIntArray2634;
	private final int[] anIntArray2638;
	private final int[] anIntArray2639;
	private final int[] anIntArray2640;
	private final int anInt2650;
	private final Class14 aClass14_2651;
	private final int[] anIntArray2653;
	private final int[] anIntArray2654;
	private final Class38_Sub22[][] aClass38_Sub22ArrayArray2657;
	private final int[] anIntArray2661;
	int[] anIntArray2626;
	int[] anIntArray2636;
	int[] anIntArray2649;
	...
	static final Class38_Sub20_Sub9_Sub1_Sub1 method853(byte[] is) {
		try {
			if (!true)
			...
			throw Class38_Sub1.method607(runtimeexception, "c.K(" + (is != null ? "{...}" : "null") + ',' + true + ')');
		}
	}
		...
		try {
			...
			for (/**/; i_75_ < i_74_; i_75_++) {
				...
				if (class38_sub20_sub3_sub7_sub2 != null && class38_sub20_sub3_sub7_sub2.isVisible()) {
					class38_sub20_sub3_sub7_sub2.isIdle = (Class38_Sub4.aBool1811 && ItemDefinition.anInt2783 > 50 || ItemDefinition.anInt2783 > 200) && !bool && class38_sub20_sub3_sub7_sub2.anInt3454 == class38_sub20_sub3_sub7_sub2.idleAnimation;
					int i_77_ = class38_sub20_sub3_sub7_sub2.anInt3444 >> 7;
					int i_78_ = class38_sub20_sub3_sub7_sub2.anInt3493 >> 7;
			...
			throw Class38_Sub1.method607(runtimeexception, "c.FA(" + bool + ',' + (byte) -35 + ')');
		}
	}
	...
	private void method833(int i, int i_0_) {
		do {
			try {
				if ((byte) 102 == 102)
					break;
				...
				throw Class38_Sub1.method607(runtimeexception, "c.O(" + i + ',' + i_0_ + ',' + (byte) 102 + ')');
			}
			break;
		} while (false);
	}

	private void method834(int i, int i_2_, int i_3_) {
		try {
	...
	private int method835(int i, Class38_Sub22 class38_sub22) {
		try {
			int i_5_ = anIntArray2654[class38_sub22.anInt2344] * anIntArray2639[class38_sub22.anInt2344] + 4096 >> 13;
			Class52 class52 = class38_sub22.aClass52_2322;
			i_5_ = i_5_ * i_5_ + 16384 >> 15;
			i_5_ = i_5_ * class38_sub22.anInt2311 + 16384 >> 15;
			i_5_ = anInt2635 * i_5_ + 128 >> 8;
			...
			if (class52.aByteArray1139 != null) {
				...
				if (class52.aByteArray1139.length - 2 > class38_sub22.anInt2340) {
					int i_8_ = (class52.aByteArray1139[class38_sub22.anInt2340] & 0xff) << 8;
					int i_9_ = class52.aByteArray1139[class38_sub22.anInt2340 + 2] << 8 & 0xff00;
			...
			if (i > (class38_sub22.anInt2345 ^ 0xffffffff) && class52.aByteArray1153 != null) {
				...
				if (class38_sub22.anInt2318 < class52.aByteArray1153.length - 2) {
					int i_12_ = class52.aByteArray1153[class38_sub22.anInt2318] << 8 & 0xff00;
					int i_13_ = class52.aByteArray1153[class38_sub22.anInt2318 + 2] << 8 & 0xff00;
					i_11_ += (-i_12_ + i_10_) * (-i_11_ + class52.aByteArray1153[class38_sub22.anInt2318 + 3]) / (i_13_ - i_12_);
				}
				i_5_ = i_5_ * i_11_ + 32 >> 6;
			}
			return i_5_;
		} catch (RuntimeException runtimeexception) {
	...
	private void method837(int i_16_) {
		try {
			int i_17_ = i_16_ & 0xf0;
			if (i_17_ == 128) {
				int i_18_ = i_16_ & 0xf;
				int i_19_ = i_16_ >> 8 & 0x7f;
				int i_20_ = (i_16_ & 0x7f06bb) >> 16;
				...
				if (i_17_ == 144) {
					int i_21_ = i_16_ & 0xf;
					int i_22_ = i_16_ >> 8 & 0x7f;
					int i_23_ = i_16_ >> 16 & 0x7f;
					if (i_23_ <= 0)
					...
					int i_24_ = i_16_ & 0xf;
					int i_25_ = (i_16_ & 0x7f0797) >> 16;
					int i_26_ = i_16_ >> 8 & 0x7f;
					method846(i_26_, i_24_, (byte) 13 + 101, i_25_);
				} else if (i_17_ == 176) {
					int i_27_ = (i_16_ & 0x7f4afb) >> 16;
					int i_28_ = i_16_ >> 8 & 0x7f;
					int i_29_ = i_16_ & 0xf;
					if (i_28_ == 0)
						anIntArray2603[i_29_] = (i_27_ << 14) + Class38_Sub10_Sub3.method941(anIntArray2603[i_29_], -2080769);
					if (i_28_ == 32)
						anIntArray2603[i_29_] = (i_27_ << 7) + Class38_Sub10_Sub3.method941(anIntArray2603[i_29_], -16257);
					if (i_28_ == 1)
						anIntArray2653[i_29_] = (i_27_ << 7) + Class38_Sub10_Sub3.method941(-16257, anIntArray2653[i_29_]);
					if (i_28_ == 33)
						anIntArray2653[i_29_] = i_27_ + Class38_Sub10_Sub3.method941(anIntArray2653[i_29_], -128);
					if (i_28_ == 5)
						anIntArray2634[i_29_] = Class38_Sub10_Sub3.method941(-16257, anIntArray2634[i_29_]) + (i_27_ << 7);
					if (i_28_ == 37)
						anIntArray2634[i_29_] = i_27_ + Class38_Sub10_Sub3.method941(anIntArray2634[i_29_], -128);
					if (i_28_ == 7)
						anIntArray2654[i_29_] = Class38_Sub10_Sub3.method941(-16257, anIntArray2654[i_29_]) + (i_27_ << 7);
					if (i_28_ == 39)
						anIntArray2654[i_29_] = i_27_ + Class38_Sub10_Sub3.method941(-128, anIntArray2654[i_29_]);
					if (i_28_ == 10)
						anIntArray2640[i_29_] = Class38_Sub10_Sub3.method941(-16257, anIntArray2640[i_29_]) + (i_27_ << 7);
					if (i_28_ == 42)
						anIntArray2640[i_29_] = i_27_ + Class38_Sub10_Sub3.method941(-128, anIntArray2640[i_29_]);
					if (i_28_ == 11)
						anIntArray2639[i_29_] = (i_27_ << 7) + Class38_Sub10_Sub3.method941(anIntArray2639[i_29_], -16257);
					if (i_28_ == 43)
					...
					if (i_28_ == 99)
						anIntArray2605[i_29_] = Class38_Sub10_Sub3.method941(127, anIntArray2605[i_29_]) + (i_27_ << 7);
					if (i_28_ == 98)
						anIntArray2605[i_29_] = i_27_ + Class38_Sub10_Sub3.method941(16256, anIntArray2605[i_29_]);
					if (i_28_ == 101)
						anIntArray2605[i_29_] = (i_27_ << 7) + 16384 + Class38_Sub10_Sub3.method941(127, anIntArray2605[i_29_]);
					if (i_28_ == 100)
						anIntArray2605[i_29_] = Class38_Sub10_Sub3.method941(anIntArray2605[i_29_], 16256) + i_27_ + 16384;
					if (i_28_ == 120)
						method859((byte) 13 ^ 0xd, i_29_);
					if (i_28_ == 121)
						method858(-119, i_29_);
					if (i_28_ == 123)
						method851((byte) 13 ^ ~0x1d, i_29_);
					if (i_28_ == 6) {
						int i_30_ = anIntArray2605[i_29_];
						if (i_30_ == 16384)
							anIntArray2661[i_29_] = (i_27_ << 7) + Class38_Sub10_Sub3.method941(anIntArray2661[i_29_], -16257);
					}
					if (i_28_ == 38) {
					...
					if (i_28_ == 16)
						this.anIntArray2626[i_29_] = (i_27_ << 7) + Class38_Sub10_Sub3.method941(-16257, this.anIntArray2626[i_29_]);
					if (i_28_ == 48)
					...
					if (i_28_ == 17)
						method864((anIntArray2638[i_29_] & ~0x3f80) + (i_27_ << 7), i_29_);
					if (i_28_ == 49)
						method864(i_27_ + (anIntArray2638[i_29_] & ~0x7f), i_29_);
				} else if (i_17_ == 192) {
					int i_32_ = i_16_ & 0xf;
					int i_33_ = (i_16_ & 0x7f0f) >> 8;
					method848(i_32_, i_33_ + anIntArray2603[i_32_], 119);
				} else if (i_17_ == 208) {
					int i_34_ = i_16_ & 0xf;
					int i_35_ = i_16_ >> 8 & 0x7f;
					method833(i_34_, i_35_);
				} else if (i_17_ == 224) {
					int i_36_ = i_16_ & 0xf;
					int i_37_ = (i_16_ >> 8 & 0x7f) + ((i_16_ & 0x7f0072) >> 9);
					method834(i_37_, (byte) 13 ^ ~0x77, i_36_);
				} else {
					i_17_ = i_16_ & 0xff;
					if (i_17_ == 255)
						method865();
			...
			throw Class38_Sub1.method607(runtimeexception, "c.D(" + (byte) 13 + ',' + i_16_ + ')');
		}
	}

	final synchronized void method838() {
		do {
			try {
				method866(-128, 9, 128);
				if ((byte) -108 < -50)
				...
				throw Class38_Sub1.method607(runtimeexception, "c.AA(" + (byte) -108 + ',' + 9 + ',' + 128 + ')');
			}
			break;
		} while (false);
	}
	...
	final synchronized void method840(int i_43_) {
		try {
			anInt2635 = i_43_;
			if (-19402 != -19402)
				aClass38_Sub10_Sub3_2668 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "c.W(" + -19402 + ',' + i_43_ + ')');
		}
	}
		...
		try {
			if (i == 1) {
				...
				if (bool && class38_sub22.aClass38_Sub16_Sub1_2337.aBool3025) {
					...
					i_45_ <<= 8;
					i_46_ = (int) ((long) i_47_ * (long) this.anIntArray2626[class38_sub22.anInt2344] >> 6);
					if (i_46_ >= i_45_) {
						class38_sub22.aClass38_Sub10_Sub2_2314.method904();
						i_46_ = i_45_ + i_45_ - (1 + i_46_);
					}
				} else
					i_46_ = (int) ((long) i_45_ * (long) this.anIntArray2626[class38_sub22.anInt2344] >> 6);
	...
	private void method844(int i, int i_48_) {
		try {
	...
	private void method845(int i, int i_49_, boolean bool, int i_50_) {
		try {
			method850(i_50_, 64, (byte) 114, i_49_);
			if ((this.anIntArray2636[i_49_] & 0x2) != 0)
				for (Class38_Sub22 class38_sub22 = (Class38_Sub22) aClass38_Sub10_Sub3_2668.aClass13_2828.method74(-49); class38_sub22 != null; class38_sub22 = (Class38_Sub22) aClass38_Sub10_Sub3_2668.aClass13_2828.method62())
					if (i_49_ == class38_sub22.anInt2344 && class38_sub22.anInt2345 < 0) {
						...
						int i_51_ = (class38_sub22.anInt2331 * class38_sub22.anInt2342 >> 12) + class38_sub22.anInt2328;
						class38_sub22.anInt2328 += -class38_sub22.anInt2329 + i_50_ << 8;
			...
			if (class38_sub18 != null) {
				...
				if (class38_sub16_sub1 != null) {
					...
					class38_sub22.anInt2329 = i_50_;
					class38_sub22.anInt2311 = i * i * class38_sub18.anInt2204 * class38_sub18.aByteArray2211[i_50_] + 1024 >> 11;
					class38_sub22.anInt2343 = class38_sub18.aByteArray2210[i_50_] & 0xff;
					class38_sub22.anInt2328 = -(class38_sub18.aShortArray2212[i_50_] & 0x7fff) + (i_50_ << 8);
					...
					if (this.anIntArray2626[i_49_] != 0) {
						class38_sub22.aClass38_Sub10_Sub2_2314 = Class38_Sub10_Sub2.method873(class38_sub16_sub1, method867(class38_sub22), 0, method855(class38_sub22, 118));
						method843(1, class38_sub18.aShortArray2212[i_50_] < 0, class38_sub22);
					} else
						class38_sub22.aClass38_Sub10_Sub2_2314 = Class38_Sub10_Sub2.method873(class38_sub16_sub1, method867(class38_sub22), method835(-1, class38_sub22), method855(class38_sub22, 50));
	...
	private void method846(int i, int i_53_, int i_54_, int i_55_) {
		try {
	...
	final synchronized boolean method847(Class17 class17, Class79 class79, Class38_Sub24 class38_sub24) {
		try {
			...
			for (Class38_Sub2 class38_sub2 = (Class38_Sub2) class38_sub24.aClass14_2417.method82((byte) 122); class38_sub2 != null; class38_sub2 = (Class38_Sub2) class38_sub24.aClass14_2417.method78(116)) {
				int i_58_ = (int) class38_sub2.aLong898;
				Class38_Sub18 class38_sub18 = (Class38_Sub18) aClass14_2651.method75(i_58_);
				if (class38_sub18 == null) {
					class38_sub18 = Class38_Sub20_Sub14.method1001(i_58_, class17);
					if (class38_sub18 == null) {
						bool = false;
						continue;
					}
					aClass14_2651.method80(i_58_, class38_sub18);
				}
				if (!class38_sub18.method701(class79, class38_sub2.aByteArray1756, is))
					bool = false;
			}
			if (10599 != 10599)
				Class38_Sub10_Sub1.aClass19_2589 = null;
			...
			throw Class38_Sub1.method607(runtimeexception, "c.L(" + 22050 + ',' + (class17 != null ? "{...}" : "null") + ',' + (class79 != null ? "{...}" : "null") + ',' + (class38_sub24 != null ? "{...}" : "null") + ',' + 10599 + ')');
		}
	}

	private void method848(int i, int i_59_, int i_60_) {
		try {
	...
	private void method849(int i, byte i_62_) {
		do {
			try {
	...
	private void method850(int i, int i_63_, byte i_64_, int i_65_) {
		try {
	...
	private void method851(int i, int i_67_) {
		try {
	...
	private int method855(Class38_Sub22 class38_sub22, int i) {
		try {
			if (i <= 23)
				return 4;
			int i_81_ = anIntArray2640[class38_sub22.anInt2344];
			if (i_81_ >= 8192)
				return 16384 - ((-i_81_ + 16384) * (-class38_sub22.anInt2343 + 128) + 32 >> 6);
			return i_81_ * class38_sub22.anInt2343 + 32 >> 6;
		} catch (RuntimeException runtimeexception) {
	...
	final boolean method857(Class38_Sub22 class38_sub22, boolean bool, int i, int[] is, int i_82_) {
		try {
			...
			class38_sub22.aClass38_Sub10_Sub2_2314.method871(method867(class38_sub22));
			class38_sub22.anInt2325++;
			double d = ((class38_sub22.anInt2331 * class38_sub22.anInt2342 >> 12) + (class38_sub22.anInt2329 - 60 << 8)) * 5.086263020833333E-6;
			Class52 class52 = class38_sub22.aClass52_2322;
			...
			if (class52.aByteArray1139 != null) {
				...
				for (/**/; class38_sub22.anInt2340 < class52.aByteArray1139.length - 2 && (class52.aByteArray1139[class38_sub22.anInt2340 + 2] & 0xff) << 8 < class38_sub22.anInt2320; class38_sub22.anInt2340 += 2) {
					/* empty */
				}
			...
			if (class38_sub22.anInt2345 >= 0 && class52.aByteArray1153 != null && (this.anIntArray2636[class38_sub22.anInt2344] & 0x1) == 0 && (class38_sub22.anInt2319 < 0 || class38_sub22 != aClass38_Sub22ArrayArray2608[class38_sub22.anInt2344][class38_sub22.anInt2319])) {
				...
				for (/**/; class38_sub22.anInt2318 < class52.aByteArray1153.length - 2 && class38_sub22.anInt2345 > (class52.aByteArray1153[class38_sub22.anInt2318 + 2] << 8 & 0xff00); class38_sub22.anInt2318 += 2) {
					/* empty */
				}
	...
	private void method858(int i, int i_85_) {
		try {
			if (i_85_ < 0)
	...
	private void method859(int i, int i_86_) {
		try {
			if (i == 0)
	...
	final int method861() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "c.I(" + 15 + ')');
		}
	}
	...
	final boolean method862(Class38_Sub22 class38_sub22) {
		try {
			if (class38_sub22.aClass38_Sub10_Sub2_2314 == null) {
				if (class38_sub22.anInt2345 >= 0) {
					class38_sub22.method330(0);
			...
			throw Class38_Sub1.method607(runtimeexception, "c.M(" + -31299 + ',' + (class38_sub22 != null ? "{...}" : "null") + ')');
		}
	}
	...
	private void method864(int i_92_, int i_93_) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "c.E(" + (byte) 52 + ',' + i_92_ + ',' + i_93_ + ')');
			}
			break;
		} while (false);
	}
	...
	private void method865() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "c.CA(" + (byte) 47 + ')');
		}
	}

	private void method866(int i, int i_96_, int i_97_) {
		try {
	...
	private int method867(Class38_Sub22 class38_sub22) {
		try {
			if ((byte) 32 != 32)
				method866(38, 7, 17);
			int i_98_ = class38_sub22.anInt2328 + (class38_sub22.anInt2331 * class38_sub22.anInt2342 >> 12);
			Class52 class52 = class38_sub22.aClass52_2322;
			i_98_ += (anIntArray2632[class38_sub22.anInt2344] - 8192) * anIntArray2661[class38_sub22.anInt2344] >> 12;
			if (class52.anInt1147 > 0 && (class52.anInt1160 > 0 || anIntArray2653[class38_sub22.anInt2344] > 0)) {
				int i_99_ = class52.anInt1160 << 2;
				int i_100_ = class52.anInt1140 << 1;
				if (class38_sub22.anInt2325 < i_100_)
					i_99_ = class38_sub22.anInt2325 * i_99_ / i_100_;
				i_99_ += anIntArray2653[class38_sub22.anInt2344] >> 7;
			...
			throw Class38_Sub1.method607(runtimeexception, "c.RA(" + (class38_sub22 != null ? "{...}" : "null") + ',' + (byte) 32 + ')');
		}
	}
