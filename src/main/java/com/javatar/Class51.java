package com.javatar;/* Class51 - Decompiled by JODE
...
final class Class51 {
	...
	static final void method403(Class17 class17, boolean bool, Class17 class17_2_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ke.C(" + (class17 != null ? "{...}" : "null") + ',' + 112 + ',' + bool + ',' + (class17_2_ != null ? "{...}" : "null") + ')');
		}
	}
			...
			if (Class48.anInt1069 == 30) {
				...
				if (Class48.anInt1069 == 30) {
					...
					if (Class38_Sub20_Sub8.anInt2857 > 750)
								...
								if (Class52.aBool1143 && Class10.anInt188 >= 5) {
									if (Class38_Sub20_Sub8.aClass38_Sub6_2877 == Class2.aClass38_Sub6_27 && Class38_Sub3.anInt1786 != Class73_Sub2.anInt2287) {
										...
										if (!Class37.method322(16777215, Class30.method283(-128, class38_sub6))) {
											if (i_18_ != 1)
												class38_sub6.method644(Class73_Sub2.anInt2287, Class38_Sub3.anInt1786);
											else {
												...
												while (i_19_ != i_20_)
													if (i_20_ <= i_19_) {
														if (i_20_ < i_19_) {
															class38_sub6.method644(i_20_ + 1, i_20_);
															i_20_++;
														}
													} else {
														class38_sub6.method644(i_20_ - 1, i_20_);
						...
						Projectile.method1168(NodeSub.anInt2252, 0, 0, 503, 0, 765, 0);
						Entity.anInt3513++;
						for (;;) {
