package com.javatar;/* Class52 - Decompiled by JODE
...
final class Class52 {
	...
	static Class17_Sub1 indexBinary;
		...
		do {
			try {
				...
				for (int i_15_ = 0; ObjectDefinition.anInt2467 * 100 > i_15_; i_15_++) {
					...
					Class2_Sub1.anIntArray2004[(i_16_ << 7) + i_17_] = 192;
				}
	...
	static final void method408(Class17 class17, RSString class19, RSString class19_27_) {
		do {
			try {
				int i_29_ = class17.method104(class19);
				int i_30_ = class17.method118(class19_27_, i_29_, true);
				Class23.method203(class17, 255, false, i_30_, 2, i_29_);
				if (55 >= 20)
					break;
				Class52.method407(-92, false);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "kc.C(" + (class17 != null ? "{...}" : "null") + ',' + (class19 != null ? "{...}" : "null") + ',' + 55 + ',' + false + ',' + 255 + ',' + (class19_27_ != null ? "{...}" : "null") + ',' + 2 + ')');
			}
			break;
		} while (false);
	}
