package com.javatar;/* Class38_Sub3 - Decompiled by JODE
...
final class Class38_Sub3 extends Node {
	...
	static final void method619(int i_1_) {
		do {
			try {
				for (Class38_Sub11 class38_sub11 = (Class38_Sub11) Entity.aClass14_3514.method82((byte) 69); class38_sub11 != null; class38_sub11 = (Class38_Sub11) Entity.aClass14_3514.method78(76))
					if (i_1_ == (class38_sub11.aLong898 >> 48 & 0xffffL))
						class38_sub11.method330(0);
				if (4590 == 4590)
					break;
				Class38_Sub3.method621(null, -35, -125, 118, -44, null, -115);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "pc.A(" + 4590 + ',' + i_1_ + ')');
			}
			break;
		} while (false);
	}
	...
	static final void method620() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "pc.B(" + (byte) -77 + ')');
		}
	}
