package com.javatar;/* Class37 - Decompiled by JODE
...
final class Class37 {
	...
	static final void method325(int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			if ((byte) -87 != -87)
			...
			for (int i_11_ = 0; i_11_ < Class72.anInt1416; i_11_++) {
				...
				if (Class17_Sub1.anInt1710 != 0)
					...
					if (Class83.anIntArray1667[i_11_] == 1)
						Class38_Sub11.aClass38_Sub20_Sub9_Sub1_Sub1_2093.method1075(class19, i_5_ + Class29.anInt703, Class38_Sub20_Sub12.anInt3002 + i_4_, i_17_, RuntimeException_Sub1.anInt3293);
					if (Class83.anIntArray1667[i_11_] == 2)
						Class38_Sub11.aClass38_Sub20_Sub9_Sub1_Sub1_2093.method1080(class19, Class29.anInt703 + i_5_, Class38_Sub20_Sub12.anInt3002 + i_4_, i_17_, RuntimeException_Sub1.anInt3293);
					if (Class83.anIntArray1667[i_11_] == 3)
						Class38_Sub11.aClass38_Sub20_Sub9_Sub1_Sub1_2093.method1083(class19, i_5_ + Class29.anInt703, i_4_ + Class38_Sub20_Sub12.anInt3002, i_17_, RuntimeException_Sub1.anInt3293, -Class83.anIntArray1650[i_11_] + 150);
			...
			throw Class38_Sub1.method607(runtimeexception, "i.B(" + (byte) -87 + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ',' + i_6_ + ')');
		}
	}

	static final Class38_Sub20_Sub15 method326(int i_24_) {
		try {
			Class38_Sub20_Sub15 class38_sub20_sub15 = (Class38_Sub20_Sub15) Class82.aClass83_1641.method591(16 ^ ~0x7088, i_24_);
			if (class38_sub20_sub15 != null)
				return class38_sub20_sub15;
			byte[] is = Class17_Sub1.aClass17_1706.method109(16, i_24_, -85);
			class38_sub20_sub15 = new Class38_Sub20_Sub15();
			if (is != null)
				class38_sub20_sub15.method1007(new RS2Buffer(is));
			Class82.aClass83_1641.method590(i_24_, (byte) -125, class38_sub20_sub15);
			return class38_sub20_sub15;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "i.A(" + 16 + ',' + i_24_ + ')');
		}
	}

	static final void method327(Object object, Class56 class56) {
		do {
			try {
				if (class56.anEventQueue1243 != null && 1 == 1) {
				...
				throw Class38_Sub1.method607(runtimeexception, "i.E(" + (object != null ? "{...}" : "null") + ',' + (class56 != null ? "{...}" : "null") + ',' + 1 + ')');
			}
			break;
		} while (false);
	}
	...
	static final Class38_Sub20_Sub9_Sub2[] method329(RSString class19, RSString class19_31_, int i, Class17 class17) {
		try {
			int i_32_ = class17.method104(class19_31_);
