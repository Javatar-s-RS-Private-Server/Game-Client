package com.javatar;/* Class83 - Decompiled by JODE
...
final class Class83 {
	...
	private final NodeSub aClass38_Sub20_1658 = new NodeSub();
	private final Class26 aClass26_1683 = new Class26();
	private final int anInt1684;
	private final Class14 aClass14_1685;
	...
	static final void method593() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ja.D(" + (byte) -68 + ')');
		}
	}
	...
	final void method590(long l, byte i, NodeSub class38_sub20) {
		try {
			if (i < -117) {
				...
				aClass14_1685.method80(l, class38_sub20);
