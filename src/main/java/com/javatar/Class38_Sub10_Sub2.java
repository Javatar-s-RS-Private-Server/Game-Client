package com.javatar;/* Class38_Sub10_Sub2 - Decompiled by JODE
...
final class Class38_Sub10_Sub2 extends Class38_Sub10 {
	...
	private static int method869(int i, int i_0_, byte[] is, int[] is_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_9_, int i_10_) {
	...
	private static int method872(int i, byte[] is, int[] is_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i_13_ >>= 8;
		i_19_ >>= 8;
		i_15_ <<= 2;
		i_16_ <<= 2;
	...
	private static int method875(int i, byte[] is, int[] is_23_, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i_24_ >>= 8;
		i_30_ >>= 8;
		i_26_ <<= 2;
		i_27_ <<= 2;
	...
	private static int method877(int i, int i_31_, byte[] is, int[] is_32_, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_40_, int i_41_) {
	...
	static final Class38_Sub10_Sub2 method878(Class38_Sub16_Sub1 class38_sub16_sub1, int i_42_) {
		if (class38_sub16_sub1.aByteArray3029 == null || class38_sub16_sub1.aByteArray3029.length == 0)
			return null;
		return new Class38_Sub10_Sub2(class38_sub16_sub1, (int) (class38_sub16_sub1.anInt3028 * 256L * 100 / (Class38_Sub20_Sub7.anInt2852 * 100)), i_42_ << 6);
	}

	private static int method879(int i, int i_51_, byte[] is, int[] is_52_, int i_53_, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_60_, int i_61_) {
	...
	private static int method881(int i, int i_66_, byte[] is, int[] is_67_, int i_68_, int i_69_, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_, int i_75_, int i_76_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_77_, int i_78_) {
	...
	private static int method886(int i, int i_80_, byte[] is, int[] is_81_, int i_82_, int i_83_, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_89_, int i_90_) {
	...
	private static int method887(int i, byte[] is, int[] is_91_, int i_92_, int i_93_, int i_94_, int i_95_, int i_96_, int i_97_, int i_98_, int i_99_, int i_100_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i_92_ >>= 8;
		i_100_ >>= 8;
		i_94_ <<= 2;
		i_95_ <<= 2;
	...
	private static int method888(byte[] is, int[] is_101_, int i, int i_102_, int i_103_, int i_104_, int i_105_, int i_106_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i >>= 8;
		i_106_ >>= 8;
		i_103_ <<= 2;
	...
	private static int method890(byte[] is, int[] is_107_, int i, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i >>= 8;
		i_113_ >>= 8;
		i_109_ <<= 2;
		i_110_ <<= 2;
	...
	private static int method892(int i, int i_114_) {
		if (i_114_ < 0)
			return i;
		return (int) (i * Math.sqrt((16384 - i_114_) * 1.220703125E-4) + 0.5);
	}

	private static int method897(int i, int i_128_, byte[] is, int[] is_129_, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_, int i_136_, int i_137_, int i_138_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_139_, int i_140_) {
	...
	private static int method898(byte[] is, int[] is_141_, int i, int i_142_, int i_143_, int i_144_, int i_145_, int i_146_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i >>= 8;
		i_146_ >>= 8;
		i_143_ <<= 2;
	...
	private static int method899(int i, byte[] is, int[] is_147_, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_, int i_153_, int i_154_, int i_155_, int i_156_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i_148_ >>= 8;
		i_156_ >>= 8;
		i_150_ <<= 2;
		i_151_ <<= 2;
	...
	private static int method900(byte[] is, int[] is_157_, int i, int i_158_, int i_159_, int i_160_, int i_161_, int i_162_, int i_163_, Class38_Sub10_Sub2 class38_sub10_sub2) {
		i >>= 8;
		i_163_ >>= 8;
		i_159_ <<= 2;
		i_160_ <<= 2;
	...
	private static int method902(int i, int i_169_, byte[] is, int[] is_170_, int i_171_, int i_172_, int i_173_, int i_174_, int i_175_, int i_176_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_177_, int i_178_) {
	...
	private static int method903(int i, int i_179_) {
		if (i_179_ < 0)
			return -i;
		return (int) (i * Math.sqrt(i_179_ * 1.220703125E-4) + 0.5);
	}

	private static int method905(int i, int i_180_, byte[] is, int[] is_181_, int i_182_, int i_183_, int i_184_, int i_185_, int i_186_, int i_187_, Class38_Sub10_Sub2 class38_sub10_sub2, int i_188_, int i_189_) {
	...
	private int method880(int[] is, int i, int i_62_, int i_63_, int i_64_) {
		while (anInt2684 > 0) {
	...
	private synchronized void method883(int i, int i_79_) {
		anInt2679 = i;
		anInt2673 = i_79_;
		anInt2684 = 0;
		method906();
	...
	private synchronized void method885() {
		method883(0, method889());
	}
	...
	private int method896(int[] is, int i, int i_124_, int i_125_, int i_126_) {
		while (anInt2684 > 0) {
	...
	final synchronized void method904() {
