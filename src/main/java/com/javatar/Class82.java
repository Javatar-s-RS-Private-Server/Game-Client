package com.javatar;/* Class82 - Decompiled by JODE
...
final class Class82 {
	...
	static final void method588(Class17 class17, Class17 class17_13_) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "ab.B(" + (byte) -73 + ',' + (class17 != null ? "{...}" : "null") + ',' + (class17_13_ != null ? "{...}" : "null") + ')');
			}
			break;
		} while (false);
	}
