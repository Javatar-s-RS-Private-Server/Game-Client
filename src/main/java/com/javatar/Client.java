package com.javatar;/* client - Decompiled by JODE
...
public final class Client extends Applet_Sub1 {
	...
	static PacketBuffer secureBuffer = new PacketBuffer();
	...
	static boolean method1229(int i, Class38_Sub6 class38_sub6) {
		try {
		...
		try {
			...
			try {
				...
				if (Class23.packetId == 106) {
					...
					int i_45_ = Class15.inputStream.readUnsignedShortLE();
					...
					Class4.method23(i_45_);
					int i_47_ = Class15.inputStream.readUnsignedShortLE();
					for (int i_48_ = 0; i_47_ > i_48_; i_48_++) {
						int i_49_ = Class15.inputStream.getUByteC();
						if (i_49_ == 255)
							i_49_ = Class15.inputStream.method730(30703 ^ 0x779d);
						...
						Class38_Sub6.method639(i_45_, i_48_, i_49_, i_50_ - 1);
					}
					if (class38_sub6 != null)
				...
				if (Class23.packetId == 42) {
					...
					for (int i_51_ = 0; Class38_Sub20_Sub3_Sub2.anInt3250 > i_51_; i_51_++) {
						Class5.aLongArray97[i_51_] = Class15.inputStream.readLong(-118);
				...
				if (Class23.packetId == 92) {
					int i_54_ = Class15.inputStream.readUnsignedShortLE();
					if (i_54_ == 65535)
						i_54_ = -1;
					int i_55_ = Class15.inputStream.readInt(true);
					int i_56_ = Class15.inputStream.method746(30703 - 30806);
				...
				if (Class23.packetId == 89) {
					...
					for (int i_59_ = class19.method143((byte) 81) - 1; i_59_ >= 0; i_59_--)
						if (class19.method163(114, i_59_) == 115)
							...
							objects[i_59_ + 1] = Class15.inputStream.readInt(true);
					objects[0] = Class15.inputStream.readInt(true);
				...
				if (Class23.packetId == 238) {
					RSString class19 = Class15.inputStream.readString(30703 + 1347387929);
					if (class19.method169(0, Class77.aClass19_1508)) {
						...
						boolean bool = false;
						long l = class19_60_.method162(30703 - 30703);
						...
						if (!bool && Sequence.anInt2731 == 0)
							Class62.method464(Class60.aClass19_1319, 4, class19_60_);
					} else if (class19.method169(30703 - 30703, Class11.aClass19_210)) {
						boolean bool = false;
						...
						if (!bool && Sequence.anInt2731 == 0)
							Class62.method464(Class72.aClass19_1420, 8, class19_62_);
						...
						if (!class19.method169(0, Class44.aClass19_1011)) {
							if (!class19.method169(0, Class21.aClass19_526)) {
								if (class19.method169(0, Class38_Sub20_Sub16.aClass19_3107)) {
									RSString class19_64_ = class19.method144((byte) -8, 0, class19.method170(30703 - 30702, Class38_Sub20_Sub16.aClass19_3107));
									if (Sequence.anInt2731 == 0)
										Class62.method464(class19_64_, 12, Class38_Sub22.aClass19_2312);
								} else if (class19.method169(0, Class32.aClass19_778)) {
									RSString class19_65_ = class19.method144((byte) -113, 0, class19.method170(30703 ^ 0x77ee, Class32.aClass19_778));
									if (Sequence.anInt2731 == 0)
										Class62.method464(class19_65_, 13, Class38_Sub22.aClass19_2312);
								} else
									Class62.method464(class19, 0, Class38_Sub22.aClass19_2312);
							} else {
								RSString class19_66_ = class19.method144((byte) -114, 0, class19.method170(30703 - 30702, Class21.aClass19_526));
								Class62.method464(class19_66_, 11, Class38_Sub22.aClass19_2312);
							}
						} else {
							...
							if (!bool && Sequence.anInt2731 == 0)
								Class62.method464(Class38_Sub22.aClass19_2312, 10, class19_67_);
						}
					} else {
						...
						if (!bool && Sequence.anInt2731 == 0) {
							...
							Class62.method464(class19_71_, 8, class19_69_);
						}
					}
					Class23.packetId = -1;
					return true;
				...
				if (Class23.packetId == 188) {
					Class41.method350(30703 - 40718);
					Class23.packetId = -1;
					return false;
				}
				if (Class23.packetId == 184) {
					long l = Class15.inputStream.readLong(-109);
					int i_72_ = Class15.inputStream.readUnsignedShortLE();
					...
					for (int i_74_ = 0; Class81.anInt1618 > i_74_; i_74_++)
						if (l == Class20.aLongArray499[i_74_]) {
							if (i_72_ != Class41.anIntArray941[i_74_]) {
								...
								if (i_72_ > 0)
									Class62.method464(Class9.method43(new RSString[]{class19, Class38_Sub10_Sub3.aClass19_2834}, (byte) -20), 5, Class38_Sub22.aClass19_2312);
								if (i_72_ == 0)
									Class62.method464(Class9.method43(new RSString[]{class19, Sequence.aClass19_2727}, (byte) -20), 5, Class38_Sub22.aClass19_2312);
							}
				...
				if (Class23.packetId == 68) {
					long l = Class15.inputStream.readLong(-119);
					Class15.inputStream.method765((byte) 120);
					long l_82_ = Class15.inputStream.readLong(-119);
					boolean bool = false;
					long l_83_ = Class15.inputStream.readUnsignedShortLE();
					long l_84_ = Class15.inputStream.method738((byte) 119);
					int i_85_ = Class15.inputStream.getUByte();
					long l_86_ = (l_83_ << 32) - -l_84_;
					...
					if (!bool && Sequence.anInt2731 == 0) {
						...
						RSString class19 = Class38_Sub20_Sub9_Sub1.method1062(Class58.method443((byte) 33, Class15.inputStream).method161());
						if (i_85_ == 2 || i_85_ == 3)
							Sequence.method914(Class9.method43(new RSString[]{Class32.aClass19_775, Class73.method520(l, 1).method167((byte) 52)}, (byte) -20), 9, class19, Class73.method520(l_82_, 1).method167((byte) 52));
						else if (i_85_ == 1)
							Sequence.method914(Class9.method43(new RSString[]{Class38_Sub20_Sub10.aClass19_2911, Class73.method520(l, 1).method167((byte) 52)}, (byte) -20), 9, class19, Class73.method520(l_82_, 30703 ^ 0x77ee).method167((byte) 52));
						else
							Sequence.method914(Class73.method520(l, 30703 - 30702).method167((byte) 52), 9, class19, Class73.method520(l_82_, 1).method167((byte) 52));
					}
					Class23.packetId = -1;
					return true;
				}
				if (Class23.packetId == 111) {
					...
					Class38_Sub8 class38_sub8 = (Class38_Sub8) Class10.aClass14_190.method75(i_91_);
					if (class38_sub8 != null)
						Class48.method388(class38_sub8.anInt2038 != i_90_, (byte) -14, class38_sub8);
					Class60.method454(i_89_, i_90_, i_91_);
					Class23.packetId = -1;
					return true;
				}
				if (Class23.packetId == 38) {
					int i_92_ = Class15.inputStream.method772();
					int i_93_ = Class15.inputStream.readInt(true);
					int i_94_ = Class15.inputStream.method772();
					Class38_Sub6 class38_sub6 = Projectile.method1167(i_93_, 30703 - 30628);
				...
				if (Class23.packetId == 41) {
					...
					RSString class19 = Class15.inputStream.readString(1347418632);
					Class38_Sub6 class38_sub6 = Projectile.method1167(i_97_, 30703 - 30812);
					if (!class19.method175(class38_sub6.aClass19_1876)) {
				...
				if (Class23.packetId == 77) {
					long l = Class15.inputStream.readLong(-120);
					RSString class19 = Class38_Sub20_Sub9_Sub1.method1062(Class58.method443((byte) 33, Class15.inputStream).method161());
					Class62.method464(class19, 6, Class73.method520(l, 1).method167((byte) 52));
					Class23.packetId = -1;
					return true;
				}
				if (Class23.packetId == 142) {
					int i_99_ = Class15.inputStream.method749();
				...
				if (Class23.packetId == 108) {
					...
					Class82.anInt1647 = Class15.inputStream.method772();
					Class23.packetId = -1;
				...
				if (Class23.packetId == 36) {
					Class38_Sub10_Sub3.method939();
					Class23.packetId = -1;
					return true;
				}
				if (Class23.packetId == 119) {
					Class53.method411(Class15.inputStream);
					Class23.packetId = -1;
					return true;
				}
				...
				if (Class23.packetId == 171) {
					int i_103_ = Class15.inputStream.readUnsignedShortLE();
				...
				if (Class23.packetId == 213) {
					for (int i_107_ = 0; i_107_ < Class38_Sub20_Sub15.anInt3073; i_107_++) {
						Class38_Sub20_Sub15 class38_sub20_sub15 = Class37.method326(i_107_);
				...
				if (Class23.packetId == 208) {
					...
					int i_108_ = Class15.inputStream.method756(30703 - 17418);
				...
				if (Class23.packetId == 55) {
					...
					Class38_Sub17.anInt2195 = Class15.inputStream.readUnsignedShortLE();
				...
				if (Class23.packetId == 161) {
					int i_113_ = Class15.inputStream.method730(30703 ^ 0x77dc);
					int i_114_ = Class15.inputStream.readUnsignedShortLE();
					if (i_114_ == 65535)
						i_114_ = -1;
					int i_115_ = Class15.inputStream.method746(30703 ^ ~0x77ae);
					int i_116_ = Class15.inputStream.readUnsignedShortLE();
					if (i_116_ == 65535)
						i_116_ = -1;
					for (int i_117_ = i_114_; i_117_ <= i_116_; i_117_++) {
						long l = ((long) i_113_ << 32) - -(long) i_117_;
						Node Node = Entity.aClass14_3514.method75(l);
						if (Node != null)
							Node.method330(0);
						Entity.aClass14_3514.method80(l, new Class38_Sub11(i_115_));
					}
					Class23.packetId = -1;
					return true;
				}
				...
				if (Class23.packetId == 222) {
					long l = Class15.inputStream.readLong(-102);
					long l_120_ = Class15.inputStream.readUnsignedShortLE();
					long l_121_ = Class15.inputStream.method738((byte) 90);
					long l_122_ = (l_120_ << 32) + l_121_;
					boolean bool = false;
					...
					if (!bool && Sequence.anInt2731 == 0) {
						...
						if (i_123_ == 2 || i_123_ == 3)
							Class62.method464(class19, 7, Class9.method43(new RSString[]{Class32.aClass19_775, Class73.method520(l, 30703 ^ 0x77ee).method167((byte) 52)}, (byte) -20));
						else if (i_123_ != 1)
							Class62.method464(class19, 3, Class73.method520(l, 30703 ^ 0x77ee).method167((byte) 52));
						else
							Class62.method464(class19, 7, Class9.method43(new RSString[]{Class38_Sub20_Sub10.aClass19_2911, Class73.method520(l, 1).method167((byte) 52)}, (byte) -20));
					}
					Class23.packetId = -1;
					return true;
				}
				...
				if (Class23.packetId == 99) {
					int i_127_ = Class15.inputStream.readUnsignedShortLE();
					int i_128_ = Class15.inputStream.getUByte();
					int i_129_ = Class15.inputStream.readUnsignedShortLE();
				...
				if (Class23.packetId == 232) {
					...
					if (Class42.anInt962 == 1)
						Class60.anInt1320 = Class15.inputStream.readUnsignedShortLE();
					if (Class42.anInt962 >= 2 && Class42.anInt962 <= 6) {
						...
						Class42.anInt962 = 2;
						Class32.anInt770 = Class15.inputStream.readUnsignedShortLE();
						Class5.anInt93 = Class15.inputStream.readUnsignedShortLE();
						Class38_Sub20_Sub2.anInt2535 = Class15.inputStream.getUByte();
					}
					if (Class42.anInt962 == 10)
						Class62.anInt1344 = Class15.inputStream.readUnsignedShortLE();
					Class23.packetId = -1;
					return true;
				}
				...
				if (Class23.packetId == 2) {
					...
					int i_138_ = Class15.inputStream.readUnsignedShortLE();
					Class38_Sub6 class38_sub6;
					if (i_137_ >= 0)
						class38_sub6 = Projectile.method1167(i_137_, 30703 - 30825);
					else
						class38_sub6 = null;
					if (i_137_ < -70000)
						i_138_ += 32768;
					while (Class15.inputStream.pos < Entity.anInt3446) {
						int i_139_ = Class15.inputStream.method726();
						int i_140_ = Class15.inputStream.readUnsignedShortLE();
						int i_141_ = 0;
						if (i_140_ != 0) {
						...
						Class38_Sub6.method639(i_138_, i_139_, i_141_, i_140_ - 1);
					}
					if (class38_sub6 != null)
				...
				if (Class23.packetId == 239) {
					...
					int i_144_ = Class15.inputStream.readUnsignedShortLE();
					Class38_Sub6 class38_sub6 = Projectile.method1167(i_142_, -114);
					Class23.packetId = -1;
					class38_sub6.anInt1862 = i_143_ + (i_144_ << 16);
					return true;
				}
				...
				if (Class23.packetId == 51) {
					NPC.method1200(Entity.anInt3446, Class15.inputStream, 30703 - 30604, Class38_Sub4.aClass56_1798);
					Class23.packetId = -1;
					return true;
				}
				if (Class23.packetId == 10) {
					...
					if (i_145_ == 65535)
						i_145_ = -1;
					Class4.method26(i_145_, 30703 ^ ~0x5d7f);
					Class23.packetId = -1;
					return true;
				}
				...
				if (Class23.packetId == 94) {
					int i_148_ = Class15.inputStream.method756(30703 - 17418);
				...
				if (Class23.packetId == 25) {
					int i_150_ = Class15.inputStream.readUnsignedShortLE();
					int i_151_ = Class15.inputStream.readInt(true);
					Class38_Sub6 class38_sub6 = Projectile.method1167(i_151_, 30703 ^ 0x77c0);
				...
				if (Class23.packetId == 224) {
					...
					int i_153_ = Class15.inputStream.readUnsignedShortLE();
					int i_154_ = Class15.inputStream.readUnsignedShortLE();
					if (i_153_ != NodeSub.anInt2252) {
						NodeSub.anInt2252 = i_153_;
						method1231(30703 - 30703, NodeSub.anInt2252);
					...
					while (i_154_-- > 0) {
						...
						int i_157_ = Class15.inputStream.readUnsignedShortLE();
						...
						if (class38_sub8 == null)
							class38_sub8 = Class60.method454(i_158_, i_157_, i_156_);
					...
					while (i_152_ > Class15.inputStream.pos) {
						...
						int i_160_ = Class15.inputStream.readUnsignedShortLE();
						int i_161_ = Class15.inputStream.readUnsignedShortLE();
						int i_162_ = Class15.inputStream.readInt(true);
						for (int i_163_ = i_160_; i_161_ >= i_163_; i_163_++) {
							long l = ((long) i_159_ << 32) + i_163_;
							Entity.aClass14_3514.method80(l, new Class38_Sub11(i_162_));
						}
					}
					Class23.packetId = -1;
					return true;
				...
				if (Class23.packetId == 4) {
					...
					long l = Class15.inputStream.readLong(-122);
					if (l == 0L) {
					...
					long l_164_ = Class15.inputStream.readLong(30703 - 30810);
					...
					for (int i_166_ = 0; i_166_ < Class15.anInt300; i_166_++) {
						...
						class38_sub9s[i_166_].aLong898 = Class15.inputStream.readLong(-126);
						class38_sub9s[i_166_].aClass19_2061 = Class73.method520(class38_sub9s[i_166_].aLong898, 1);
						class38_sub9s[i_166_].anInt2063 = Class15.inputStream.readUnsignedShortLE();
					...
					while (i_167_ > 0) {
						...
						for (int i_168_ = 0; i_168_ < i_167_; i_168_++)
							if (class38_sub9s[i_168_].aClass19_2061.method141(class38_sub9s[i_168_ + 1].aClass19_2061) > 0) {
								bool = false;
				...
				if (Class23.packetId == 33) {
					...
					Class64.anInt1358 = Class15.inputStream.getUByteC();
					while (Class15.inputStream.pos < Entity.anInt3446) {
						Class23.packetId = Class15.inputStream.getUByte();
						Class60.method452();
					}
					Class23.packetId = -1;
					return true;
				...
				if (Class23.packetId == 76) {
					...
					Class38_Sub20_Sub15.anInt3071 = Class15.inputStream.readUnsignedShortLE();
				...
				if (Class23.packetId == 130) {
					...
					Class38_Sub6 class38_sub6 = Projectile.method1167(i_181_, 30703 ^ 0x77c6);
				...
				if (Class23.packetId == 46) {
					long l = Class15.inputStream.readLong(-114);
					int i_182_ = Class15.inputStream.readUnsignedShortLE();
					byte i_183_ = Class15.inputStream.method765((byte) 89);
					boolean bool = (l & ~0x7fffffffffffffffL) != 0L;
					if (!bool) {
						...
						for (i_184_ = Class15.anInt300 - 1; i_184_ >= 0; i_184_--) {
							int i_185_ = NPC.aClass38_Sub9Array3557[i_184_].aClass19_2061.method141(class38_sub9.aClass19_2061);
							if (i_185_ == 0) {
				...
				if (Class23.packetId == 5) {
					int i_192_ = Class15.inputStream.readUnsignedShortLE();
					int i_193_ = i_192_ >> 10 & 0x1f;
					int i_194_ = Class15.inputStream.method730(30703 ^ 0x77bf);
					int i_195_ = i_192_ & 0x1f;
					int i_196_ = i_192_ >> 5 & 0x1f;
					Class38_Sub6 class38_sub6 = Projectile.method1167(i_194_, -114);
					int i_197_ = (i_196_ << 11) + (i_193_ << 19) + (i_195_ << 3);
				...
				Class38_Sub20_Sub2.method813(exception, string);
				Class41.method350(-10015);
			}
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "mb.C(" + 30703 + ')');
		}
	}

	static boolean calculatePath(boolean arbitraryDestinationFlag, int i, int fromLocalY, int objectType, int i_25_, int toLocalX, int fromLocalX, int objectFace, int toLocalY, int i_30_, int clickType) {
		for (int x = 0; x < 104; x++)
			for (int y = 0; y < 104; y++) {
				wayPoints[x][y] = 0;
		...
		while (nextIndex != currentIndex) {
			...
			if (objectType != 0)
				if (objectType >= 5 && objectType != 10 || !clippingHeights[height].method537(i, toLocalY, currentY, toLocalX, objectType - 1, currentX)) {
					if (objectType < 10 && clippingHeights[height].method522(toLocalX, objectType - 1, i, currentX, currentY, toLocalY)) {
						foundDestination = true;
						break;
					}
				} else {
			...
			if (i_30_ != 0 && i_25_ != 0 && clippingHeights[height].reachedFacingObject(currentY, i_30_, i_25_, currentX, toLocalY, toLocalX, objectFace)) {
				foundDestination = true;
				break;
			}
		...
		if (currentIndex > 0) {
			...
			if (clickType == 0) { // minimap click
				secureBuffer.putOpcode(184);
				secureBuffer.putByte(maxPathSize + 3 + maxPathSize);
			}
			if (clickType == 1) { // main screen click
				secureBuffer.putOpcode(24);
				secureBuffer.putByte(maxPathSize + maxPathSize + 17);
			}
			if (clickType == 2) { // object click
				secureBuffer.putOpcode(110);
				secureBuffer.putByte(maxPathSize + 3 + maxPathSize);
			}
			secureBuffer.putLEShortA(localX + currentBaseY);
			destX = walkingQueueX[0];
			destY = walkingQueueY[0];
			for (int id = 1; maxPathSize > id; id++) {
				currentIndex--;
				secureBuffer.putByteC(-localX + walkingQueueX[currentIndex]);
				secureBuffer.putByteA(-localY + walkingQueueY[currentIndex]);
			}
			secureBuffer.putByteC(heldKeys[82] ? 1 : 0);
			secureBuffer.putShort(localY + currentBaseX);
			return true;
		}
		return clickType != 1;
	}

	static int keyboardIdleTime() {
		return keyboardIdleTime++;
	}

	static int mouseIdleTime() {
		return mouseIdleTime++;
	}

	static void setMouseIdleTime(int time) {
		mouseIdleTime = time;
	}
	...
	static void method1231(int i, int i_32_) {
		try {
			if (Class22.method196(i_32_)) {
	...
	void method1209() {
		try {
			...
			Class15.method83();
			Class42.method357(-7);
			Class38_Sub20_Sub13.method992();
			Class47.method384(-18075);
			if (Class4.aClass32_91 != null) {
				Class52.anInt1145 = Class4.aClass32_91.method297((byte) 12);
			}
			if (1000 == 1000) {
	...
	private void method1226() {
		do
			try {
							...
							try {
								...
								if (Class47.anInt1046 == 2) {
									...
									class38_sub23.putInt(468);// client
																// revision
									Class38_Sub20_Sub16.aClass31_3098.write(class38_sub23.buffer, 5, (byte) 127);
									Class47.anInt1046++;
									RS2Buffer.aLong2396 = Class9.method48((byte) -60);
								}
								if (Class47.anInt1046 == 3) {
									if (Class48.anInt1069 > 5 && Class38_Sub20_Sub16.aClass31_3098.avaliable((byte) 115) <= 0) {
										if (Class9.method48((byte) -32) + -RS2Buffer.aLong2396 > 30000L) {
											method1228(-2);
											break;
										}
									} else {
										int response = Class38_Sub20_Sub16.aClass31_3098.read(860);
										if (response != 0) {
											method1228(response);
											break;
										}
								...
								if (Class47.anInt1046 == 4) {
									Class50.method398(Class38_Sub20_Sub16.aClass31_3098, Class48.anInt1069 > 20);
									Class47.anInt1046 = 0;
				...
				throw Class38_Sub1.method607(runtimeexception, "client.Q(" + -56 + ')');
			}
		while (false);
	}
	...
	void method1223() {
		try {
			...
			if (bool && Class76.aBool1490 && Class38_Sub6.aClass77_1857 != null)
				Class38_Sub6.aClass77_1857.method557();
			if (Class15.aBool283) {
				Class38_Sub20_Sub3_Sub4.method1157(2 ^ 0x8002, Class38_Sub3.aCanvas1783);
				Class61.method460(Class38_Sub3.aCanvas1783, 2 ^ ~0x2);
				if (Class4.aClass32_91 != null)
					Class4.aClass32_91.method295(Class38_Sub3.aCanvas1783);
				method1219(2 ^ ~0x7331);
				Class9.method44(Class38_Sub3.aCanvas1783);
				...
				if (Class48.anInt1069 == 10)
					...
					if (Class48.anInt1069 != 25) {
						if (Class48.anInt1069 != 30) {
							...
							Class38_Sub20_Sub15.method1009();
					} else if (Class72.anInt1407 != 1) {
						if (Class72.anInt1407 != 2)
							Class53.method409(Class2.aClass19_39, 2 + 16777213, false);
						else {
							...
							Class53.method409(Class9.method43(new RSString[]{Class2.aClass19_39, Entity.aClass19_3438, RuntimeException_Sub1.method1098(i_17_, 0), Class33.aClass19_792}, (byte) -20), 2 ^ 0xfffffd, false);
						}
					} else {
				...
				try {
					...
					for (int i_19_ = 0; Class38_Sub20_Sub11.anInt2957 > i_19_; i_19_++)
						if (Class73_Sub2.aBoolArray2294[i_19_]) {
							Class38_Sub2.aClass2_1768.method17(graphics, Class22.anIntArray536[i_19_], Class64.anIntArray1356[i_19_], Class38_Sub8.anIntArray2045[i_19_], Class67.anIntArray1387[i_19_]);
			...
			throw Class38_Sub1.method607(runtimeexception, "client.E(" + 2 + ')');
		}
	}

	private void method1228(int js5Response) {
		do {
			try {
				...
				ObjectDefinition.aClass65_2461 = null;
				Class38_Sub20_Sub16.aClass31_3098 = null;
				if (Class2.anInt35 >= 2 && (js5Response == 7 || js5Response == 9)) {
					if (Class48.anInt1069 <= 5) {
						method1224("js5connect_full");
						Class48.anInt1069 = 1000;
					} else
						Class76.anInt1499 = 3000;
				} else {
					if (Class2.anInt35 >= 2 && js5Response == 6) {
						method1224("js5connect_outofdate");
						Class48.anInt1069 = 1000;
					} else {
						if (Class2.anInt35 >= 4) {
							if (Class48.anInt1069 > 5) {
				...
				throw Class38_Sub1.method607(runtimeexception, "client.R(" + 1000 + ',' + js5Response + ')');
			}
			break;
		} while (false);
	}
	...
	void method1211() {
		do {
			try {
				NodeSub.js5Port = Player.anInt3582 != 0 ? Class23.anInt556 + 50000 : 43595;
				if ((byte) 85 > 50) {
					...
					SceneModel.worldPort = Player.anInt3582 != 0 ? Class23.anInt556 + 40000 : 43594;
					//Class38_Sub12.currentPort = SceneModel.worldPort;
					Class38_Sub19.method705();
					Class9.method44(Class38_Sub3.aCanvas1783);
					Projectile.method1165(0, Class38_Sub3.aCanvas1783);
					Class4.aClass32_91 = Class38_Sub9.method664();
					if (Class4.aClass32_91 != null)
					...
					try {
						if (Class38_Sub4.aClass56_1798.aClass63_1238 != null) {
							Class17_Sub1.aClass16_1707 = new Class16(Class38_Sub4.aClass56_1798.aClass63_1238, 5200);
							for (int i_27_ = 0; i_27_ < 16; i_27_++)
								Class43.aClass16Array982[i_27_] = new Class16(Class38_Sub4.aClass56_1798.aClass63Array1239[i_27_], 6000);
							Class16.aClass16_333 = new Class16(Class38_Sub4.aClass56_1798.aClass63_1244, 6000);
							Class40.aClass48_917 = new Class48(255, Class17_Sub1.aClass16_1707, Class16.aClass16_333, 500000);
							Class38_Sub20_Sub11.aClass16_2923 = new Class16(Class38_Sub4.aClass56_1798.aClass63_1252, 24);
				...
				throw Class38_Sub1.method607(runtimeexception, "client.F(" + (byte) 85 + ')');
			}
			break;
		} while (false);
	}
	...
	public void init() {
		try {
			if (method1210()) {
				...
				Node.aBool889 = string_28_ != null && string_28_.equals("1");
				...
				method1221(ObjectDefinition.anInt2464 + 32);
			}
		} catch (RuntimeException runtimeexception) {
		...
		do {
			try {
				if (Class48.anInt1069 != 1000) {
					boolean bool_31_ = Class79.method568();
					if (false)
						method1214(-120);
					if (bool_31_)
						break;
				...
				throw Class38_Sub1.method607(runtimeexception, "client.T(" + false + ')');
			}
			break;
		} while (false);
	}
