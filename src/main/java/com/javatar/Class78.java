package com.javatar;/* Class78 - Decompiled by JODE
...
final class Class78 {
	...
	static Class17_Sub1 indexConfigs;
	...
	static final RSString method564(int i) {
		try {
			if (!true)
				return null;
			...
			throw Class38_Sub1.method607(runtimeexception, "jb.B(" + true + ',' + i + ')');
		}
	}
	...
	static final Class77 method567(Class56 class56, int i, int i_2_, Component component) {
		try {
			...
			try {
				...
				if (RSString.anInt456 > 0 && Class40.aClass21_916 == null) {
					...
					class56.method430(RSString.anInt456, Class40.aClass21_916, (byte) 62 ^ 0x4b);
				}
				...
				try {
					...
					class77_sub2.anInt1538 = i_2_;
					if ((byte) 62 != 62)
						Class78.indexConfigs = null;
					class77_sub2.anIntArray1515 = new int[256 * (!Class37.aBool880 ? 1 : 2)];
					class77_sub2.method553(component);
					class77_sub2.anInt1539 = 16384;
					class77_sub2.method554(class77_sub2.anInt1539);
					if (RSString.anInt456 > 0 && Class40.aClass21_916 == null) {
						Class40.aClass21_916 = new Class21();
						Class40.aClass21_916.aClass56_509 = class56;
			...
			throw Class38_Sub1.method607(runtimeexception, "jb.D(" + (class56 != null ? "{...}" : "null") + ',' + i + ',' + i_2_ + ',' + (byte) 62 + ',' + (component != null ? "{...}" : "null") + ')');
		}
	}
}
