package com.javatar;/* Class54 - Decompiled by JODE
...
final class Class54 {
	...
	static final boolean method420(int i) {
		try {
			if (0 != 0)
				Class54.aClass19_1188 = null;
			return (i & 0x1) != 0;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "kb.G(" + i + ',' + 0 + ')');
		}
	}

	static final RSString method421(Class38_Sub6 class38_sub6, int i) {
		try {
			if (12874 != 12874)
				Class54.method419(-49, -116, -108, -125, -109, 41, 113);
			if (!NodeSub.method708(0, Class30.method283(12874 ^ ~0x3233, class38_sub6), i) && class38_sub6.anObjectArray1907 == null)
				return null;
			if (class38_sub6.aClass19Array1851 == null || class38_sub6.aClass19Array1851.length <= i || class38_sub6.aClass19Array1851[i] == null || class38_sub6.aClass19Array1851[i].method178(-91).method143((byte) 71) == 0) {
				if (Node.aBool892)
					return Class9.method43(new RSString[]{NPC.aClass19_3551, RuntimeException_Sub1.method1098(i, 12874 ^ 0x324a)}, (byte) -20);
				return null;
			}
			return class38_sub6.aClass19Array1851[i];
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "kb.D(" + (class38_sub6 != null ? "{...}" : "null") + ',' + i + ',' + 12874 + ')');
		}
	}
		...
		try {
			if (Class38_Sub20_Sub10.anInt2910 < 50 && Class77.anInt1505 != 0 && class38_sub20_sub4.anIntArray2560 != null && i_25_ < class38_sub20_sub4.anIntArray2560.length) {
				...
				if (i_26_ != 0) {
					...
					Class77.anIntArray1531[Class38_Sub20_Sub10.anInt2910] = i_29_ + (i_31_ << 16) + (i_30_ << 8);
	...
	static final void method423() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "kb.E(" + 32 + ')');
		}
	}
