package com.javatar;/* Class38_Sub20_Sub10 - Decompiled by JODE
...
final class Class38_Sub20_Sub10 extends NodeSub {
	...
	static final void method976(int i, int i_0_, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			if (-24253 != -24253)
			...
			if (i_6_ != 0) {
				...
				int i_13_ = i_12_ * i_9_ - i_7_ * i_11_ >> 16;
				i_7_ = i_11_ * i_9_ + i_7_ * i_12_ >> 16;
				i_9_ = i_13_;
			}
			if (i_8_ != 0) {
				int i_14_ = Class38_Sub20_Sub9_Sub4.anIntArray3520[i_8_];
				int i_15_ = Class38_Sub20_Sub9_Sub4.anIntArray3528[i_8_];
				int i_16_ = i_15_ * i_10_ + i_14_ * i_7_ >> 16;
				i_7_ = i_15_ * i_7_ - i_10_ * i_14_ >> 16;
				i_10_ = i_16_;
			}
			...
			throw Class38_Sub1.method607(runtimeexception, "ud.G(" + i + ',' + i_0_ + ',' + -24253 + ',' + i_2_ + ',' + i_3_ + ',' + i_4_ + ',' + i_5_ + ')');
		}
	}
	...
	static final int method978(int i, int i_17_, int i_18_, int i_19_, int i_20_, int i_22_) {
		try {
			i_22_ &= 0x3;
			if ((i_18_ & 0x1) == 1) {
				int i_23_ = i_19_;
			...
			throw Class38_Sub1.method607(runtimeexception, "ud.F(" + i + ',' + i_17_ + ',' + i_18_ + ',' + i_19_ + ',' + i_20_ + ',' + (byte) -62 + ',' + i_22_ + ')');
		}
	}
}
