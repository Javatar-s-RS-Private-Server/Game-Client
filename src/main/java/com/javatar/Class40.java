package com.javatar;/* Class40 - Decompiled by JODE
...
final class Class40 implements Runnable {
	...
	static final void method341() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "t.C(" + 98 + ')');
		}
	}
	...
	static final Class2 method343(int i, int i_3_, Component component) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "t.D(" + i + ',' + i_3_ + ',' + (component != null ? "{...}" : "null") + ',' + 44 + ')');
		}
	}
