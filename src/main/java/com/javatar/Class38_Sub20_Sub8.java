package com.javatar;/* Class38_Sub20_Sub8 - Decompiled by JODE
...
final class Class38_Sub20_Sub8 extends NodeSub {
	...
	static final void method951(Class38_Sub6 class38_sub6) {
		try {
			if (1 != 1)
			...
			throw Class38_Sub1.method607(runtimeexception, "ee.I(" + 1 + ',' + (class38_sub6 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final int method955() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ee.H(" + true + ',' + false + ',' + -20683 + ')');
		}
	}

	private void method950(int i) {
		try {
			double d = ((i & 0xff3da0) >> 16) / 256.0;
			double d_3_ = ((i & 0xff58) >> 8) / 256.0;
			double d_4_ = d;
			if (d_3_ < d_4_)
				d_4_ = d_3_;
			...
			throw Class38_Sub1.method607(runtimeexception, "ee.J(" + i + ',' + true + ')');
		}
	}

	final void method953(int i, RS2Buffer class38_sub23) {
		try {
			if (false)
			...
			for (; ; ) {
				...
				if (i_11_ == 0)
					break;
				method956(i, class38_sub23, i_11_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ee.L(" + false + ',' + i + ',' + (class38_sub23 != null ? "{...}" : "null") + ')');
		}
	}

	final void method954() {
		try {
			if ((byte) 116 < 115)
				Class38_Sub20_Sub8.aClass19_2869 = null;
			method950(anInt2859);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ee.G(" + (byte) 116 + ')');
		}
	}

	private void method956(int i, RS2Buffer class38_sub23, int i_15_) {
		do {
			try {
				int i_16_ = -67 % ((114 - 25) / 35);
				if (i_15_ != 1)
					break;
				anInt2859 = class38_sub23.method738((byte) 85);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "ee.K(" + i + ',' + 114 + ',' + (class38_sub23 != null ? "{...}" : "null") + ',' + i_15_ + ')');
			}
			break;
		} while (false);
	}
