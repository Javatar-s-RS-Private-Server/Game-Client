package com.javatar;/* Class28 - Decompiled by JODE
...
final class Class28 {
	...
	static final void method271(int i, int i_0_, Class17_Sub1 class17_sub1, Class48 class48) {
		try {
			...
			if (is != null)
				class17_sub1.method602(true, is, i_0_, class48);
			else {
				if (i < 107)
					Class28.method273(53, -99, -98, 52);
				byte[] is_1_ = class48.method391(i_0_);
				class17_sub1.method602(true, is_1_, i_0_, class48);
			}
	...
	static final void method273(int i, int i_2_, int i_3_, int i_4_) {
		try {
			...
			if (Class38_Sub20_Sub17.anInt3129 < 3)
				...
				Class38_Sub20_Sub9.method974(i_2_, i, Class38_Sub6.anIntArray1967, Class40.anIntArray919);
