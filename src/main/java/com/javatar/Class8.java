package com.javatar;/* Class8 - Decompiled by JODE
...
final class Class8 {
	...
	private final int[][][] anIntArrayArrayArray143 = new int[2][2][4];
	private final int[] anIntArray147 = new int[2];
	private final int[][][] anIntArrayArrayArray148 = new int[2][2][4];
	...
	private static float method38(float f) {
	...
	final void method37(RS2Buffer class38_sub23, Class36 class36) {
		...
		if (i != 0) {
			anIntArray147[0] = class38_sub23.readUnsignedShortLE();
			anIntArray147[1] = class38_sub23.readUnsignedShortLE();
			int i_0_ = class38_sub23.getUByte();
			for (int i_1_ = 0; i_1_ < 2; i_1_++)
				for (int i_2_ = 0; i_2_ < this.anIntArray142[i_1_]; i_2_++) {
					anIntArrayArrayArray148[i_1_][0][i_2_] = class38_sub23.readUnsignedShortLE();
					anIntArrayArrayArray143[i_1_][0][i_2_] = class38_sub23.readUnsignedShortLE();
				}
			for (int i_3_ = 0; i_3_ < 2; i_3_++)
				for (int i_4_ = 0; i_4_ < this.anIntArray142[i_3_]; i_4_++)
					if ((i_0_ & 1 << i_3_ * 4 << i_4_) != 0) {
						anIntArrayArrayArray148[i_3_][1][i_4_] = class38_sub23.readUnsignedShortLE();
						anIntArrayArrayArray143[i_3_][1][i_4_] = class38_sub23.readUnsignedShortLE();
					} else {
	...
	private float method41(int i, int i_14_, float f) {
	...
	private float method42(int i, int i_16_, float f) {
