package com.javatar;/* Class38_Sub17 - Decompiled by JODE
...
final class Class38_Sub17 extends Node {
	...
	static final void method692(int i) {
		do {
			try {
				...
				RSString.method168(Class3.anInt66, Class38_Sub20_Sub13.anInt3011, Class38_Sub6.anInt1976, Class38_Sub20_Sub2.anInt2540);
				if (i >= 21)
					break;
	...
	static final int method694(Class17 class17, Class17 class17_11_) {
		try {
			if (-27706 != -27706)
				Class38_Sub17.aClass19_2186 = null;
			int i_12_ = 0;
			...
			if (class17.method113(Entity.aClass19_3506, Class51.aClass19_1132, -123))
				i_12_++;
			if (class17.method113(Class54.aClass19_1194, Class51.aClass19_1132, -27706 + 27657))
				i_12_++;
			...
			throw Class38_Sub1.method607(runtimeexception, "uc.A(" + -27706 + ',' + (class17 != null ? "{...}" : "null") + ',' + (class17_11_ != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final void method695() {
		try {
			while (Class15.inputStream.method787((byte) -95, Entity.anInt3446) >= 27) {
				int i = Class15.inputStream.method785(15);
				if (i == 32767)
					break;
				...
				int i_14_ = PlayerAppearance.anIntArray418[Class15.inputStream.method785(3)];
				if (bool_13_)
					class38_sub20_sub3_sub7_sub1.anInt3488 = class38_sub20_sub3_sub7_sub1.anInt3491 = i_14_;
				int i_15_ = Class15.inputStream.method785(5);
				int i_16_ = Class15.inputStream.method785(1);
				if (i_15_ > 15)
					i_15_ -= 32;
				if (i_16_ == 1)
					ItemDefinition.anIntArray2797[Class38_Sub20_Sub15.anInt3064++] = i;
				class38_sub20_sub3_sub7_sub1.aClass38_Sub20_Sub5_3543 = Class38_Sub20_Sub3_Sub4.method1156(-103, Class15.inputStream.method785(14));
				int i_17_ = Class15.inputStream.method785(1);
				int i_18_ = Class15.inputStream.method785(5);
				...
				if (class38_sub20_sub3_sub7_sub1.anInt3439 == 0)
					class38_sub20_sub3_sub7_sub1.anInt3491 = 0;
			...
			throw Class38_Sub1.method607(runtimeexception, "uc.C(" + true + ')');
		}
	}
	...
	static final void method696() {
		try {
				...
				if (class38_sub20_sub3_sub6.graphicId == Client.height && class38_sub20_sub3_sub6.anInt3409 >= Class45.anInt1016) {
					if (Class45.anInt1016 >= class38_sub20_sub3_sub6.anInt3424) {
						if (class38_sub20_sub3_sub6.anInt3421 > 0) {
							...
							if (class38_sub20_sub3_sub7_sub1 != null && class38_sub20_sub3_sub7_sub1.anInt3493 >= 0 && class38_sub20_sub3_sub7_sub1.anInt3493 < 13312 && class38_sub20_sub3_sub7_sub1.anInt3444 >= 0 && class38_sub20_sub3_sub7_sub1.anInt3444 < 13312)
								class38_sub20_sub3_sub6.method1170(class38_sub20_sub3_sub7_sub1.anInt3444, class38_sub20_sub3_sub7_sub1.anInt3493, (byte) -55, Class45.anInt1016, Class35.method317((byte) 80 ^ ~0x1637, class38_sub20_sub3_sub6.graphicId, class38_sub20_sub3_sub7_sub1.anInt3493, class38_sub20_sub3_sub7_sub1.anInt3444) - class38_sub20_sub3_sub6.startTime);
						}
						if (class38_sub20_sub3_sub6.anInt3421 < 0) {
			...
			throw Class38_Sub1.method607(runtimeexception, "uc.D(" + (byte) 80 + ')');
		}
	}
}
