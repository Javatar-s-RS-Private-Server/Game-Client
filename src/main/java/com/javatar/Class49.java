package com.javatar;/* Class49 - Decompiled by JODE
...
final class Class49 {
	...
	static final void method394(int i, int i_0_, int i_1_, int i_3_) {
		do {
			try {
				Class38_Sub20_Sub9.method971(i_0_, i_3_, i + i_0_, i_1_ + i_3_);
				Class38_Sub20_Sub9_Sub4.method1191();
				RuntimeException_Sub1.anInt3293++;
				Class38_Sub10_Sub1.method854(true);
				ItemDefinition.method923(true);
				Class38_Sub10_Sub1.method854(false);
				ItemDefinition.method923(false);
				Class38_Sub17.method696();
				Class4.method28();
				...
				Class37.method325(i_1_, i_3_, i_0_, i);
				Class83.method589(i_0_, i_3_, 28);
				((Class45) Class38_Sub20_Sub9_Sub4.anInterface3_3533).method377(Canvas_Sub1.anInt2529);
				Class38_Sub20_Sub3_Sub4.method1155(i_3_, i_1_, i_0_, i);
				Class11.anInt208 = i_7_;
				Class2.anInt30 = i_8_;
				Class38_Sub18.anInt2209 = i_10_;
				Class3.anInt44 = i_9_;
				Entity.anInt3464 = i_11_;
				if (Class28.aBool680 && Class38_Sub20_Sub8.method955() == 0)
				...
				if (Class28.aBool680 || SceneModel.aBool2553 || i_14_ < i_0_ || i_14_ >= i + i_0_ || i_3_ > i_15_ || i_3_ + i_1_ <= i_15_)
					break;
				Class23.method199(i_14_, i_3_, i_0_, i_15_);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "kf.A(" + i + ',' + i_0_ + ',' + i_1_ + ',' + (byte) 117 + ',' + i_3_ + ')');
			}
			break;
		} while (false);
	}
