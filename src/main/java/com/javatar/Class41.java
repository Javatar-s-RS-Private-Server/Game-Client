package com.javatar;/* Class41 - Decompiled by JODE
	...
	static final void method344() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "na.F(" + 10649 + ')');
			}
			break;
		} while (false);
	}
		...
		try {
			if (l != 0L)
				if (Class81.anInt1618 >= 100 && Class15.anInt272 != 1 || Class81.anInt1618 >= 200)
					Class62.method464(ItemDefinition.aClass19_2792, 0, Class38_Sub22.aClass19_2312);
				else {
					...
					for (int i_0_ = 0; Class81.anInt1618 > i_0_; i_0_++)
						if (Class20.aLongArray499[i_0_] == l) {
							Class62.method464(Class9.method43(new RSString[]{class19, Class38_Sub20_Sub11.aClass19_2952}, (byte) -20), 0, Class38_Sub22.aClass19_2312);
							return;
						}
	...
	static final void method349() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "na.J(" + 2 + ')');
			}
			break;
		} while (false);
	}
		...
		do {
			try {
				...
				if (Entity.anInt3446 != Class15.inputStream.pos)
					throw new RuntimeException("gpp1 pos:" + Class15.inputStream.pos + " psize:" + Entity.anInt3446);
