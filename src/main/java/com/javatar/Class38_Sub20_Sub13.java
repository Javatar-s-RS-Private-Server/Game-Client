package com.javatar;/* Class38_Sub20_Sub13 - Decompiled by JODE
...
final class Class38_Sub20_Sub13 extends NodeSub {
	...
	Class38_Sub20_Sub13(Class17 class17, Class17 class17_29_, int i, boolean bool) {
		try {
			...
			int i_30_ = class17.method103(i);
			this.aClass7Array3018 = new Animation[i_30_];
			int[] is = class17.method110(i, 20);
			for (int j : is) {
				Class38_Sub14 class38_sub14 = null;
				byte[] is_32_ = class17.method109(i, j, -104);
				int i_33_ = (is_32_[0] & 0xff) << 8 | is_32_[1] & 0xff;
				...
				this.aClass7Array3018[j] = new Animation(is_32_, class38_sub14);
			}
	...
	static final void method992() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "rc.G(" + 103 + ')');
		}
	}
	...
	static final int method995(int i, int i_28_) {
		try {
			i_28_ = (i_28_ & 0x55555555) + (i_28_ >>> 1 & 0x55555555);
			i_28_ = ((i_28_ & ~0x33333332) >>> 2) + (i_28_ & 0x33333333);
			i_28_ = i_28_ + (i_28_ >>> 4) & 0xf0f0f0f;
			if (i > -49)
