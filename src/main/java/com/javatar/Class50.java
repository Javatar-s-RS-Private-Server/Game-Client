package com.javatar;/* Class50 - Decompiled by JODE
...
final class Class50 {
	...
	static final void method398(Class31 class31, boolean bool) {
		try {
			...
			if (71 >= 35) {
				...
				for (; ; ) {
					...
					if (class38_sub20_sub2 == null)
						break;
					Sequence.aClass14_2713.method80(class38_sub20_sub2.aLong898, class38_sub20_sub2);
					Class15.anInt291++;
					Class78.anInt1561--;
				}
				for (;;) {
					...
					Class40.aClass14_914.method80(class38_sub20_sub2.aLong898, class38_sub20_sub2);
					Class20.anInt502++;
					RS2Buffer.anInt2406--;
				}
			...
			throw Class38_Sub1.method607(runtimeexception, "tc.A(" + (class31 != null ? "{...}" : "null") + ',' + 71 + ',' + bool + ')');
		}
	}
	...
	static final void method401() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "tc.D(" + -5560 + ')');
		}
	}
}
