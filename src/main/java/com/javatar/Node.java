package com.javatar;/* Node - Decompiled by JODE
...
class Node {
    ...
    static Class17_Sub1 indexInstruments;
    ...
    static final ItemDefinition forId(int i, int i_0_) {
        try {
            ...
            class38_sub20_sub6.method927();
            if (class38_sub20_sub6.anInt2767 != -1)
                class38_sub20_sub6.method936(Node.forId(class38_sub20_sub6.anInt2790, 80), Node.forId(class38_sub20_sub6.anInt2767, 116));
    ...
    static void writeUID(RS2Buffer buffer) {
        do {
            try {
                byte[] is = new byte[24];
                if (Class38_Sub20_Sub11.aClass16_2923 != null) {
                    try {
                        ...
                        int i_1_ = 0;
                        Class38_Sub20_Sub11.aClass16_2923.method95(is);
                        for (/**/; i_1_ < 24; i_1_++)
                            if (is[i_1_] != 0)
                                break;
                        if (i_1_ >= 24)
                ...
                buffer.putBytes(24, is);
                break;
            } catch (RuntimeException runtimeexception) {
                throw Class38_Sub1.method607(runtimeexception, "v.LB(" + (buffer != null ? "{...}" : "null") + ',' + (byte) -83 + ')');
            }
        } while (false);
    }
