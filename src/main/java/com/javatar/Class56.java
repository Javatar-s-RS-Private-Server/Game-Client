package com.javatar;/* Class56 - Decompiled by JODE
...
public class Class56 implements Runnable {
	...
	public final Class65 method428(boolean bool, Class var_class, String string) {
		if (!bool)
			return null;
		return method437(2, 0, new Object[]{var_class, string}, 9);
	}

	private void method429(int i, String string, int i_1_) {
		if (i < 32 || i > 34)
			i = 32;
		...
		for (int i_3_ = 0; i_3_ < 2; i_3_++)
			for (String value : strings_2_)
				for (String s : strings) {
					try {
						if (s.length() > 0 && !new File(s).exists())
							continue;
						File file = new File(s + value);
						...
						if (aClass63_1252 == null)
							try {
								...
								if (i_3_ == 1 || file_7_.exists())
									aClass63_1252 = new Class63(file_7_, 25L);
							} catch (Exception exception) {
								aClass63_1252 = null;
							}
						if (aFile1247 == null)
							try {
								...
								if (i_3_ == 0 && !file_8_.exists())
									continue;
								aClass63_1238 = new Class63(file_8_, 52428800L);
								aClass63Array1239 = new Class63[i_1_];
								for (int i_9_ = 0; i_9_ < i_1_; i_9_++)
									aClass63Array1239[i_9_] = new Class63(new File(file, "main_file_cache.idx" + i_9_), 1048576L);
								aClass63_1244 = new Class63(new File(file, "main_file_cache.idx255"), 1048576L);
	...
	public final Class65 method430(int i, Runnable runnable, int i_13_) {
		if (i_13_ <= 101)
			return null;
		return method437(2, i, runnable, 2);
	}
	...
	public final void method431(int i) {
		...
		if (i == 4) {
			...
			if (aClass63Array1239 != null)
				for (Class63 class63 : aClass63Array1239)
					if (class63 != null)
						try {
							class63.method471(0);
						} catch (java.io.IOException ioexception) {
