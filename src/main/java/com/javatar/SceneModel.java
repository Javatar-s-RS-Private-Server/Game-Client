package com.javatar;/* SceneModel - Decompiled by JODE
...
abstract class SceneModel extends NodeSub {
	...
	void method818(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
		do {
			try {
				Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1 = method820();
				if (class38_sub20_sub3_sub1 == null)
					break;
				this.height = class38_sub20_sub3_sub1.height;
	...
	Class38_Sub20_Sub3_Sub1 method820() {
		try {
			if ((byte) 109 != 109)
				SceneModel.aBool2553 = false;
			return null;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "dd.E(" + (byte) 109 + ')');
		}
	}
}
