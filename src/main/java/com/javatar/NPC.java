package com.javatar;/* NPC - Decompiled by JODE
					...
					if (i_5_ != 0 && i_5_ != 1 && i_5_ != 2) {
						if (i_5_ == 3 || i_5_ == 4) {
							String string = new String(stream.readString(
									1347418632).method158());
							String string_6_ = new String(stream
									.readString(1347418632).method158());
	...
	static final void method1201() {
		do {
			try {
				...
				throw Class38_Sub1
						.method607(runtimeexception, "q.I(" + (byte) -53 + ')');
			}
			break;
		} while (false);
	}

	static final boolean method1202(RSString class19) {
		try {
			if (class19 == null)
				return false;
			int i_14_ = 0;
			...
			throw Class38_Sub1.method607(runtimeexception, "q.K(" + (byte) -108 + ','
					+ (class19 != null ? "{...}" : "null") + ')');
		}
	}
	...
	final Class38_Sub20_Sub3_Sub1 method820() {
		try {
			...
			Class38_Sub20_Sub4 class38_sub20_sub4 = this.currentAnimationId == -1
					|| this.anInt3461 != 0 ? null : Sequence.forID(
					(byte) 120, this.currentAnimationId);
			if ((byte) 109 != 109)
				NPC.method1200(80, null, 28, null);
			Class38_Sub20_Sub4 class38_sub20_sub4_0_ = this.anInt3454 != -1
					&& (this.anInt3454 != this.idleAnimation || class38_sub20_sub4 == null) ? Sequence
					.forID((byte) 87, this.anInt3454) : null;
			Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1 = this.aClass38_Sub20_Sub5_3543
					.method919(class38_sub20_sub4_0_,
							this.anInt3471, class38_sub20_sub4,
							(byte) 90, this.anInt3474);
			...
			if (this.anInt3477 != -1
				...
				Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1_1_ = Class38_Sub11
						.method673(this.anInt3477, 127).method984(
								123, this.anInt3500);
			...
			throw Class38_Sub1.method607(runtimeexception, "q.E(" + (byte) 109 + ')');
		}
	}
}
