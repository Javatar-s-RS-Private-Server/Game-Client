package com.javatar;/* Class38_Sub20_Sub4 - Decompiled by JODE
...
final class Class38_Sub20_Sub4 extends NodeSub {
		...
		do {
			try {
				...
				if (i_2_ == 81) {
					...
					if (bool)
						break;
					Class62.method464(Class9.method43(new RSString[]{Sequence.aClass19_2739, class19_3_}, (byte) -20), 0, Class38_Sub22.aClass19_2312);
				}
			} catch (RuntimeException runtimeexception) {
	...
	final void method823(RS2Buffer class38_sub23) {
		try {
			int i_0_ = 52 % (((byte) 117 - 4) / 41);
			for (; ; ) {
				int i_1_ = class38_sub23.getUByte();
				if (i_1_ == 0)
					break;
				method826(class38_sub23, i_1_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "vc.G(" + (class38_sub23 != null ? "{...}" : "null") + ',' + (byte) 117 + ')');
		}
	}

	final Class38_Sub20_Sub3_Sub1 method825(int i, int i_5_, Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1) {
		try {
			i_5_ = this.anIntArray2585[i_5_];
			Class38_Sub20_Sub13 class38_sub20_sub13 = Class23.method202(i_5_ >> 16);
			i_5_ &= 0xffff;
			...
			throw Class38_Sub1.method607(runtimeexception, "vc.F(" + i + ',' + i_5_ + ',' + (class38_sub20_sub3_sub1 != null ? "{...}" : "null") + ',' + (byte) -124 + ')');
		}
	}

	private void method826(RS2Buffer stream, int i) {
		try {
			if ((byte) 93 <= 22)
				method831(93);
			if (i == 1) {
			...
			throw Class38_Sub1.method607(runtimeexception, "vc.O(" + (stream != null ? "{...}" : "null") + ',' + i + ',' + (byte) 93 + ')');
		}
	}

	final Class38_Sub20_Sub3_Sub1 method827(Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1, int i) {
		try {
			i = this.anIntArray2585[i];
			Class38_Sub20_Sub13 class38_sub20_sub13 = Class23.method202(i >> 16);
			i &= 0xffff;
			if (class38_sub20_sub13 == null)
			...
			throw Class38_Sub1.method607(runtimeexception, "vc.N(" + true + ',' + (class38_sub20_sub3_sub1 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	final Class38_Sub20_Sub3_Sub1 method829(int i_21_, Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1) {
		try {
			int i_22_ = this.anIntArray2585[i_21_];
			Class38_Sub20_Sub13 class38_sub20_sub13 = Class23.method202(i_22_ >> 16);
			i_22_ &= 0xffff;
			if (class38_sub20_sub13 == null)
				return class38_sub20_sub3_sub1.method1038(true);
			if (-964 != -964)
			...
			if (anIntArray2579 != null && i_21_ < anIntArray2579.length) {
				...
				class38_sub20_sub13_23_ = Class23.method202(i_24_ >> 16);
				i_24_ &= 0xffff;
			}
			...
			throw Class38_Sub1.method607(runtimeexception, "vc.L(" + -964 + ',' + i_21_ + ',' + (class38_sub20_sub3_sub1 != null ? "{...}" : "null") + ')');
		}
	}
	...
	final Class38_Sub20_Sub3_Sub1 method830(int i, Class38_Sub20_Sub4 class38_sub20_sub4_27_, Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1, int i_28_, int i_29_) {
		try {
			...
			Class38_Sub20_Sub13 class38_sub20_sub13 = Class23.method202(i_29_ >> 16);
			i_29_ &= 0xffff;
			if (class38_sub20_sub13 == null)
				return class38_sub20_sub4_27_.method832(class38_sub20_sub3_sub1, i);
			i = class38_sub20_sub4_27_.anIntArray2585[i];
			if (i_28_ != 0)
				return null;
			Class38_Sub20_Sub13 class38_sub20_sub13_30_ = Class23.method202(i >> 16);
			i &= 0xffff;
	...
	final Class38_Sub20_Sub3_Sub1 method832(Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1, int i) {
		try {
			i = this.anIntArray2585[i];
			Class38_Sub20_Sub13 class38_sub20_sub13 = Class23.method202(i >> 16);
			if (0 != 0)
			...
			throw Class38_Sub1.method607(runtimeexception, "vc.E(" + (class38_sub20_sub3_sub1 != null ? "{...}" : "null") + ',' + i + ',' + 0 + ')');
		}
	}
}
