package com.javatar;/* Class38_Sub20_Sub16 - Decompiled by JODE
...
final class Class38_Sub20_Sub16 extends NodeSub {
	...
	private final int[] anIntArray3082;
	...
	static final void method1025(Class74[] class74s, SceneGraph class27) {
		try {
					...
					for (int i_7_ = 0; i_7_ < 104; i_7_++)
						if ((Class82.aByteArrayArrayArray1648[i_5_][i_6_][i_7_] & 0x1) == 1) {
							...
							if ((Class82.aByteArrayArrayArray1648[1][i_6_][i_7_] & 0x2) == 2)
								i_8_--;
							if (i_8_ >= 0)
								class74s[i_8_].method524(i_6_, i_7_);
						}
			...
			for (int i_9_ = 0; i_9_ < 4; i_9_++) {
				...
				for (int i_12_ = 1; i_12_ < 103; i_12_++)
					for (int i_13_ = 1; i_13_ < 103; i_13_++) {
						...
						int i_17_ = (i_15_ << 8) / i_16_;
						int i_18_ = (is[i_13_][i_12_ + 1] >> 3) + (is[i_13_ - 1][i_12_] >> 2) - (-(is[i_13_ + 1][i_12_] >> 3) + -(is[i_13_][i_12_ - 1] >> 2) - (is[i_13_][i_12_] >> 1));
						int i_19_ = 65536 / i_16_;
						int i_20_ = (i_14_ << 8) / i_16_;
						...
						for (int i_34_ = -5; i_34_ < 109; i_34_++) {
							...
							if (i_34_ >= 1 && i_34_ < 103 && (!Class38_Sub4.aBool1811 || (Class82.aByteArrayArrayArray1648[0][i_23_][i_34_] & 0x2) != 0 || (Class82.aByteArrayArrayArray1648[i_9_][i_23_][i_34_] & 0x10) == 0 && Class38_Sub20_Sub8.method949(i_9_, 122, i_34_, i_23_) == Entity.anInt3489)) {
								...
								if (i_37_ > 0 || i_38_ > 0) {
									...
									if (i_9_ > 0) {
										boolean bool = i_37_ != 0 || Class48.aByteArrayArrayArray1084[i_9_][i_23_][i_34_] == 0;
										if (i_38_ > 0 && !Class38_Sub2.method616(i_38_ - 1).aBool3056)
											bool = false;
									...
									if (i_38_ == 0)
										...
										Class38_Sub20_Sub14 class38_sub20_sub14 = Class38_Sub2.method616(i_38_ - 1);
										...
										if (i_55_ < 0) {
											if (class38_sub20_sub14.anInt3034 == 16711935) {
												...
												i_56_ = Class6.method33(0 + 2, class38_sub20_sub14.anInt3050, class38_sub20_sub14.anInt3048, class38_sub20_sub14.anInt3051);
										...
										int i_60_ = 0;
										if (i_57_ != -2)
											i_60_ = Class38_Sub20_Sub9_Sub4.anIntArray3530[Class37.method324(i_57_, 96, 0 ^ 0x6c)];
			...
			throw Class38_Sub1.method607(runtimeexception, "jc.L(" + (class74s != null ? "{...}" : "null") + ',' + 0 + ',' + (class27 != null ? "{...}" : "null") + ')');
		}
	}

	final boolean method1021() {
		try {
			if (anIntArray3097 == null)
				return true;
			boolean bool = true;
			for (int i : anIntArray3097)
				if (!Class38_Sub10_Sub1.aClass17_2646.method116(i, 0))
					bool = false;
			if (125 < 20)
				method1028(55);
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "jc.H(" + 125 + ')');
		}
	}

	final void method1023(RS2Buffer class38_sub23) {
		try {
			for (; ; ) {
				int i_2_ = class38_sub23.getUByte();
				if (i_2_ == 0)
					break;
				method1027(i_2_, class38_sub23);
			}
			int i_3_ = 4 / ((-46 - (byte) 84) / 54);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "jc.F(" + (byte) 84 + ',' + (class38_sub23 != null ? "{...}" : "null") + ')');
		}
	}
	...
	final boolean method1024() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "jc.G(" + (byte) 107 + ')');
		}
	}

	final Model method1026() {
		try {
			if ((byte) -87 >= -73)
				return null;
			if (anIntArray3097 == null)
			...
			throw Class38_Sub1.method607(runtimeexception, "jc.E(" + (byte) -87 + ')');
		}
	}

	private void method1027(int i, RS2Buffer class38_sub23) {
		do {
			try {
				if (i != 1) {
					if (i == 2) {
						...
						for (int i_112_ = 0; i_112_ < i_111_; i_112_++)
							anIntArray3097[i_112_] = class38_sub23.readUnsignedShortLE();
					} else if (i == 3)
						this.aBool3091 = true;
					else if (i != 40) {
						if (i != 41) {
							if (i >= 60 && i < 70)
								anIntArray3082[i - 60] = class38_sub23.readUnsignedShortLE();
						} else {
							...
							for (int i_114_ = 0; i_114_ < i_113_; i_114_++) {
								aShortArray3105[i_114_] = (short) class38_sub23.readUnsignedShortLE();
								aShortArray3090[i_114_] = (short) class38_sub23.readUnsignedShortLE();
							}
						}
					} else {
						...
						for (int i_116_ = 0; i_115_ > i_116_; i_116_++) {
							aShortArray3083[i_116_] = (short) class38_sub23.readUnsignedShortLE();
							aShortArray3103[i_116_] = (short) class38_sub23.readUnsignedShortLE();
						}
					}
				} else
				...
				throw Class38_Sub1.method607(runtimeexception, "jc.I(" + i + ',' + (class38_sub23 != null ? "{...}" : "null") + ',' + (byte) -125 + ')');
			}
			break;
		} while (false);
	}
