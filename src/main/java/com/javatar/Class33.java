package com.javatar;/* Class33 - Decompiled by JODE
...
final class Class33 {
	...
	static Class17_Sub1 soundEffects;
	...
	static final Class38_Sub20_Sub9_Sub3[] method302() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "a.B(" + 9590 + ')');
		}
	}

	static final void method303(int i, int i_3_) {
		do {
			try {
				if ((Class38_Sub20_Sub17.anInt3129 ^ 0xffffffff) == -1 || Class38_Sub20_Sub17.anInt3129 == 3) {
					...
					i_8_ = (Class38_Sub7.anInt2027 + 256) * i_8_ >> 8;
	...
	static final Class38_Sub20_Sub9_Sub2 method305(int i, int i_14_, Class17 class17) {
		try {
			if (!true)
			...
			throw Class38_Sub1.method607(runtimeexception, "a.C(" + i + ',' + i_14_ + ',' + true + ',' + (class17 != null ? "{...}" : "null") + ')');
		}
	}
}
