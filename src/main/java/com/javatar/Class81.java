package com.javatar;/* Class81 - Decompiled by JODE
...
final class Class81 {
	...
	static final void method584(int i_1_) {
		try {
				...
				for (int i_4_ = 1; i_4_ < 103; i_4_++) {
					...
					for (int i_6_ = 1; i_6_ < 103; i_6_++) {
						if ((Class82.aByteArrayArrayArray1648[i_1_][i_6_][i_4_] & 0x18) == 0)
							RuntimeException_Sub1.aClass27_3292.method252(is, i_5_, i_1_, i_6_, i_4_);
						if (i_1_ < 3 && (Class82.aByteArrayArrayArray1648[i_1_ + 1][i_6_][i_4_] & 0x8) != 0)
							RuntimeException_Sub1.aClass27_3292.method252(is, i_5_, i_1_ + 1, i_6_, i_4_);
						i_5_ += 4;
					}
				}
				Class38_Sub17.aClass38_Sub20_Sub9_Sub3_2194.method1124();
				int i_7_ = 228 - (-(int) (Math.random() * 20.0) - ((int) (Math.random() * 20.0) + 228 << 16)) + (238 + (int) (Math.random() * 20.0) - 10 << 8);
				int i_8_ = 238 + (int) (Math.random() * 20.0) - 10 << 16;
			...
			throw Class38_Sub1.method607(runtimeexception, "aa.C(" + (byte) -123 + ',' + i_1_ + ')');
		}
	}

	static final Class38_Sub20_Sub9_Sub3 method585(Class17 class17, RSString class19, RSString class19_20_) {
		try {
			if (32554 != 32554)
				Class81.anInt1619 = 107;
			int i_21_ = class17.method104(class19_20_);
			int i_22_ = class17.method118(class19, i_21_, true);
			return Class38_Sub6.method647(i_22_, class17, i_21_, -1);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "aa.D(" + (class17 != null ? "{...}" : "null") + ',' + (class19 != null ? "{...}" : "null") + ',' + (class19_20_ != null ? "{...}" : "null") + ',' + 32554 + ')');
		}
	}

	final void method583(byte[] is, RS2Buffer class38_sub23) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "aa.B(" + (is != null ? "{...}" : "null") + ',' + (byte) -104 + ',' + (class38_sub23 != null ? "{...}" : "null") + ')');
		}
	}
}
