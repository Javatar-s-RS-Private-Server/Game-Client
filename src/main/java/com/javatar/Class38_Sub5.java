package com.javatar;/* Class38_Sub5 - Decompiled by JODE
...
final class Class38_Sub5 extends Node {
	...
	private final int[] anIntArray1840;
	private final int[] anIntArray1846;
	int anInt1839;
	boolean aBool1842;
	int anInt1843;
	int[] anIntArray1844;
	...
	Class38_Sub5(RS2Buffer class38_sub23) {
		this.anInt1843 = class38_sub23.readUnsignedShortLE();
		...
		for (int i_32_ = 0; i_32_ < i; i_32_++)
			anIntArray1846[i_32_] = class38_sub23.readUnsignedShortLE();
		if (i > 1) {
	...
	final boolean method633(double d, int i, Class17 class17) {
		for (int j : anIntArray1846)
			if (class17.method119(j) == null)
				return false;
		int i_15_ = i * i;
		this.anIntArray1844 = new int[i_15_];
		for (int i_16_ = 0; i_16_ < anIntArray1846.length; i_16_++) {
			Class38_Sub20_Sub9_Sub2 class38_sub20_sub9_sub2 = Class9.method49(class17, anIntArray1846[i_16_]);
