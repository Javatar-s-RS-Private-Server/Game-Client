package com.javatar;/* Class38_Sub20_Sub17 - Decompiled by JODE
...
final class Class38_Sub20_Sub17 extends NodeSub {
	...
	static final int method1033(int i, int i_4_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ac.I(" + i + ',' + false + ',' + i_4_ + ')');
		}
	}
		...
		do {
			try {
				...
				if (!Class37.secondMapRegion) {
					...
					int regionY = Class15.inputStream.readUnsignedShortLE();
					int i_9_ = (-Class15.inputStream.pos + Entity.anInt3446) / 16;
					...
					int localY = Class15.inputStream.readUnsignedShortLE();
					...
					for (int i_15_ = (regionY - 6) / 8; (regionY + 6) / 8 >= i_15_; i_15_++)
						for (int i_16_ = (regionX - 6) / 8; (regionX + 6) / 8 >= i_16_; i_16_++) {
							int i_17_ = i_16_ + (i_15_ << 8);
							if (!bool_13_ || i_16_ != 49 && i_16_ != 149 && i_16_ != 147 && i_15_ != 50 && (i_15_ != 49 || i_16_ != 47)) {
								Class38_Sub12.anIntArray2115[i_9_] = i_17_;
								Class72.anIntArray1409[i_9_] = Class48.indexMaps.method104(Class9.method43(new RSString[]{Class38_Sub6.aClass19_1880, RuntimeException_Sub1.method1098(i_15_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_16_, 0)}, (byte) -20));
								Class51.anIntArray1131[i_9_] = Class48.indexMaps.method104(Class9.method43(new RSString[]{Class77.aClass19_1528, RuntimeException_Sub1.method1098(i_15_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_16_, 0)}, (byte) -20));
								i_9_++;
							}
						}
					Class38_Sub20_Sub13.updateRegion(height, regionX, regionY, localX, localY, (byte) -128);
				} else {
					int i_18_ = Class15.inputStream.readUnsignedShortLE();
					int i_19_ = Class15.inputStream.method741(55);
					int i_20_ = Class15.inputStream.readUnsignedShortLE();
					...
					for (int i_22_ = 0; i_22_ < 4; i_22_++)
						for (int i_23_ = 0; i_23_ < 13; i_23_++)
							for (int i_24_ = 0; i_24_ < 13; i_24_++) {
								int i_25_ = Class15.inputStream.method785(1);
								if (i_25_ != 1)
									RSString.anIntArrayArrayArray445[i_22_][i_23_][i_24_] = -1;
								else
									RSString.anIntArrayArrayArray445[i_22_][i_23_][i_24_] = Class15.inputStream.method785(26);
							}
					Class15.inputStream.method788();
					int i_26_ = (Entity.anInt3446 - Class15.inputStream.pos) / 16;
					...
					for (int i_30_ = 0; i_30_ < 4; i_30_++)
						for (int i_31_ = 0; i_31_ < 13; i_31_++)
							for (int i_32_ = 0; i_32_ < 13; i_32_++) {
								...
								if (i_33_ != -1) {
									int i_34_ = (i_33_ & 0xffdae4) >> 14;
									int i_35_ = (i_33_ & 0x3fff) >> 3;
									int i_36_ = i_35_ / 8 + (i_34_ / 8 << 8);
									...
									if (i_36_ != -1) {
										...
										int i_39_ = i_36_ >> 8 & 0xff;
										Class72.anIntArray1409[i_26_] = Class48.indexMaps.method104(Class9.method43(new RSString[]{Class38_Sub6.aClass19_1880, RuntimeException_Sub1.method1098(i_39_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_38_, 0)}, (byte) -20));
										Class51.anIntArray1131[i_26_] = Class48.indexMaps.method104(Class9.method43(new RSString[]{Class77.aClass19_1528, RuntimeException_Sub1.method1098(i_39_, 0), Class66.aClass19_1374, RuntimeException_Sub1.method1098(i_38_, 0)}, (byte) -20));
										i_26_++;
									}
								}
							}
	...
	final void method1031(RS2Buffer class38_sub23) {
		try {
			for (; ; ) {
				int i_2_ = class38_sub23.getUByte();
				if (i_2_ == 0)
					break;
				method1032(i_2_, class38_sub23);
			}
			if (109 < 97)
				Class38_Sub20_Sub17.method1036(4);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ac.G(" + (class38_sub23 != null ? "{...}" : "null") + ',' + 109 + ')');
		}
	}

	private void method1032(int i_3_, RS2Buffer class38_sub23) {
		try {
			if (i_3_ == 1) {
				this.anInt3132 = class38_sub23.readUnsignedShortLE();
			...
			throw Class38_Sub1.method607(runtimeexception, "ac.F(" + (byte) -114 + ',' + i_3_ + ',' + (class38_sub23 != null ? "{...}" : "null") + ')');
		}
	}
}
