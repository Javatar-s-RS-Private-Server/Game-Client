package com.javatar.jagex;/* Class38_Sub1 - Decompiled by JODE
...
final class Class38_Sub1 extends Node {
	int anInt1722;
	int[] anIntArray1723;
	static Class17_Sub1 aClass17_Sub1_1724;
	...
	static Class17_Sub1 aClass17_Sub1_1746;
	int anInt1747;
	...
	public static void method608(boolean bool) {
		do {
			try {
				Class38_Sub1.aClass17_Sub1_1724 = null;
				...
				Class38_Sub1.aClass17_Sub1_1746 = null;
				...
				if (bool == true)
					break;
				Class38_Sub1.method610(true, 48);
			} catch (RuntimeException runtimeexception) {
	...
	final void method609(int i) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "oa.E(" + i + ')');
			}
			break;
		} while (false);
	}

	static final int method610(boolean bool, int i) {
		try {
			if (bool != true)
				Class38_Sub1.aClass38_Sub20_Sub9_Sub2_1740 = null;
			return (i & 0x1f976) >> -701292789;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "oa.D(" + bool + ',' + i + ')');
		}
	}
