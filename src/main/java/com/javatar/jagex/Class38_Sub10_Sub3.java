package com.javatar.jagex;/* Class38_Sub10_Sub3 - Decompiled by JODE
...
final class Class38_Sub10_Sub3 extends Class38_Sub10 {
	...
	private Class38_Sub10_Sub1 aClass38_Sub10_Sub1_2832;
	...
	static final void method939(int i) {
		try {
			...
			for (int i_6_ = 0; i_6_ < Class4.anInt81; i_6_++) {
				...
				if (((Entity) Class53.aClass38_Sub20_Sub3_Sub7_Sub1Array1164[i_7_]).anInt3459 != Class45.anInt1016) {
