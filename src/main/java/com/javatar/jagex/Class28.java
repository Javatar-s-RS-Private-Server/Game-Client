package com.javatar.jagex;/* Class28 - Decompiled by JODE
		...
		try {
			...
			synchronized (Class81.aClass13_1616) {
				for (Class38_Sub17 class38_sub17 = (Class38_Sub17) Class81.aClass13_1616.method65(109); class38_sub17 != null; class38_sub17 = (Class38_Sub17) Class81.aClass13_1616.method63(-3))
					if (i_0_ == ((Node) class38_sub17).aLong898 && class48 == class38_sub17.aClass48_2187 && class38_sub17.anInt2185 == 0) {
	...
	static final void method273(int i, int i_2_, int i_3_, int i_4_) {
		try {
			...
			if (Class38_Sub20_Sub17.anInt3129 == 2 || Class38_Sub20_Sub17.anInt3129 == 5)
				...
				int i_6_ = ((Entity) Client.myPlayer).anInt3493 / 32 + 48;
				int i_7_ = -(((Entity) Client.myPlayer).anInt3444 / 32) + 464;
				...
				for (int i_8_ = 0; i_8_ < Applet_Sub1.anInt3627; i_8_++) {
					int i_9_ = -(((Entity) Client.myPlayer).anInt3493 / 32) + Class72.anIntArray1418[i_8_] * 4 + 2;
					int i_10_ = -(((Entity) Client.myPlayer).anInt3444 / 32) + Class35.anIntArray840[i_8_] * 4 + 2;
				...
				for (int i_11_ = 0; i_11_ < 104; i_11_++)
					for (int i_12_ = 0; i_12_ < 104; i_12_++) {
						...
						if (class13 != null) {
							int i_13_ = i_12_ * 4 + 2 - ((Entity) Client.myPlayer).anInt3444 / 32;
							int i_14_ = i_11_ * 4 + 2 - ((Entity) Client.myPlayer).anInt3493 / 32;
				...
				for (int i_15_ = 0; i_15_ < Class4.anInt87; i_15_++) {
					...
					if (class38_sub20_sub3_sub7_sub1 != null && class38_sub20_sub3_sub7_sub1.isVisible()) {
						...
						if (class38_sub20_sub5 != null && class38_sub20_sub5.aBool2722 && class38_sub20_sub5.aBool2689) {
							int i_16_ = ((Entity) class38_sub20_sub3_sub7_sub1).anInt3444 / 32 - ((Entity) Client.myPlayer).anInt3444 / 32;
							int i_17_ = -(((Entity) Client.myPlayer).anInt3493 / 32) + ((Entity) class38_sub20_sub3_sub7_sub1).anInt3493 / 32;
				...
				for (int i_18_ = 0; ItemDefinition.anInt2783 > i_18_; i_18_++) {
					...
					if (class38_sub20_sub3_sub7_sub2 != null && class38_sub20_sub3_sub7_sub2.isVisible()) {
						int i_19_ = -(((Entity) Client.myPlayer).anInt3493 / 32) + ((Entity) class38_sub20_sub3_sub7_sub2).anInt3493 / 32;
						int i_20_ = ((Entity) class38_sub20_sub3_sub7_sub2).anInt3444 / 32 - ((Entity) Client.myPlayer).anInt3444 / 32;
						...
						if (Client.myPlayer.team != 0 && class38_sub20_sub3_sub7_sub2.team != 0 && class38_sub20_sub3_sub7_sub2.team == Client.myPlayer.team)
							bool_22_ = true;
						if (!bool) {
							if (!bool_22_)
				...
				if (Class42.anInt962 != 0 && Class45.anInt1016 % 20 < 10) {
					if (Class42.anInt962 == 1 && Class60.anInt1320 >= 0 && Class60.anInt1320 < Class53.aClass38_Sub20_Sub3_Sub7_Sub1Array1164.length) {
						...
						if (class38_sub20_sub3_sub7_sub1 != null) {
							int i_23_ = ((Entity) class38_sub20_sub3_sub7_sub1).anInt3493 / 32 - ((Entity) Client.myPlayer).anInt3493 / 32;
							int i_24_ = ((Entity) class38_sub20_sub3_sub7_sub1).anInt3444 / 32 - ((Entity) Client.myPlayer).anInt3444 / 32;
					...
					if (Class42.anInt962 == 10 && Class62.anInt1344 >= 0 && Class9.aClass38_Sub20_Sub3_Sub7_Sub2Array152.length > Class62.anInt1344) {
						...
						if (class38_sub20_sub3_sub7_sub2 != null) {
							int i_27_ = ((Entity) class38_sub20_sub3_sub7_sub2).anInt3493 / 32 - ((Entity) Client.myPlayer).anInt3493 / 32;
							int i_28_ = -(((Entity) Client.myPlayer).anInt3444 / 32) + ((Entity) class38_sub20_sub3_sub7_sub2).anInt3444 / 32;
