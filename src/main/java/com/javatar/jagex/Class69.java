package com.javatar.jagex;/* Class69 - Decompiled by JODE
...
final class Class69 {
	...
	private static final byte method485(Class35 class35) {
		return (byte) Class69.method490(1, class35);
	}

	private static final void method486(int[] is, int[] is_0_, int[] is_1_, byte[] is_2_, int i, int i_3_, int i_4_) {
		int i_5_ = 0;
	...
	private static final void method487(Class35 class35) {
		boolean bool = false;
		...
		while (bool_34_) {
			...
			for (int i_37_ = 0; i_37_ < 16; i_37_++) {
				i_35_ = Class69.method485(class35);
				if (i_35_ == 1)
					class35.aBoolArray844[i_37_] = true;
				else
					class35.aBoolArray844[i_37_] = false;
			}
			...
			if (class35.anInt829 == class35.anInt835 + 1 && class35.anInt827 == 0)
				bool_34_ = true;
			else
				bool_34_ = false;
		}
	...
	private static final byte method488(Class35 class35) {
		return (byte) Class69.method490(8, class35);
	}

	static final int method489(byte[] is, int i, byte[] is_87_, int i_88_, int i_89_) {
		synchronized (Class69.aClass35_1396) {
			Class69.aClass35_1396.aByteArray818 = is_87_;
			Class69.aClass35_1396.anInt806 = i_89_;
	...
	private static final int method490(int i, Class35 class35) {
		int i_90_;
		for (;;) {
	...
	private static final void method492(Class35 class35) {
		class35.anInt819 = 0;
		for (int i = 0; i < 256; i++)
	...
	private static final void method493(Class35 class35) {
