package com.javatar.jagex;/* Class34 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Class34 {
	private int[][] anIntArrayArray793;
	...
	final void method306(float[] fs, int i) {
		...
		for (int i_2_ = 2; i_2_ < i_0_; i_2_++) {
			...
			if (i_6_ != 0) {
				...
				if (i_6_ >= i_9_)
					Class34.anIntArray795[i_2_] = i_7_ > i_8_ ? i_6_ - i_8_ + i_5_ : i_5_ - i_6_ + i_7_ - 1;
				else
	...
	private final int method307(int i, int i_16_, int i_17_, int i_18_, int i_19_) {
	...
	private final void method308(int i, int i_25_) {
		if (i < i_25_) {
			int i_26_ = i;
	...
	private static final int method309(int[] is, int i) {
		int i_31_ = is[i];
		int i_32_ = -1;
	...
	private final void method310(int i, int i_36_, int i_37_, int i_38_, float[] fs, int i_39_) {
	...
	private static final int method311(int[] is, int i) {
		int i_48_ = is[i];
		int i_49_ = -1;
	...
	final boolean method313() {
		...
		int i_56_ = 2;
		for (int i_57_ = 0; i_57_ < anIntArray797.length; i_57_++) {
			int i_58_ = anIntArray797[i_57_];
