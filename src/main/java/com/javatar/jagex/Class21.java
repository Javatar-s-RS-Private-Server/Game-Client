package com.javatar.jagex;/* Class21 - Decompiled by JODE
...
final class Class21 implements Runnable {
		...
		try {
			...
			try {
				while (!this.aBool525) {
					...
					Class37.method327(null, this.aClass56_509, 1);
				}
	...
	static final void method194(Class48 class48, int i, byte[] is, int i_6_) {
		try {
			if (i_6_ != -31194)
				Class21.aByteArrayArray507 = null;
			...
			throw Class38_Sub1.method607(runtimeexception, "de.B(" + (class48 != null ? "{...}" : "null") + ',' + i + ',' + (is != null ? "{...}" : "null") + ',' + i_6_ + ')');
		}
	}
