package com.javatar.jagex;/* Class38_Sub16_Sub1 - Decompiled by JODE
...
final class Class38_Sub16_Sub1 extends Class38_Sub16 {
	...
	final Class38_Sub16_Sub1 method996(Class20 class20) {
		this.aByteArray3029 = class20.method184(this.aByteArray3029, (byte) -105);
		this.anInt3028 = class20.method186(this.anInt3028, -111);
	...
	Class38_Sub16_Sub1(int i, byte[] is, int i_0_, int i_1_) {
		this.anInt3028 = i;
