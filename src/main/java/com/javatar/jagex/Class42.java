package com.javatar.jagex;/* Class42 - Decompiled by JODE
			...
			for (int i_2_ = 1; i_1_ - 1 > i_2_; i_2_++) {
				...
				for (int i_5_ = i_4_; i_5_ < 128; i_5_++) {
					...
					if (i_6_ == 0)
						...
						Class38_Sub2.aClass2_1768.anIntArray28[i_0_++] = Class38_Sub10_Sub3.method941(16711680, Class38_Sub10_Sub3.method941(i_6_, 65280) * i_7_ + i_9_ * Class38_Sub10_Sub3.method941(i_8_, 65280)) + Class38_Sub10_Sub3.method941(i_9_ * Class38_Sub10_Sub3.method941(i_8_, 16711935) + Class38_Sub10_Sub3.method941(16711935, i_6_) * i_7_, -16711936) >> 531617576;
					}
				}
				i_0_ += 765 - (-i_4_ + 128);
			}
							...
							if (Class38_Sub20_Sub14.aBoolArray3036[i_29_] || Class38_Sub14.anInt2139 > 1) {
								...
								if (class38_sub6.anInt1868 != 1)
									if (class38_sub6.anInt1868 == 2) {
										...
										if (class38_sub6.anInt1917 == -1) {
											...
											if (class38_sub20_sub6 != null) {
												...
												if (class38_sub20_sub3_sub1 != null) {
													...
													i_71_ = ((SceneModel) class38_sub20_sub3_sub1).height / 2;
												} else
										...
										int i_72_ = Class38_Sub20_Sub9_Sub4.anIntArray3520[class38_sub6.anInt1925] * class38_sub6.anInt1921 >> 123389168;
										int i_73_ = class38_sub6.anInt1921 * Class38_Sub20_Sub9_Sub4.anIntArray3528[class38_sub6.anInt1925] >> 1277596464;
										if (class38_sub20_sub3_sub1 != null)
											if (!class38_sub6.aBool1961)
										...
										if (class38_sub6.anInt1868 == 8 && Class54.aClass38_Sub6_1186 == class38_sub6 && Class38_Sub11.anInt2104 == Class38_Sub14.anInt2144) {
											...
											while (class19.method143((byte) 74) > 0) {
												...
												i_80_ += ((Class38_Sub20_Sub9_Sub1) class38_sub20_sub9_sub1_sub1).anInt3216 + 1;
												if (i_83_ > i_79_)
													i_79_ = i_83_;
											}
											i_79_ += 6;
											...
											while (class19.method143((byte) 125) > 0) {
												...
												i_86_ += ((Class38_Sub20_Sub9_Sub1) class38_sub20_sub9_sub1_sub1).anInt3216 + 1;
											}
										}
										if (class38_sub6.anInt1868 == 9)
											if (class38_sub6.anInt1901 == 1)
												...
												if (i_89_ > i_91_)
													i_91_ = i_89_;
												if (i_91_ != 0) {
													int i_92_ = (class38_sub6.anInt1923 << 1961482352) / i_91_;
													int i_93_ = (class38_sub6.anInt1886 << -765831152) / i_91_;
													if (i_93_ > i_92_)
														i_93_ = -i_93_;
													else
														i_92_ = -i_92_;
													int i_94_ = class38_sub6.anInt1901 * i_93_ >> -1335466159;
													int i_95_ = class38_sub6.anInt1901 * i_93_ + 1 >> 1885842449;
													int i_96_ = class38_sub6.anInt1901 * i_92_ + 1 >> -1233388015;
													int i_97_ = i_92_ * class38_sub6.anInt1901 >> -50663503;
