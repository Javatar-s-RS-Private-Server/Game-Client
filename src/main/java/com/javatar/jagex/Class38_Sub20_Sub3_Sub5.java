package com.javatar.jagex;/* Class38_Sub20_Sub3_Sub5 - Decompiled by JODE
		...
		try {
			if (i_1_ < 128 || i < 128 || i_1_ > 13056 || i > 13056) {
				...
				if (i_0_ > 115) {
					...
					int i_8_ = i_1_ * i_7_ + i * i_6_ >> 1511514352;
					i = -(i_1_ * i_6_) + i * i_7_ >> 706717840;
					i_1_ = i_8_;
					i_8_ = i_5_ * i_3_ - i_4_ * i >> -366018000;
					i = i * i_5_ + i_3_ * i_4_ >> 1575861808;
					i_3_ = i_8_;
					if (i < 50) {
						Class29.anInt703 = -1;
						Class38_Sub20_Sub12.anInt3002 = -1;
					} else {
						Class38_Sub20_Sub12.anInt3002 = (i_3_ << 871288041) / i + 167;
						Class29.anInt703 = (i_1_ << 524878569) / i + 256;
					}
				}
			}
		...
		try {
			if (class38_sub20_sub9_sub3 != null) {
				...
				if (i_14_ <= 6400) {
					...
					int i_17_ = i_16_ * i_11_ - i_12_ * i_15_ >> -332952368;
					int i_18_ = i_11_ * i_15_ + i_16_ * i_12_ >> -1975978832;
					if (i_14_ <= 2500)
