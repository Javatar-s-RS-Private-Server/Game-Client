package com.javatar.jagex;/* Class38_Sub10_Sub2 - Decompiled by JODE
...
final class Class38_Sub10_Sub2 extends Class38_Sub10 {
	...
	final synchronized void method667(int[] is, int i, int i_43_) {
		if (anInt2679 == 0 && anInt2684 == 0)
			...
			Class38_Sub16_Sub1 class38_sub16_sub1 = (Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076;
	...
	private final int method880(int[] is, int i, int i_62_, int i_63_, int i_64_) {
		while (anInt2684 > 0) {
			...
			if (anInt2676 == -256 && (anInt2685 & 0xff) == 0) {
				if (Class37.aBool880)
					i = Class38_Sub10_Sub2.method899(0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, anInt2680, anInt2671, 0, i_65_, i_62_, this);
				else
					i = Class38_Sub10_Sub2.method900(((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, anInt2672, 0, i_65_, i_62_, this);
			} else if (Class37.aBool880)
				i = Class38_Sub10_Sub2.method881(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, anInt2680, anInt2671, 0, i_65_, i_62_, this, anInt2676, i_64_);
			else
				i = Class38_Sub10_Sub2.method877(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, anInt2672, 0, i_65_, i_62_, this, anInt2676, i_64_);
			anInt2684 -= i;
			if (anInt2684 != 0)
				return i;
			if (method895())
		...
		if (anInt2676 == -256 && (anInt2685 & 0xff) == 0) {
			if (Class37.aBool880)
				return Class38_Sub10_Sub2.method875(0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, 0, i_63_, i_62_, this);
			return Class38_Sub10_Sub2.method888(((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, 0, i_63_, i_62_, this);
		}
		if (Class37.aBool880)
			return Class38_Sub10_Sub2.method879(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, 0, i_63_, i_62_, this, anInt2676, i_64_);
		return Class38_Sub10_Sub2.method905(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, 0, i_63_, i_62_, this, anInt2676, i_64_);
	}
	...
	final int method671() {
		...
		i = (i ^ i >> 31) + (i >>> 31);
		if (anInt2674 == 0)
			i -= i * anInt2685 / (((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029.length << 8);
		else if (anInt2674 >= 0)
			i -= i * anInt2682 / ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029.length;
		if (i > 255)
			return 255;
		return i;
	}
	...
	final boolean method891() {
		if (anInt2685 >= 0 && anInt2685 < ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029.length << 8)
			return false;
		return true;
	}
	...
	final synchronized void method894(int i) {
		int i_115_ = ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029.length << 8;
		if (i < -1)
			i = -1;
		if (i > i_115_)
			i = i_115_;
	...
	private final int method896(int[] is, int i, int i_124_, int i_125_, int i_126_) {
		while (anInt2684 > 0) {
			...
			if (anInt2676 == 256 && (anInt2685 & 0xff) == 0) {
				if (Class37.aBool880)
					i = Class38_Sub10_Sub2.method887(0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, anInt2680, anInt2671, 0, i_127_, i_124_, this);
				else
					i = Class38_Sub10_Sub2.method890(((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, anInt2672, 0, i_127_, i_124_, this);
			} else if (Class37.aBool880)
				i = Class38_Sub10_Sub2.method897(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, anInt2680, anInt2671, 0, i_127_, i_124_, this, anInt2676, i_126_);
			else
				i = Class38_Sub10_Sub2.method869(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, anInt2672, 0, i_127_, i_124_, this, anInt2676, i_126_);
			anInt2684 -= i;
			if (anInt2684 != 0)
				return i;
			if (method895())
		...
		if (anInt2676 == 256 && (anInt2685 & 0xff) == 0) {
			if (Class37.aBool880)
				return Class38_Sub10_Sub2.method872(0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, 0, i_125_, i_124_, this);
			return Class38_Sub10_Sub2.method898(((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, 0, i_125_, i_124_, this);
		}
		if (Class37.aBool880)
			return Class38_Sub10_Sub2.method886(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2678, anInt2683, 0, i_125_, i_124_, this, anInt2676, i_126_);
		return Class38_Sub10_Sub2.method902(0, 0, ((Class38_Sub16_Sub1) ((Class38_Sub10) this).aClass38_Sub16_2076).aByteArray3029, is, anInt2685, i, anInt2677, 0, i_125_, i_124_, this, anInt2676, i_126_);
	}
	...
	private Class38_Sub10_Sub2(Class38_Sub16_Sub1 class38_sub16_sub1, int i, int i_190_) {
		((Class38_Sub10) this).aClass38_Sub16_2076 = class38_sub16_sub1;
