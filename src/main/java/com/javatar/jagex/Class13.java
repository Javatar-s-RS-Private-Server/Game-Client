package com.javatar.jagex;/* Class13 - Decompiled by JODE
...
final class Class13 {
	...
	static Class17_Sub1 aClass17_Sub1_237;
			...
			if (class13 == null)
				...
				if (i == -1)
					if (class38_sub20_sub3_sub4 == null)
						...
						int i_8_ = i_1_ + (i_0_ << -729212281) + 1610612736;
	...
	static final boolean method64(int i, int i_9_) {
		try {
			if (i_9_ != -8956)
				Class13.aClass17_Sub1_237 = null;
			if ((i >> -1500007649 & 0x1) == 0)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
