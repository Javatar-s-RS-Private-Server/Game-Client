package com.javatar.jagex;/* Class77 - Decompiled by JODE
...
class Class77 {
	...
	private Class38_Sub10[] aClass38_Sub10Array1535;
	private int anInt1536;
	private long aLong1537;
	int anInt1538;
	int anInt1539;
	private int anInt1540;
	private Class38_Sub10[] aClass38_Sub10Array1541;
	...
	private final void method549(int[] is, int i) {
		int i_2_ = i;
		if (Class37.aBool880)
			i_2_ <<= 1;
		...
		if (aClass38_Sub10_1524 != null && anInt1542 <= 0) {
			...
			Class6.method35((byte) -15, aClass38_Sub10_1524);
			method563(0, aClass38_Sub10_1524, aClass38_Sub10_1524.method671());
			int i_3_ = 0;
			int i_4_ = 255;
			int i_5_ = 7;
			while_12_: while (i_4_ != 0) {
				int i_6_;
				int i_7_;
				if (i_5_ < 0) {
					i_6_ = i_5_ & 0x3;
							...
							if (class38_sub16 != null && class38_sub16.anInt2183 > i_7_) {
								...
								if (class38_sub10_11_ != null) {
									...
									for (/**/; class38_sub10_11_ != null; class38_sub10_11_ = class38_sub10_9_.method668())
										method563(0, class38_sub10_11_, i_12_ * class38_sub10_11_.method671() >> 8);
								}
		...
		if (aClass38_Sub10_1524 != null)
			aClass38_Sub10_1524.method667(is, 0, i);
		aLong1527 = Class9.method48((byte) -34);
	}

	final synchronized void method550(Class38_Sub10 class38_sub10, int i) {
		try {
			aClass38_Sub10_1524 = class38_sub10;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "qc.J(" + (class38_sub10 != null ? "{...}" : "null") + ',' + i + ')');
		}
	}

	static final void method551(boolean bool, RSString class19, RSString class19_16_, RSString class19_17_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "qc.F(" + bool + ',' + (class19 != null ? "{...}" : "null") + ',' + (class19_16_ != null ? "{...}" : "null") + ',' + (class19_17_ != null ? "{...}" : "null") + ')');
		}
	}

	final void method552(boolean bool) {
		try {
			aBool1532 = bool;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "qc.G(" + bool + ')');
		}
	}
	...
	final synchronized void method556(int i) {
		try {
			if (i != 0)
			...
			if (this.anIntArray1515 != null) {
				...
				try {
					...
					while (i_19_ > i_18_) {
						i_18_ += 256;
						method549(this.anIntArray1515, 256);
						method555();
					}
					if (l > aLong1533) {
						if (aBool1532)
			...
			throw Class38_Sub1.method607(runtimeexception, "qc.I(" + i + ')');
		}
	}

	final synchronized void method557(boolean bool) {
		try {
			aBool1532 = bool;
			try {
				method561();
			...
			throw Class38_Sub1.method607(runtimeexception, "qc.O(" + bool + ')');
		}
	}
	...
	private final void method562(int i, int i_20_) {
		do {
			try {
				if (i != 13094)
					anInt1534 = -15;
				...
				if (aClass38_Sub10_1524 == null)
					break;
				aClass38_Sub10_1524.method669(i_20_);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "qc.K(" + i + ',' + i_20_ + ')');
			}
			break;
		} while (false);
	}

	private final void method563(int i, Class38_Sub10 class38_sub10, int i_21_) {
		try {
			if (i != 0)
				anInt1542 = 112;
			int i_22_ = i_21_ >> -438573371;
			...
			throw Class38_Sub1.method607(runtimeexception, "qc.A(" + i + ',' + (class38_sub10 != null ? "{...}" : "null") + ',' + i_21_ + ')');
		}
	}
