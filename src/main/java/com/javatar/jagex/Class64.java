package com.javatar.jagex;/* Class64 - Decompiled by JODE
...
final class Class64 {
	...
	static final void method474(boolean bool) {
		do {
			try {
				if (bool)
				...
				for (int i = 0; Class38_Sub20_Sub10.anInt2910 > i; i++) {
					...
					if (Class76.anIntArray1495[i] < -10) {
						...
						if (class68 == null) {
							class68 = Class68.method484(Class33.aClass17_Sub1_784, ObjectDefinition.anIntArray2442[i], 0);
							if (class68 == null)
								continue;
						...
						if (Class76.anIntArray1495[i] < 0) {
							...
							if (Class77.anIntArray1531[i] == 0)
								...
								int i_4_ = (Class77.anIntArray1531[i] & 0xffc8e2) >> -722212848;
								int i_5_ = i_4_ * 128 + 64 - ((Entity) Client.myPlayer).anInt3493;
								if (i_5_ < 0)
									i_5_ = -i_5_;
								int i_6_ = Class77.anIntArray1531[i] >> -831952120 & 0xff;
								int i_7_ = -((Entity) Client.myPlayer).anInt3444 + i_6_ * 128 + 64;
								if (i_7_ < 0)
									i_7_ = -i_7_;
							...
							if (i_2_ > 0) {
								...
								Class38_Sub10_Sub2 class38_sub10_sub2 = Class38_Sub10_Sub2.method878(class38_sub16_sub1, 100, i_2_);
				...
				if (Class15.anInt302 != 0 && Class38_Sub19.anInt2238 != -1)
					Class38_Sub4.method628(Class67.aClass17_Sub1_1382, -1, Class38_Sub19.anInt2238, Class15.anInt302, false, 0);
				Class76.aBool1490 = false;
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "ce.B(" + bool + ')');
			}
			break;
		} while (false);
	}
