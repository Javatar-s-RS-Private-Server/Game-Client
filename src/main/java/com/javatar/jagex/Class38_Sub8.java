package com.javatar.jagex;/* Class38_Sub8 - Decompiled by JODE
...
final class Class38_Sub8 extends Node {
	...
	static final int method657(int i, int i_0_, int i_1_, byte[] is) {
		try {
			...
			for (int i_3_ = i_0_; i > i_3_; i_3_++)
				i_2_ = i_2_ >>> -555181784 ^ PlayerAppearance.anIntArray415[(i_2_ ^ is[i_3_]) & 0xff];
			if (i_1_ != 25274)
	...
	static final void method659(byte i, Entity class38_sub20_sub3_sub7) {
		do {
			try {
				if (i < 107)
	...
	static final Class38_Sub20_Sub9_Sub2[] method661(int i) {
		try {
			Class38_Sub20_Sub9_Sub2[] class38_sub20_sub9_sub2s = new Class38_Sub20_Sub9_Sub2[Class38_Sub14.anInt2133];
			for (int i_16_ = i; i_16_ < Class38_Sub14.anInt2133; i_16_++) {
			...
			throw Class38_Sub1.method607(runtimeexception, "ue.E(" + i + ')');
		}
	}
