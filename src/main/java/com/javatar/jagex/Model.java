package com.javatar.jagex;/* Model - Decompiled by JODE
...
final class Model extends SceneModel {
	...
	private final void method1130(byte[] is) {
		...
		for (int i_55_ = 0; i_55_ < i; i_55_++) {
			...
			int i_58_ = 0;
			if ((i_56_ & 0x2) != 0)
				i_58_ = class38_sub23_7_.method737(-49152);
			int i_59_ = 0;
			if ((i_56_ & 0x4) != 0)
				i_59_ = class38_sub23_8_.method737(-49152);
		...
		for (int i_65_ = 0; i_65_ < i_12_; i_65_++) {
			...
			if (i_66_ == 1) {
				...
				i_64_ = i_61_;
				i_62_ = class38_sub23.method737(-49152) + i_64_;
				i_64_ = i_62_;
				i_63_ = class38_sub23.method737(-49152) + i_64_;
				i_64_ = i_63_;
	...
	private final void method1136(byte[] is) {
		boolean bool = false;
		...
		for (int i_150_ = 0; i_150_ < i; i_150_++) {
			...
			int i_153_ = 0;
			if ((i_151_ & 0x2) != 0)
				i_153_ = class38_sub23_119_.method737(-49152);
			int i_154_ = 0;
			if ((i_151_ & 0x4) != 0)
				i_154_ = class38_sub23_120_.method737(-49152);
		...
		for (int i_161_ = 0; i_161_ < i_122_; i_161_++) {
			...
			if (i_162_ == 1) {
				...
				i_160_ = i_157_;
				i_158_ = class38_sub23.method737(-49152) + i_160_;
				i_160_ = i_158_;
				i_159_ = class38_sub23.method737(-49152) + i_160_;
				i_160_ = i_159_;
	...
	private final void method1138() {
		if (!aBool3306) {
			...
			for (int i = 0; i < vertexCount; i++) {
				...
				if (i_170_ > anInt3330)
					anInt3330 = i_170_;
				if (-i_169_ > ((SceneModel) this).height)
					((SceneModel) this).height = -i_169_;
				if (i_169_ > anInt3342)
					anInt3342 = i_169_;
			}
			aBool3306 = true;
	...
	private final int method1140(Model class38_sub20_sub3_sub3_172_, int i) {
		int i_173_ = -1;
	...
	private static final int method1141(int i, int i_178_) {
	...
	private static final int method1144(int i) {
		if (i < 2)
			i = 2;
		else if (i > 126)
			i = 126;
	...
	final void method1146(int i) {
		int i_214_ = Model.anIntArray3315[i];
		int i_215_ = Model.anIntArray3309[i];
