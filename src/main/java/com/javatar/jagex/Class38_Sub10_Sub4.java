package com.javatar.jagex;/* Class38_Sub10_Sub4 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Class38_Sub10_Sub4 extends Class38_Sub10 {
	private Class13 aClass13_3078 = new Class13();
	private Class13 aClass13_3079 = new Class13();
		...
		do {
			...
			synchronized (class38_sub13) {
				...
				if (i_2_ < 0) {
					...
					method1016(((Node) class38_sub13).aClass38_894, class38_sub13);
				}
			}
		} while (i_0_ != 0);
	}
