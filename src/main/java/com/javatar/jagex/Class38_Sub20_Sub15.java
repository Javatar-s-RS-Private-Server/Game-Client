package com.javatar.jagex;/* Class38_Sub20_Sub15 - Decompiled by JODE
...
final class Class38_Sub20_Sub15 extends NodeSub {
	...
	final void method1007(RS2Buffer class38_sub23, byte i) {
		do {
			try {
				for (;;) {
				...
				throw Class38_Sub1.method607(runtimeexception, "ie.G(" + (class38_sub23 != null ? "{...}" : "null") + ',' + i + ')');
			}
			break;
		} while (false);
	}
	...
	static final void method1009(byte i) {
		try {
			...
			if (!SceneModel.aBool2553) {
				...
				Class38_Sub17.method692(i ^ 0x75);
			...
			Class3.method19(((Entity) Client.myPlayer).anInt3444, ((Entity) Client.myPlayer).anInt3493, Canvas_Sub1.anInt2529, 0, Client.height);
			Canvas_Sub1.anInt2529 = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ie.E(" + i + ')');
		}
	}
	...
	static final void method1012(byte i) {
		try {
			if (i != -68)
				Class38_Sub20_Sub15.method1013(39);
			Class80.aClass83_1608.method596(-106);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ie.J(" + i + ')');
		}
	}
			...
			if (i == -1)
				for (;;) {
					...
					if (class38_sub17 == null)
						break;
					class38_sub17.aClass17_Sub1_2196.method602(false, false, class38_sub17.aByteArray2191, (int) ((Node) class38_sub17).aLong898, class38_sub17.aClass48_2187);
				}
		} catch (RuntimeException runtimeexception) {
