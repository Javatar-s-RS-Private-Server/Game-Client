package com.javatar.jagex;/* Class79 - Decompiled by JODE
...
final class Class79 {
	...
	private Class17 aClass17_1578;
	private Class14 aClass14_1582 = new Class14(256);
	private Class17 aClass17_1584;
	private Class14 aClass14_1585 = new Class14(256);

	static final boolean method568(int i) {
		try {
			...
			try {
				...
				for (/**/; RS2Buffer.anInt2406 < 20 && Class20.anInt502 > 0; Class20.anInt502--) {
					...
					PlayerAppearance.aClass14_397.method80(true, ((Node) class38_sub20_sub2).aLong898, class38_sub20_sub2);
					RS2Buffer.anInt2406++;
				}
				for (int i_1_ = 0; i_1_ < 100; i_1_++) {
					int i_2_ = Class38_Sub20_Sub17.aClass31_3138.method291((byte) 118);
					if (i_2_ < 0)
						throw new IOException();
					if (i_2_ == 0)
						break;
					...
					if (i_3_ > 0) {
						...
						if (i_12_ == Class38_Sub20_Sub3_Sub2.aClass38_Sub23_3275.pos) {
							if (((Node) Class38_Sub20_Sub4.aClass38_Sub20_Sub2_2564).aLong898 != 16711935L) {
								...
								Class38_Sub20_Sub4.aClass38_Sub20_Sub2_2564.aClass17_Sub1_2544.method597(NodeSub.aBool2251, (int) (((Node) Class38_Sub20_Sub4.aClass38_Sub20_Sub2_2564).aLong898 & 0xffffL), (((Node) Class38_Sub20_Sub4.aClass38_Sub20_Sub2_2564).aLong898 & 0xff0000L) == 16711680L, false, Class38_Sub20_Sub3_Sub2.aClass38_Sub23_3275.buffer);
							} else {
			...
			throw Class38_Sub1.method607(runtimeexception, "jf.B(" + i + ')');
		}
	}
	...
	private final Class38_Sub16_Sub1 method570(int i, int i_19_, int[] is, int i_20_) {
		try {
			...
			aClass14_1585.method80(true, l, class38_sub16_sub1);
			if (is != null)
				is[0] -= class38_sub16_sub1.aByteArray3029.length;
			return class38_sub16_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "jf.F(" + i + ',' + i_19_ + ',' + (is != null ? "{...}" : "null") + ',' + i_20_ + ')');
		}
	}

	static final void method571(boolean bool) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "jf.D(" + bool + ')');
		}
	}

	final Class38_Sub16_Sub1 method572(int i, byte i_22_, int[] is) {
		try {
			if (i_22_ <= 40)
				return null;
			...
			throw Class38_Sub1.method607(runtimeexception, "jf.I(" + i + ',' + i_22_ + ',' + (is != null ? "{...}" : "null") + ')');
		}
	}

	final Class38_Sub16_Sub1 method573(int[] is, byte i, int i_23_) {
		try {
			if (i > -26)
				return null;
			...
			throw Class38_Sub1.method607(runtimeexception, "jf.A(" + (is != null ? "{...}" : "null") + ',' + i + ',' + i_23_ + ')');
		}
	}

	static final void method574(int i, boolean bool) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "jf.C(" + i + ',' + bool + ')');
		}
	}
	...
	private final Class38_Sub16_Sub1 method576(int i, int i_26_, byte i_27_, int[] is) {
		try {
			...
			if (class38_sub15 == null) {
				...
				if (class38_sub15 == null)
					return null;
				aClass14_1582.method80(true, l, class38_sub15);
			}
	...
	static final String method577(int i, Throwable throwable) throws IOException {
		String string;
