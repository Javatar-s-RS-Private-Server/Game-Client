package com.javatar.jagex;/* Class38_Sub20_Sub14 - Decompiled by JODE
...
final class Class38_Sub20_Sub14 extends NodeSub {
	...
	static final void method997(boolean bool, Entity class38_sub20_sub3_sub7) {
		try {
			if (!bool && class38_sub20_sub3_sub7.anInt3439 != 0) {
				...
				if (class38_sub20_sub3_sub7.anInt3502 >= 32768) {
					...
					if (class38_sub20_sub3_sub7_sub2 != null) {
						int i_1_ = -((Entity) class38_sub20_sub3_sub7_sub2).anInt3444 + class38_sub20_sub3_sub7.anInt3444;
						int i_2_ = -((Entity) class38_sub20_sub3_sub7_sub2).anInt3493 + class38_sub20_sub3_sub7.anInt3493;
						if (i_2_ != 0 || i_1_ != 0)
			...
			throw Class38_Sub1.method607(runtimeexception, "ia.G(" + bool + ',' + (class38_sub20_sub3_sub7 != null ? "{...}" : "null") + ')');
		}
	}

	private final void method998(RS2Buffer class38_sub23, int i, int i_6_, int i_7_) {
		try {
			if (i == 1)
			...
			throw Class38_Sub1.method607(runtimeexception, "ia.H(" + (class38_sub23 != null ? "{...}" : "null") + ',' + i + ',' + i_6_ + ',' + i_7_ + ')');
		}
	}

	final void method999(int i) {
		try {
			if (i < 106)
				Class38_Sub20_Sub14.anInt3039 = -9;
			if (this.anInt3030 != -1) {
				method1003(this.anInt3030, 3998);
				this.anInt3040 = this.anInt3048;
				this.anInt3053 = this.anInt3050;
				this.anInt3033 = this.anInt3051;
			}
			method1003(this.anInt3034, 3998);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ia.I(" + i + ')');
		}
	}
	...
	static final Class38_Sub18 method1001(int i, Class17 class17, int i_10_) {
		try {
			if (i_10_ != 0)
				return null;
			...
			throw Class38_Sub1.method607(runtimeexception, "ia.J(" + i + ',' + (class17 != null ? "{...}" : "null") + ',' + i_10_ + ')');
		}
	}
		...
		do {
			try {
				if (Class38_Sub4.aBool1811 && Entity.anInt3489 != Client.height)
					Class38_Sub20_Sub13.updateRegion(Client.height, Class38_Sub17.anInt2193, ItemDefinition.anInt2801, ((Entity) Client.myPlayer).walkQueueX[0], ((Entity) Client.myPlayer).walkQueueY[0], (byte) -128);
				else {
					if (Client.height != Class80.anInt1595) {
						Class80.anInt1595 = Client.height;
						Class81.method584((byte) -123, Client.height);
					}
					if (i == -66)
						break;
				...
				throw Class38_Sub1.method607(runtimeexception, "ia.E(" + i + ')');
			}
			break;
		} while (false);
	}

	private final void method1003(int i, int i_11_) {
		do {
			try {
				double d = ((i & 0xffd3) >> -1940780152) / 256.0;
				double d_12_ = (i & 0xff) / 256.0;
				double d_13_ = 0.0;
				double d_14_ = ((i & 0xff6541) >> -1565588208) / 256.0;
				double d_15_ = d_14_;
				double d_16_ = d_14_;
				if (d > d_16_)
					d_16_ = d;
				...
				throw Class38_Sub1.method607(runtimeexception, "ia.M(" + i + ',' + i_11_ + ')');
			}
			break;
		} while (false);
	}

	static final void method1004(int i, int i_19_, int i_20_, byte i_21_) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "ia.K(" + i + ',' + i_19_ + ',' + i_20_ + ',' + i_21_ + ')');
			}
			break;
		} while (false);
	}
