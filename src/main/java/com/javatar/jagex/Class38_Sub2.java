package com.javatar.jagex;/* Class38_Sub2 - Decompiled by JODE
...
final class Class38_Sub2 extends Node {
	...
	static final int method612(int i) {
		try {
			...
			if (-Class38_Sub18.anInt2209 + i_0_ < 800 && (Class82.aByteArrayArrayArray1648[Client.height][Class11.anInt208 >> 970045223][Class2.anInt30 >> -180243193] & 0x4) != 0)
	...
	static final void method613(Class38_Sub20_Sub9_Sub1_Sub1 class38_sub20_sub9_sub1_sub1, boolean bool, Class38_Sub20_Sub9_Sub1_Sub1 class38_sub20_sub9_sub1_sub1_1_) {
		try {
			Class38_Sub2.anInt1761++;
			if (Player.aClass38_Sub20_Sub9_Sub3Array3587 == null)
				Player.aClass38_Sub20_Sub9_Sub3Array3587 = ItemDefinition.method929(Class54.aClass19_1209, Class17.aClass17_Sub1_376, true, Class51.aClass19_1132);
			if (Canvas_Sub1.aClass38_Sub20_Sub9_Sub2Array2511 == null)
				Canvas_Sub1.aClass38_Sub20_Sub9_Sub2Array2511 = Class37.method329(Class51.aClass19_1132, Class38_Sub20_Sub16.aClass19_3092, -11, Class17.aClass17_Sub1_376);
			if (Class38_Sub10_Sub3.aClass38_Sub20_Sub9_Sub2Array2829 == null)
				Class38_Sub10_Sub3.aClass38_Sub20_Sub9_Sub2Array2829 = Class37.method329(Class51.aClass19_1132, Class83.aClass19_1665, -11, Class17.aClass17_Sub1_376);
			if (Class14.aClass38_Sub20_Sub9_Sub2Array250 == null)
				Class14.aClass38_Sub20_Sub9_Sub2Array250 = Class37.method329(Class51.aClass19_1132, NPC.aClass19_3555, -11, Class17.aClass17_Sub1_376);
			...
			if (Player.aClass38_Sub20_Sub9_Sub3Array3587 != null) {
				...
				for (int i_15_ = 0; Class49.anInt1089 > i_15_; i_15_++) {
					...
					if (i_13_ <= Class23.anInt543 && Class45.anInt1015 >= i_12_ && i + i_13_ > Class23.anInt543 && Class45.anInt1015 < i_5_ + i_12_ && bool_16_) {
						...
						Player.aClass38_Sub20_Sub9_Sub3Array3587[!class4.aBool83 ? 0 : 1].method1122(i_13_, i_12_, 128, 16777215);
					} else
			...
			throw Class38_Sub1.method607(runtimeexception, "ha.D(" + (class38_sub20_sub9_sub1_sub1 != null ? "{...}" : "null") + ',' + bool + ',' + (class38_sub20_sub9_sub1_sub1_1_ != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final int method615(int i, int i_30_) {
		try {
			if (i_30_ < 58)
				Class38_Sub2.method613(null, false, null);
			return (i & 0xee910) >> -1227683375;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ha.F(" + i + ',' + i_30_ + ')');
		}
	}

	static final Class38_Sub20_Sub14 method616(int i, int i_31_) {
		try {
			...
			class38_sub20_sub14.method999(124);
			Class80.aClass83_1608.method590(i_31_, (byte) -122, class38_sub20_sub14);
			return class38_sub20_sub14;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ha.G(" + i + ',' + i_31_ + ')');
		}
	}
	...
	static final void method617(int i) {
		do {
			try {
				for (int i_32_ = -1; ItemDefinition.anInt2783 > i_32_; i_32_++) {
					...
					if (class38_sub20_sub3_sub7_sub2 != null && ((Entity) class38_sub20_sub3_sub7_sub2).anInt3452 > 0) {
						((Entity) class38_sub20_sub3_sub7_sub2).anInt3452--;
						if (((Entity) class38_sub20_sub3_sub7_sub2).anInt3452 == 0)
							((Entity) class38_sub20_sub3_sub7_sub2).aClass19_3467 = null;
					}
				}
				for (int i_34_ = 0; i_34_ < Class4.anInt87; i_34_++) {
					...
					if (class38_sub20_sub3_sub7_sub1 != null && ((Entity) class38_sub20_sub3_sub7_sub1).anInt3452 > 0) {
						((Entity) class38_sub20_sub3_sub7_sub1).anInt3452--;
						if (((Entity) class38_sub20_sub3_sub7_sub1).anInt3452 == 0)
							((Entity) class38_sub20_sub3_sub7_sub1).aClass19_3467 = null;
					}
				}
				if (i == -17471)
					break;
				...
				throw Class38_Sub1.method607(runtimeexception, "ha.A(" + i + ')');
			}
			break;
		} while (false);
	}
