package com.javatar.jagex;/* Class47 - Decompiled by JODE
...
final class Class47 implements Runnable {
	...
	static final void method381(boolean bool) {
		do {
			try {
				...
				int i = Class38_Sub20_Sub11.anInt2943 + ((Entity) Client.myPlayer).anInt3493;
				int i_0_ = NodeSub.anInt2257 + ((Entity) Client.myPlayer).anInt3444;
				...
				int i_1_ = Class38_Sub20_Sub14.anInt3037 >> 1307120327;
				int i_2_ = 0;
				int i_3_ = Class38_Sub3.anInt1780 >> 1071588583;
				...
				throw Class38_Sub1.method607(runtimeexception, "te.C(" + bool + ')');
			}
			break;
		} while (false);
	}
					...
					if (class38_sub17 != null) {
						if (class38_sub17.anInt2185 != 0) {
							if (class38_sub17.anInt2185 == 1) {
								class38_sub17.aByteArray2191 = class38_sub17.aClass48_2187.method391(0, (int) ((Node) class38_sub17).aLong898);
								synchronized (Class81.aClass13_1616) {
									RuntimeException_Sub1.aClass13_3284.method68(class38_sub17, (byte) 104);
								}
							}
						} else {
							class38_sub17.aClass48_2187.method393((byte) -80, (int) ((Node) class38_sub17).aLong898, class38_sub17.aByteArray2191.length, class38_sub17.aByteArray2191);
							synchronized (Class81.aClass13_1616) {
