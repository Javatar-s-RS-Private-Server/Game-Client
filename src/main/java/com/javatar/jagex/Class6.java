package com.javatar.jagex;/* Class6 - Decompiled by JODE
...
final class Class6 {
	...
	static final int method33(int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			if (i_1_ > 243)
				i_2_ /= 2;
			int i_3_ = i_1_ / i + (i_2_ / 32 << 2020735079) + (i_0_ / 4 << 241236682);
			return i_3_;
	...
	static final void method35(byte i, Class38_Sub10 class38_sub10) {
		do {
			try {
				...
				for (Class38_Sub10 class38_sub10_4_ = class38_sub10.method670(); class38_sub10_4_ != null; class38_sub10_4_ = class38_sub10.method668())
					Class6.method35((byte) -15, class38_sub10_4_);
				if (i == -15)
					break;
				Class6.method34(-59);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "oc.A(" + i + ',' + (class38_sub10 != null ? "{...}" : "null") + ')');
			}
			break;
		} while (false);
	}
