package com.javatar.jagex;/* Class29 - Decompiled by JODE
...
final class Class29 {
	...
	static final RSString method276(WidgetComponent class38_sub6, RSString class19, boolean bool) {
		try {
					...
					if (Class38_Sub14.aClass65_2145 != null) {
						...
						try {
							if (Class38_Sub14.aClass65_2145.anObject1365 != null) {
								byte[] is = ((String) Class38_Sub14.aClass65_2145.anObject1365).getBytes("ISO-8859-1");
			...
			throw Class38_Sub1.method607(runtimeexception, "mf.C(" + (class38_sub6 != null ? "{...}" : "null") + ',' + (class19 != null ? "{...}" : "null") + ',' + bool + ')');
		}
	}
	...
	static final void method278(int i, Entity class38_sub20_sub3_sub7) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "mf.B(" + i + ',' + (class38_sub20_sub3_sub7 != null ? "{...}" : "null") + ')');
		}
	}
