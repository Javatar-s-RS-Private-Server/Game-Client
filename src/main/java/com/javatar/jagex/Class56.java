package com.javatar.jagex;/* Class56 - Decompiled by JODE
...
public class Class56 implements Runnable {
	...
	public Class56(boolean bool, Applet applet, int i, String string, int i_20_) {
		...
		try {
			if (applet != null)
				Class56.aMethod1236 = applet.getClass().getMethod("setFocusTraversalKeysEnabled", new Class[] { Boolean.TYPE });
			else
				Class56.aMethod1236 = Class.forName("java.awt.Component").getDeclaredMethod("setFocusTraversalKeysEnabled", new Class[] { Boolean.TYPE });
		} catch (Exception exception) {
			/* empty */
		}
		try {
			if (applet == null)
				Class56.aMethod1250 = Class.forName("java.awt.Container").getDeclaredMethod("setFocusCycleRoot", new Class[] { Boolean.TYPE });
			else
				Class56.aMethod1250 = applet.getClass().getMethod("setFocusCycleRoot", new Class[] { Boolean.TYPE });
		} catch (Exception exception) {
			/* empty */
		}
		if (bool)
