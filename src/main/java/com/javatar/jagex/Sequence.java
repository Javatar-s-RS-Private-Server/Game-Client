package com.javatar.jagex;/* Sequence - Decompiled by JODE
...
final class Sequence extends NodeSub {
	...
	static final void method911(byte i, int i_9_, PacketBuffer class38_sub23_sub1) {
		try {
			if (i != 7)
				Sequence.anInt2741 = 47;
			for (;;) {
				Class38_Sub7 class38_sub7 = (Class38_Sub7) Class76.aClass13_1496.method65(i + 86);
			...
			throw Class38_Sub1.method607(runtimeexception, "o.I(" + i + ',' + i_9_ + ',' + (class38_sub23_sub1 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static byte[] method912(byte[] is) {
		try {
			...
			if (i_18_ != 0) {
				...
				if (i_20_ < 0 || WidgetComponent.anInt1855 != 0 && WidgetComponent.anInt1855 < i_20_)
					throw new RuntimeException();
				byte[] is_21_ = new byte[i_20_];
				if (i_18_ != 1)
					NodeSub.aClass81_2249.method583(is_21_, (byte) -104, class38_sub23);
				else
					Class69.method489(is_21_, i_20_, is, i_19_, 9);
				return is_21_;
			}
	...
	final boolean method913(int i) {
		try {
			...
			if (i != -27678)
				return false;
			if (anInt2693 != -1)
				i_23_ = Player.method1206((byte) -98, anInt2693);
			else if (anInt2687 != -1)
				i_23_ = Class21.anIntArray528[anInt2687];
			if (i_23_ < 0 || i_23_ >= this.anIntArray2715.length || this.anIntArray2715[i_23_] == -1)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "o.P(" + i + ')');
		}
	}

	static final void method914(RSString class19, boolean bool, int i, RSString class19_24_, RSString class19_25_) {
		try {
			for (int i_26_ = 99; i_26_ > 0; i_26_--) {
				...
				WidgetComponent.aClass19Array1945[i_26_] = WidgetComponent.aClass19Array1945[i_26_ - 1];
			...
			WidgetComponent.aClass19Array1945[0] = class19_24_;
			NPC.aClass19Array3558[0] = class19_25_;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "o.J(" + (class19 != null ? "{...}" : "null") + ',' + bool + ',' + i + ',' + (class19_24_ != null ? "{...}" : "null") + ',' + (class19_25_ != null ? "{...}" : "null") + ')');
		}
	}
	...
	final Sequence method915(int i) {
		try {
			int i_27_ = -1;
			if (anInt2693 != -1)
				i_27_ = Player.method1206((byte) -98, anInt2693);
			else if (anInt2687 != -1)
	...
	final void method916(byte i, RS2Buffer class38_sub23) {
		try {
			if (i != -118)
			...
			for (;;) {
				...
				if (i_29_ == 0)
					break;
				readValues(-128, class38_sub23, i_29_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "o.N(" + i + ',' + (class38_sub23 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final Class38_Sub20_Sub4 forID(byte i, int i_31_) {
		try {
			...
			byte[] is = Class62.aClass17_1342.getFileData(12, i_31_, -75);
			class38_sub20_sub4 = new Class38_Sub20_Sub4();
			if (is != null)
				class38_sub20_sub4.method823(new RS2Buffer(is), (byte) 117);
	...
	final Class38_Sub20_Sub3_Sub1 method919(Class38_Sub20_Sub4 class38_sub20_sub4, int i, Class38_Sub20_Sub4 class38_sub20_sub4_32_, byte i_33_, int i_34_) {
		try {
			...
			if (class38_sub20_sub4_32_ != null && class38_sub20_sub4 != null)
				...
				class38_sub20_sub3_sub1_41_ = class38_sub20_sub4_32_.method832(class38_sub20_sub3_sub1, i, 0);
			else if (class38_sub20_sub4 == null)
				class38_sub20_sub3_sub1_41_ = class38_sub20_sub3_sub1.method1038(true);
			else
				class38_sub20_sub3_sub1_41_ = class38_sub20_sub4.method832(class38_sub20_sub3_sub1, i_34_, 0);
	...
	final void method920(byte i) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "o.E(" + i + ')');
			}
			break;
		} while (false);
	}

	private final void readValues(int i, RS2Buffer stream, int opcode) {
		do {
			try {
				if (opcode == 1) {
					...
					if (opcode == 13)
						...
						if (opcode == 15)
							this.anInt2710 = stream.readUnsignedShort();
						else if (opcode != 16) {
							if (opcode != 17) {
								if (opcode < 30 || opcode >= 35) {
									if (opcode != 40) {
										if (opcode != 41) {
											if (opcode == 60) {
												...
												for (int i_46_ = 0; i_45_ > i_46_; i_46_++)
													anIntArray2704[i_46_] = stream.readUnsignedShort();
											} else if (opcode != 93) {
												if (opcode != 95) {
													if (opcode != 97) {
														if (opcode == 98)
															anInt2728 = stream.readUnsignedShort();
														else if (opcode == 99)
															this.aBool2744 = true;
														else if (opcode == 100)
															anInt2692 = stream.readByte((byte) 94);
														else if (opcode == 101)
															anInt2723 = stream.readByte((byte) 105) * 5;
														else if (opcode == 102)
															this.anInt2718 = stream.readUnsignedShort();
														else if (opcode != 103) {
															if (opcode != 106) {
																if (opcode == 107)
																...
																anInt2693 = stream.readUnsignedShort();
																if (anInt2693 == 65535)
																	anInt2693 = -1;
																anInt2687 = stream.readUnsignedShort();
																if (anInt2687 == 65535)
																	anInt2687 = -1;
																int i_47_ = stream.readUnsignedByte();
																this.anIntArray2715 = new int[i_47_ + 1];
																for (int i_48_ = 0; i_48_ <= i_47_; i_48_++) {
																	this.anIntArray2715[i_48_] = stream.readUnsignedShort();
																	if (this.anIntArray2715[i_48_] == 65535)
																		this.anIntArray2715[i_48_] = -1;
																}
															}
														} else
															this.anInt2719 = stream.readUnsignedShort();
													} else
														anInt2707 = stream.readUnsignedShort();
												} else
													this.anInt2699 = stream.readUnsignedShort();
											} else
											...
											for (int i_50_ = 0; i_49_ > i_50_; i_50_++) {
												aShortArray2694[i_50_] = (short) stream.readUnsignedShort();
												aShortArray2698[i_50_] = (short) stream.readUnsignedShort();
											}
										}
									} else {
										...
										for (int i_52_ = 0; i_51_ > i_52_; i_52_++) {
											aShortArray2729[i_52_] = (short) stream.readUnsignedShort();
											aShortArray2721[i_52_] = (short) stream.readUnsignedShort();
										}
									}
								} else {
								...
								this.anInt2703 = stream.readUnsignedShort();
								this.anInt2702 = stream.readUnsignedShort();
								this.anInt2720 = stream.readUnsignedShort();
								this.anInt2712 = stream.readUnsignedShort();
							}
						} else
							this.anInt2686 = stream.readUnsignedShort();
					} else
						this.anInt2703 = stream.readUnsignedShort();
				} else
					this.anInt2697 = stream.readUnsignedByte();
				if (i < -126)
					break;
				Sequence.forID((byte) -30, -75);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "o.K(" + i + ',' + (stream != null ? "{...}" : "null") + ',' + opcode + ')');
			}
			break;
		} while (false);
	}
