package com.javatar.jagex;/* Class17 - Decompiled by JODE
...
abstract class Class17 {
	...
	private boolean aBool375;
	static Class17_Sub1 aClass17_Sub1_376;
	...
	private final boolean method101(int i, int i_0_, int[] is) {
		try {
			...
			if (is == null || is[0] == 0 && is[1] == 0 && is[2] == 0 && is[3] == 0)
				...
				class38_sub23.decryptXTEA(class38_sub23.buffer.length, 478815268, 5, is);
			}
			byte[] is_5_;
			try {
	...
	final int getFileCount(byte i, int i_20_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ea.U(" + i + ',' + i_20_ + ')');
		}
	}

	final int method104(int i, RSString class19) {
		try {
			if (i != 3)
				return -16;
			class19 = class19.method173(false);
			return aClass44_383.method370((byte) 46, class19.method150(-44));
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ea.IA(" + i + ',' + (class19 != null ? "{...}" : "null") + ')');
		}
	}
	...
	public static void method105(int i) {
		try {
			...
			if (i > 20) {
				...
				Class17.aClass17_Sub1_376 = null;
			}
		} catch (RuntimeException runtimeexception) {
	...
	void method108(byte i, int i_22_) {
		try {
			if (i != -99)
				method122(null, -23, null);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ea.C(" + i + ',' + i_22_ + ')');
		}
	}
	...
	final boolean method111(int i) {
		try {
			boolean bool = true;
			for (int i_27_ = 0; i_27_ < anIntArray378.length; i_27_++) {
				int i_28_ = anIntArray378[i_27_];
	...
	final void method112(byte[] is, int i) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "ea.O(" + (is != null ? "{...}" : "null") + ',' + i + ')');
			}
			break;
		} while (false);
	}
	...
	final boolean method113(RSString class19, RSString class19_49_, int i) {
		try {
			...
			int i_50_ = aClass44_383.method370((byte) 46, class19.method150(-44));
			if (i > -4)
				Class17.aClass19_343 = null;
		...
		do {
			try {
				...
				if (i_57_ != 0) {
					...
					int i_67_ = (i_66_ & 0xdf) >> 1748091814;
					int i_68_ = i_66_ & 0x1f;
					int i_69_ = i_57_ >> 1272466318 & 0x7fff;
				...
				if (i_54_ >= 35) {
					if (i_57_ == 0)
						break;
					int i_74_ = (i_57_ & 0x1fffe200) >> -2093634898;
	...
	final void method115(byte i, RSString class19) {
		do {
			try {
				class19 = class19.method173(false);
				int i_77_ = aClass44_383.method370((byte) 46, class19.method150(-44));
				if (i_77_ >= 0) {
					method108((byte) -99, i_77_);
					if (i == 95)
						break;
	...
	final void method117(int i) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ea.AA(" + i + ')');
		}
	}
	...
	final int method118(RSString class19, int i, boolean bool) {
		try {
			...
			return aClass44Array372[i].method370((byte) 46, class19.method150(-44));
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ea.GA(" + (class19 != null ? "{...}" : "null") + ',' + i + ',' + bool + ')');
		}
	}

	final byte[] method119(int i, int i_81_) {
		try {
			if (i_81_ != -30895)
				Class17.aClass19_343 = null;
			if (anObjectArrayArray356.length == 1)
				return method120(i, i_81_ ^ 0x78cf, 0);
			if (anObjectArrayArray356[i].length == 1)
				return method120(0, i_81_ + 31014, i);
			throw new RuntimeException();
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "ea.V(" + i + ',' + i_81_ + ')');
		}
	}
	...
	final byte[] method120(int i, int i_82_, int i_83_) {
		try {
			...
			byte[] is = Class50.method400(false, 2, anObjectArrayArray356[i_83_][i]);
			return is;
		} catch (RuntimeException runtimeexception) {
	...
	final byte[] method122(RSString class19, int i, RSString class19_87_) {
		try {
			...
			int i_88_ = aClass44_383.method370((byte) 46, class19.method150(-44));
			if (i != 2560)
				method124(-113, false);
	...
	final void method124(int i, boolean bool) {
		try {
			if (bool)
				method107(-102);
			...
			throw Class38_Sub1.method607(runtimeexception, "ea.CA(" + i + ',' + bool + ')');
		}
	}
