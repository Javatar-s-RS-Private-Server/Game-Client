package com.javatar.jagex;/* Projectile - Decompiled by JODE
...
final class Projectile extends SceneModel {
	...
	private Class38_Sub20_Sub4 sequence;
	...
	final void update(int i, int i_0_) {
		do {
			try {
	...
	final Class38_Sub20_Sub3_Sub1 method820(byte i) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "sc.E(" + i + ')');
		}
	}
	...
	static final WidgetComponent method1167(int i, int i_1_) {
		try {
			...
			if (Class62.widgets[i_3_] == null
				...
				boolean bool = Class22.loadWidget(i_3_);
				if (!bool)
					return null;
			}
	...
	static final void method1168(int i, int i_5_, int i_6_, int i_7_, int i_8_,
		...
		try {
			if (Class22.loadWidget(i))
				Class25.method211(Class62.widgets[i],
						i_10_, i_5_, i_6_, i_9_, i_8_, i_7_, i_11_, -1);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1169(int i) {
		try {
			...
			for (int i_12_ = 0; i_12_ < 100; i_12_++)
				WidgetComponent.aClass19Array1945[i_12_] = null;
			...
			for (int i_13_ = 0; i_13_ < 2048; i_13_++) {
				...
				Class38_Sub20_Sub10.appearanceCache[i_13_] = null;
			}
			...
			for (int i_18_ = 0; i_18_ < Class38_Sub20_Sub15.anInt3073; i_18_++) {
				Class38_Sub20_Sub15 class38_sub20_sub15 = Class37.method326(16,
						i_18_);
			...
			if (NodeSub.windowId != -1)
				Class74.method533((byte) 117, NodeSub.windowId);
