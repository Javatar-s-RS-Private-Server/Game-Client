package com.javatar.jagex;/* Class38_Sub15 - Decompiled by JODE
...
final class Class38_Sub15 extends Node {
	...
	private final void method680(byte[] is) {
		...
		for (int i_0_ = 0; i_0_ < i; i_0_++) {
			...
			class38_sub23.method778(i_1_, 0, false, is_3_);
			aByteArrayArray2149[i_0_] = is_3_;
		}
	}

	private static final void method681(byte[] is) {
		Class38_Sub15.method687(is, 0);
		...
		for (int i = 0; i < 2; i++) {
			...
			for (int i_15_ = 0; i_15_ < i_7_; i_15_++)
				is_13_[i_15_] = Class38_Sub21.method716(111, i_15_, i_14_);
			if (i != 0) {
	...
	private final float[] method682(int i) {
		Class38_Sub15.method687(aByteArrayArray2149[i], 0);
		...
		for (int i_42_ = 0; i_42_ < class12.anInt216; i_42_++) {
			...
			class46.method380(fs, i_28_ >> 1, bool_41_);
		}
		if (!bool_40_) {
	...
	private static final void method687(byte[] is, int i) {
		Class38_Sub15.aByteArray2178 = is;
		Class38_Sub15.anInt2166 = i;
