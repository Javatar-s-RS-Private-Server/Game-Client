package com.javatar.jagex;/* Class38_Sub20_Sub3_Sub2 - Decompiled by JODE
...
final class Class38_Sub20_Sub3_Sub2 extends SceneModel {
				...
				if (class38_sub6 != null && class38_sub6.anInt1977 == i && (!class38_sub6.aBool1961 || !Class43.method362(true, class38_sub6))) {
					...
					if (class38_sub6.anInt1868 == 6) {
						...
						if (class38_sub6.anInt1862 != 0 && !class38_sub6.aBool1961) {
							int i_3_ = class38_sub6.anInt1862 >> 3429808;
							int i_4_ = class38_sub6.anInt1862 << 1293383728 >> -1672877936;
	...
	final Class38_Sub20_Sub3_Sub1 method820(byte i) {
		try {
			...
			int i_8_ = anInt3258 + (i_6_ + 1 >> 1623173025);
			int i_9_ = anInt3258 + (i_6_ >> 2129690721);
			int i_10_ = anInt3262 + (i_7_ >> 1807125057);
			int i_11_ = (i_7_ + 1 >> -267314527) + anInt3262;
			int[][] is = Player.anIntArrayArrayArray3566[anInt3249];
			int i_12_ = is[i_8_][i_11_] + is[i_9_][i_11_] + is[i_9_][i_10_] + is[i_8_][i_10_] >> 1106059906;
			int i_13_ = (anInt3258 << 1887430759) + (i_6_ << -46280442);
			int i_14_ = (anInt3262 << 1654298567) + (i_7_ << 1688941510);
			if (i != 109)
				return null;
