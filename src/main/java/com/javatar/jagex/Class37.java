package com.javatar.jagex;/* Class37 - Decompiled by JODE
				...
				if (class38_sub20_sub3_sub7 != null && class38_sub20_sub3_sub7.isVisible()) {
					...
					if (class38_sub20_sub3_sub7.aClass19_3467 != null && (i_7_ >= ItemDefinition.anInt2783 || Class81.anInt1619 == 0 || Class81.anInt1619 == 3 || Class81.anInt1619 == 1 && Class74.method529(-125, ((Player) class38_sub20_sub3_sub7).name))) {
						...
						if (Class29.anInt703 > -1 && Class83.anInt1670 > Class72.anInt1416) {
							...
							Class83.anIntArray1656[Class72.anInt1416] = ((Class38_Sub20_Sub9_Sub1) Class38_Sub11.aClass38_Sub20_Sub9_Sub1_Sub1_2093).anInt3216;
			...
			for (int i_11_ = 0; i_11_ < Class72.anInt1416; i_11_++) {
				...
				if (Class17_Sub1.anInt1710 != 0)
					...
					if (Class83.anIntArray1667[i_11_] == 5) {
						...
						Class38_Sub20_Sub9.method970(i_5_, -((Class38_Sub20_Sub9_Sub1) Class38_Sub11.aClass38_Sub20_Sub9_Sub1_Sub1_2093).anInt3216 - 1 + i_4_ + Class38_Sub20_Sub12.anInt3002, i_5_ + i_6_, Class38_Sub20_Sub12.anInt3002 + 5 + i_4_);
						int i_23_ = 0;
						if (i_22_ >= 25) {
							if (i_22_ > 125)
								i_23_ = i_22_ - 125;
