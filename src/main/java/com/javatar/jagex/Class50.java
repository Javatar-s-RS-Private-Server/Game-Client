package com.javatar.jagex;/* Class50 - Decompiled by JODE
			...
			if (i >= 35) {
				...
				for (;;) {
					...
					if (class38_sub20_sub2 == null)
						break;
					Sequence.aClass14_2713.method80(true, ((Node) class38_sub20_sub2).aLong898, class38_sub20_sub2);
					Class15.anInt291++;
					Class78.anInt1561--;
				}
				for (;;) {
					...
					Class40.aClass14_914.method80(true, ((Node) class38_sub20_sub2).aLong898, class38_sub20_sub2);
					Class20.anInt502++;
					RS2Buffer.anInt2406--;
				}
