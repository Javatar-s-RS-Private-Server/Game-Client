package com.javatar.jagex;/* Class49 - Decompiled by JODE
		...
		do {
			try {
				...
				if (!Class38_Sub21.aBool2280) {
					...
					Class38_Sub20_Sub10.method976(i_5_, Class35.method317(-5736, Client.height, ((Entity) Client.myPlayer).anInt3493, ((Entity) Client.myPlayer).anInt3444) - 50, -24253, i_4_ * 3 + 600, Class38_Sub20_Sub14.anInt3037, i_4_, Class38_Sub3.anInt1780);
				}
				int i_6_;
				if (!Class38_Sub21.aBool2280)
