package com.javatar.jagex;/* Class38_Sub22 - Decompiled by JODE
...
final class Class38_Sub22 extends Node {
	...
	static final int method723(byte i, KeyEvent keyevent) {
		try {
			if (i != -57)
			...
			throw Class38_Sub1.method607(runtimeexception, "la.D(" + i + ','
					+ (keyevent != null ? "{...}" : "null") + ')');
		}
	}
