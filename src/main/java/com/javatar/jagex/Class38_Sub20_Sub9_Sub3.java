package com.javatar.jagex;/* Class38_Sub20_Sub9_Sub3 - Decompiled by JODE
...
final class Class38_Sub20_Sub9_Sub3 extends Class38_Sub20_Sub9 {
	...
	private final void method1100(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
		if (i_4_ != 0) {
			i -= this.anInt3295 << 4;
					...
					if (i_22_ == 0) {
						if (i_21_ == 0) {
							...
							while (i_27_ < 0) {
								...
								int i_30_ = i_26_;
								int i_31_ = i_16_;
								if (i_29_ >= 0 && i_30_ >= 0 && i_29_ - (this.anInt3297 << 12) < 0 && i_30_ - (this.anInt3298 << 12) < 0)
									for (/**/; i_31_ < 0; i_31_++) {
										int i_32_ = this.anIntArray3300[(i_30_ >> 12) * this.anInt3297 + (i_29_ >> 12)];
										if (i_32_ != 0)
	...
	private static final void method1103(int[] is, int[] is_114_, int i, int i_115_, int i_116_, int i_117_, int i_118_, int i_119_, int i_120_, int i_121_, int i_122_, int i_123_, int i_124_) {
	...
	private static final void method1104(int[] is, int[] is_131_, int i, int i_132_, int i_133_, int i_134_, int i_135_, int i_136_, int i_137_) {
		int i_138_ = -(i_134_ >> 2);
		i_134_ = -(i_134_ & 0x3);
	...
	private static final void method1111(int[] is, int[] is_205_, int i, int i_206_, int i_207_, int i_208_, int i_209_, int i_210_, int i_211_, int i_212_, int i_213_, byte[] is_214_) {
		int i_215_ = -(i_209_ >> 2);
		i_209_ = -(i_209_ & 0x3);
	...
	private static final void method1113(int[] is, int[] is_227_, int i, int i_228_, int i_229_, int i_230_, int i_231_, int i_232_) {
	...
	private static final void method1115(int[] is, int[] is_239_, int i, int i_240_, int i_241_, int i_242_, int i_243_, int i_244_, int i_245_, int i_246_) {
	...
	private static final void method1117(int[] is, int[] is_253_, int i, int i_254_, int i_255_, int i_256_, int i_257_, int i_258_, int i_259_, int i_260_, int i_261_, int i_262_) {
		int i_263_ = i_254_;
	...
	private static final void method1119(int[] is, int[] is_270_, int i, int i_271_, int i_272_, int i_273_, int i_274_, int i_275_, int i_276_, int i_277_, int i_278_) {
	...
	final void method1122(int i, int i_297_, int i_298_, int i_299_) {
		if (i_298_ == 256)
			method1105(i, i_297_);
		else {
			i += this.anInt3295;
			...
			if (i_303_ > 0 && i_302_ > 0)
				Class38_Sub20_Sub9_Sub3.method1119(Class38_Sub20_Sub9.anIntArray2886, this.anIntArray3300, 0, i_301_, i_300_, i_303_, i_302_, i_304_, i_305_, i_298_, i_299_);
		}
	}
	...
	final void method1126(int i, int i_327_, int i_328_, int i_329_, int i_330_, int i_331_, double d, int i_332_) {
		try {
			int i_333_ = -i_328_ / 2;
			int i_334_ = -i_329_ / 2;
			int i_335_ = (int) (Math.sin(d) * 65536.0);
			int i_336_ = (int) (Math.cos(d) * 65536.0);
			i_335_ = i_335_ * i_332_ >> 8;
			i_336_ = i_336_ * i_332_ >> 8;
			int i_337_ = (i_330_ << 16) + i_334_ * i_335_ + i_333_ * i_336_;
			int i_338_ = (i_331_ << 16) + i_334_ * i_336_ - i_333_ * i_335_;
			int i_339_ = i + i_327_ * Class38_Sub20_Sub9.anInt2889;
			for (i_327_ = 0; i_327_ < i_329_; i_327_++) {
				int i_340_ = i_339_;
				int i_341_ = i_337_;
				int i_342_ = i_338_;
				for (i = -i_328_; i < 0; i++) {
