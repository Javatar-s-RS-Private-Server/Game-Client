package com.javatar;/* Class38_Sub10_Sub3 - Decompiled by JODE
...
final class Class38_Sub10_Sub3 extends Class38_Sub10 {
	...
	static final void method939() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "fe.F(" + -3072 + ')');
		}
	}

	static final void method940() {
		do {
			try {
				if (true) {
				...
				throw Class38_Sub1.method607(runtimeexception, "fe.C(" + true + ')');
			}
			break;
		} while (false);
	}
	...
	private void method938(int i, Class38_Sub22 class38_sub22) {
		try {
			if (0 != (aClass38_Sub10_Sub1_2832.anIntArray2636[class38_sub22.anInt2344] & 0x4) && class38_sub22.anInt2345 < 0) {
			...
			throw Class38_Sub1.method607(runtimeexception, "fe.D(" + i + ',' + 0 + ',' + (class38_sub22 != null ? "{...}" : "null") + ')');
		}
	}
	...
	final void method667(int[] is, int i, int i_3_) {
		try {
			...
			while_8_: for (/**/; class38_sub22 != null; class38_sub22 = (Class38_Sub22) this.aClass13_2828.method63(-3))
				if (!aClass38_Sub10_Sub1_2832.method862(class38_sub22)) {
					int i_4_ = i;
					int i_5_ = i_3_;
					while (i_5_ > class38_sub22.anInt2317) {
						method943(class38_sub22, is, i_4_, i_4_ + i_5_, class38_sub22.anInt2317);
					...
					method943(class38_sub22, is, i_4_, i_5_ + i_4_, i_5_);
	...
	private void method943(Class38_Sub22 class38_sub22, int[] is, int i, int i_12_, int i_13_) {
		try {
			if (-1 != (aClass38_Sub10_Sub1_2832.anIntArray2636[class38_sub22.anInt2344] & 0x4 ^ 0xffffffff) && class38_sub22.anInt2345 < 0) {
			...
			throw Class38_Sub1.method607(runtimeexception, "fe.H(" + (class38_sub22 != null ? "{...}" : "null") + ',' + (is != null ? "{...}" : "null") + ',' + i + ',' + -1 + ',' + i_12_ + ',' + i_13_ + ')');
		}
	}
}
