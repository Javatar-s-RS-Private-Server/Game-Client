package com.javatar;/* Class55 - Decompiled by JODE
...
final class Class55 {
	...
	private final byte[] aByteArray1219 = new byte[4];
	private final long aLong1229;
	private final Class65 aClass65_1231;
	...
	final byte[] method426() throws IOException {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "bc.B(" + false + ')');
		}
	}
}
