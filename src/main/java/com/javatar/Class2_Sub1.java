package com.javatar;/* Class2_Sub1 - Decompiled by JODE
...
final class Class2_Sub1 extends Class2 implements ImageProducer, ImageObserver {
		...
		try {
			try {
				...
				if (Class9.loginState == 8) {
					Class38_Sub12.anInt2118 = 0;
					Class77.method551(Class73_Sub2.aClass19_2304, Class9.method43(new RSString[]{RuntimeException_Sub1.method1098(Class74.anInt1451 / 60, 0), Class21.aClass19_505}, (byte) -20), Class38_Sub10_Sub1.aClass19_2648);
		...
		do {
			try {
				for (int i_5_ = 0; Class38_Sub20_Sub15.anInt3064 > i_5_; i_5_++) {
					...
					Class2_Sub1.method652(class38_sub20_sub3_sub7_sub2, i_6_, i_7_);
				}
				if (19135 == 19135)
					break;
	...
	private static void method652(Player class38_sub20_sub3_sub7_sub2, int i_20_, int i_21_) {
		do {
			try {
				if ((i_21_ & 0x400) != 0) {
				...
				if ((i_21_ & 0x10) != 0) {
					...
					if (class38_sub20_sub3_sub7_sub2.name != null && class38_sub20_sub3_sub7_sub2.appearance != null) {
						...
						if (!bool && Sequence.anInt2731 == 0) {
							...
							Class15.inputStream.method778(i_29_, Class38_Sub20_Sub12.aClass38_Sub23_2991.buffer);
							Class38_Sub20_Sub12.aClass38_Sub23_2991.pos = 0;
							RSString class19 = Class38_Sub20_Sub9_Sub1.method1062(Class58.method443((byte) 33, Class38_Sub20_Sub12.aClass38_Sub23_2991).method161());
							...
							if (i_28_ != 2 && i_28_ != 3) {
								if (i_28_ != 1)
									Class62.method464(class19, 2, class38_sub20_sub3_sub7_sub2.name);
								else
									Class62.method464(class19, 1, Class9.method43(new RSString[]{Class38_Sub20_Sub10.aClass19_2911, class38_sub20_sub3_sub7_sub2.name}, (byte) -20));
							} else
								Class62.method464(class19, 1, Class9.method43(new RSString[]{Class32.aClass19_775, class38_sub20_sub3_sub7_sub2.name}, (byte) -20));
						}
					}
				...
				if ((i_21_ & 0x40) != 0) {
					...
					Class15.inputStream.method760(is, i_34_);
				...
				throw Class38_Sub1.method607(runtimeexception, "g.H(" + (byte) 93 + ',' + (class38_sub20_sub3_sub7_sub2 != null ? "{...}" : "null") + ',' + i_20_ + ',' + i_21_ + ')');
			}
			break;
		} while (false);
	}
	...
	@Override
	final void method13(Graphics graphics) {
		try {
			method653();
			graphics.drawImage(this.anImage25, 0, 0, this);
			if (29504 != 29504)
				return;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "g.C(" + (graphics != null ? "{...}" : "null") + ',' + 29504 + ',' + 0 + ',' + 0 + ')');
		}
	}
	...
	private synchronized void method651(int i, int i_11_, int i_12_, int i_14_) {
		try {
			int i_15_ = 127 % ((115 - 9) / 36);
			...
			throw Class38_Sub1.method607(runtimeexception, "g.G(" + i + ',' + i_11_ + ',' + i_12_ + ',' + 115 + ',' + i_14_ + ')');
		}
	}
	...
	private synchronized void method653() {
		try {
			if (!true)
				Class2_Sub1.aClass19_2006 = null;
			if (anImageConsumer2005 != null) {
			...
			throw Class38_Sub1.method607(runtimeexception, "g.D(" + true + ')');
		}
	}
	...
	@Override
	final void method17(Graphics graphics, int i_37_, int i_38_, int i_39_, int i_40_) {
		try {
			method651(i_39_, i_37_, i_38_, i_40_);
			Shape shape = graphics.getClip();
			graphics.clipRect(i_39_, i_40_, i_37_, i_38_);
			graphics.drawImage(this.anImage25, 0, 0, this);
			graphics.setClip(shape);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "g.I(" + 0 + ',' + (graphics != null ? "{...}" : "null") + ',' + i_37_ + ',' + i_38_ + ',' + i_39_ + ',' + i_40_ + ')');
		}
	}
