package com.javatar;/* Class32 - Decompiled by JODE
...
abstract class Class32 {
	...
	static final void method296(Entity class38_sub20_sub3_sub7) {
		do {
			try {
				...
				if (class38_sub20_sub3_sub7.walkQueueLocationIndex == 0)
					...
					if ((class38_sub20_sub3_sub7.currentAnimationId ^ 0xffffffff) != 0 && class38_sub20_sub3_sub7.anInt3461 == 0) {
				...
				throw Class38_Sub1.method607(runtimeexception, "uf.F(" + (class38_sub20_sub3_sub7 != null ? "{...}" : "null") + ',' + 0 + ')');
			}
			break;
		} while (false);
	}
	...
	static final RSString method301(int i) {
		try {
			if ((byte) -90 != -90)
				Class32.aClass19_771 = null;
			return Class67.method479(10, i, true);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "uf.G(" + i + ',' + true + ',' + (byte) -90 + ')');
		}
	}

	abstract void method295(Component component);
