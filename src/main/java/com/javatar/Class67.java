package com.javatar;/* Class67 - Decompiled by JODE
...
final class Class67 {
	...
	static Class17_Sub1 indexTrack1;
	...
	static final void method478(int i, int i_1_, int i_2_) {
		try {
			if (Class72.anInt1417 >= 2 || Class42.anInt964 != 0 || Class26.aBool614) {
				...
				Class38_Sub11.aClass38_Sub20_Sub9_Sub1_Sub1_2093.method1071(class19, i_1_ + 4, i + 15, Class45.anInt1016 / 1000);
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final RSString method479(int i, int i_4_, boolean bool) {
		try {
			if (i < 1 || i > 36)
				i = 10;
			int i_5_ = 1;
			...
			throw Class38_Sub1.method607(runtimeexception, "rf.D(" + i + ',' + 0 + ',' + i_4_ + ',' + bool + ')');
		}
	}
