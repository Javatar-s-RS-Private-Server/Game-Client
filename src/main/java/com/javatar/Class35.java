package com.javatar;/* Class35 - Decompiled by JODE
			...
			try {
				try {
					if (Class73_Sub2.aClass55_2303 == null)
						...
						byte[] is = Class73_Sub2.aClass55_2303.method426();
						if (is != null) {
							RS2Buffer class38_sub23 = new RS2Buffer(is);
							Class49.anInt1089 = class38_sub23.readUnsignedShortLE();
	...
	static final int method317(int i, int i_2_, int i_3_, int i_4_) {
		try {
			...
			if (i_7_ < 3 && (Class82.aByteArrayArrayArray1648[1][i_5_][i_6_] & 0x2) == 2)
				i_7_++;
			int i_9_ = i_4_ & 0x7f;
			int i_10_ = i_8_ * Player.anIntArrayArrayArray3566[i_7_][i_5_ + 1][i_6_] + Player.anIntArrayArrayArray3566[i_7_][i_5_][i_6_] * (-i_8_ + 128) >> 7;
			int i_11_ = Player.anIntArrayArrayArray3566[i_7_][i_5_][i_6_ + 1] * (-i_8_ + 128) + Player.anIntArrayArrayArray3566[i_7_][i_5_ + 1][i_6_ + 1] * i_8_ >> 7;
			return i_10_ * (-i_9_ + 128) + i_11_ * i_9_ >> 7;
		} catch (RuntimeException runtimeexception) {
