package com.javatar;/* Class11 - Decompiled by JODE
...
final class Class11 {
	...
	static final void method55(int i) {
		do {
			try {
				if (Class26.aBool614) {
					Class38_Sub6 class38_sub6 = Class38_Sub20_Sub12.method987(Node.anInt893, Class2_Sub1.anInt2008);
	...
	static final void method56() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "pa.C(" + (byte) -26 + ')');
		}
	}
