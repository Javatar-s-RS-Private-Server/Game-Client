package com.javatar;/* Class5 - Decompiled by JODE
...
final class Class5 {
	...
	static Class17_Sub1 indexVarbits;
	...
	static final RSString method29(int i, int i_0_, RS2Buffer class38_sub23) {
		try {
			try {
				...
				class19.anInt478 = class38_sub23.method726();
				if (class19.anInt478 > i_0_)
					class19.anInt478 = i_0_;
				class19.buffer = new byte[class19.anInt478];
				class38_sub23.pos += Class41.aClass53_935.method410(i, class38_sub23.pos, class19.buffer, class19.anInt478, class38_sub23.buffer);
				return class19;
	...
	static final boolean method31(int i) {
		try {
			if (31278 != 31278)
				Class5.method29(-46, 14, null);
			return (i >> 30 & 0x1) != 0;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "of.A(" + i + ',' + 31278 + ')');
		}
	}

	static final void method32() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "of.C(" + false + ')');
		}
	}
}
