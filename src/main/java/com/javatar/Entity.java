package com.javatar;/* Entity - Decompiled by JODE
...
abstract class Entity extends SceneModel {
	...
	static final void method1172() {
		try {
			...
			Class78.aClass83_1547.method596(-1708 + 1601);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "qd.T(" + -1708 + ')');
		}
	}

	static final int method1174(int i, int i_4_) {
		try {
			if ((byte) -127 != -127)
				Entity.aClass83_3466 = null;
			int i_6_ = i >>> 31;
	...
	static final void method1177() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "qd.N(" + 0 + ')');
		}
	}
