package com.javatar;/* Class2_Sub2 - Decompiled by JODE
...
public final class Class2_Sub2 extends Class2 {
	...
	final void method13(Graphics graphics) {
		if (29504 == 29504)
			graphics.drawImage(this.anImage25, 0, 0, aComponent2200);
	}
	...
	@Override
	final void method17(Graphics graphics, int i_4_, int i_5_, int i_6_, int i_7_) {
