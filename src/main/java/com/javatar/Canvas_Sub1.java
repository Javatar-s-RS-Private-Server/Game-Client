package com.javatar;/* Canvas_Sub1 - Decompiled by JODE
...
final class Canvas_Sub1 extends Canvas {
	...
	private final Component aComponent2526;
		...
		try {
			...
			if (Class48.anInt1069 != i_0_) {
				...
				if (i_0_ != 5 && i_0_ != 10 && i_0_ != 20)
					Class38_Sub21.method715();
				else
					Class76.method544(Class52.indexBinary, Class17.indexSprites, Class38_Sub3.aCanvas1783);
	...
	static final void method810(byte[] is) {
		try {
			RS2Buffer class38_sub23 = new RS2Buffer(is);
			class38_sub23.pos = is.length - 2;
			Class38_Sub14.anInt2133 = class38_sub23.readUnsignedShortLE();
			...
			Class16.anInt339 = class38_sub23.readUnsignedShortLE();
			Projectile.anInt3426 = class38_sub23.readUnsignedShortLE();
			int i = (class38_sub23.getUByte() & 0xff) + 1;
			for (int i_1_ = 0; Class38_Sub14.anInt2133 > i_1_; i_1_++)
				Player.anIntArray3574[i_1_] = class38_sub23.readUnsignedShortLE();
			for (int i_2_ = 0; i_2_ < Class38_Sub14.anInt2133; i_2_++)
				Class51.anIntArray1130[i_2_] = class38_sub23.readUnsignedShortLE();
			for (int i_3_ = 0; Class38_Sub14.anInt2133 > i_3_; i_3_++)
				Class61.anIntArray1332[i_3_] = class38_sub23.readUnsignedShortLE();
			for (int i_4_ = 0; i_4_ < Class38_Sub14.anInt2133; i_4_++)
				Class38_Sub20_Sub8.anIntArray2873[i_4_] = class38_sub23.readUnsignedShortLE();
			...
			throw Class38_Sub1.method607(runtimeexception, "he.C(" + false + ',' + (is != null ? "{...}" : "null") + ')');
		}
	}

	static final void method811(Class38_Sub6[] class38_sub6s, int i_15_) {
		try {
			if ((byte) 40 != 40)
				Canvas_Sub1.method810(null);
			int i_16_ = 0;
				...
				if (class38_sub6 != null) {
					if (class38_sub6.anInt1868 == 0) {
						if (class38_sub6.aClass38_Sub6Array1867 != null)
							Canvas_Sub1.method811(class38_sub6.aClass38_Sub6Array1867, i_15_);
			...
			throw Class38_Sub1.method607(runtimeexception, "he.D(" + (byte) 40 + ',' + (class38_sub6s != null ? "{...}" : "null") + ',' + i_15_ + ')');
		}
	}
