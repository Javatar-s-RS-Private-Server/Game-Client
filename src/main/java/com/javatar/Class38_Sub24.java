package com.javatar;/* Class38_Sub24 - Decompiled by JODE
...
final class Class38_Sub24 extends Node {
	...
	private Class38_Sub24(RS2Buffer class38_sub23) {
		...
		int i_16_ = class38_sub23.readUnsignedShortLE();
		int i_17_ = i * 10 + 14;
		class38_sub23.pos = 0;
		int i_18_ = 0;
		int i_19_ = 0;
		...
		for (int i_77_ = 0; i_77_ < i; i_77_++) {
			...
			while_21_: do {
				for (;;) {
					int i_80_ = class38_sub23.method731();
					class38_sub23_69_.method775(i_80_);
					...
					if (i_5_ == 144) {
						...
						if (i_13_ > 0) {
							...
							if (class38_sub2 == null) {
								...
								this.aClass14_2417.method80(i_14_, class38_sub2);
							}
