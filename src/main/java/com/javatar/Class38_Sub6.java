package com.javatar;/* Class38_Sub6 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class Class38_Sub6 extends Node {
	...
	static {
		Class38_Sub6.aClass19_1939 = RSString.createRSString("Please reload this page)3");
		Class38_Sub6.aClass19_1970 = Class38_Sub6.aClass19_1939;
	}
	...
	int anInt1865;
	int[] anIntArray1866;
	Class38_Sub6[] aClass38_Sub6Array1867;
	int anInt1868;
	...
	int anInt1936;
	Class38_Sub6 aClass38_Sub6_1937;
	...
	public static void method638(byte i) {
		try {
			Class38_Sub6.aClass19_1970 = null;
			Class38_Sub6.aClass77_1857 = null;
			Class38_Sub6.aClass19_1880 = null;
			Class38_Sub6.anIntArrayArray1902 = null;
			int i_4_ = 94 / ((i + 76) / 49);
			Class38_Sub6.aClass19Array1945 = null;
			Class38_Sub6.aClass19_1939 = null;
			Class38_Sub6.anIntArray1967 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "f.D(" + i + ')');
		}
	}

	static final void method639(int i, int i_5_, int i_7_, int i_8_) {
		try {
			...
			if (class38_sub3 == null) {
				...
				Class38_Sub20_Sub8.aClass14_2863.method80(i, class38_sub3);
			}
			...
			if (-31820 != -31820)
				Class38_Sub6.method647(73, null, 117, 78);
			class38_sub3.anIntArray1781[i_5_] = i_8_;
			class38_sub3.anIntArray1779[i_5_] = i_7_;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "f.J(" + i + ',' + i_5_ + ',' + -31820 + ',' + i_7_ + ',' + i_8_ + ')');
		}
	}

	static final void method640(long l) {
		try {
			if (l != 0L) {
				if (1 != 1)
					Class38_Sub6.anIntArrayArray1902 = null;
			...
			throw Class38_Sub1.method607(runtimeexception, "f.H(" + l + ',' + 1 + ')');
		}
	}
	...
	final Class38_Sub20_Sub9_Sub3 method634(int i, boolean bool) {
		try {
			...
			if (i_0_ == -1)
				return null;
			long l = ((this.aBool1885 ? 1L : 0L) << 39) + ((this.aBool1927 ? 1L : 0L) << 38) + ((long) this.anInt1909 << 36) + i_0_ + ((long) this.anInt1930 << 40);
			...
			class38_sub20_sub9_sub3 = Class38_Sub6.method647(0, Class38_Sub19.aClass17_2230, i_0_, -1);
			if (class38_sub20_sub9_sub3 == null) {
	...
	private int[] method635(RS2Buffer class38_sub23) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "f.L(" + (class38_sub23 != null ? "{...}" : "null") + ',' + 16369 + ')');
		}
	}

	final void method636(RSString class19, int i) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "f.F(" + (class19 != null ? "{...}" : "null") + ',' + true + ',' + i + ')');
			}
			break;
		} while (false);
	}

	final Class38_Sub20_Sub9_Sub1_Sub1 method637() {
		try {
			Class42.aBool965 = false;
			if (this.anInt1920 == -1)
				return null;
			...
			throw Class38_Sub1.method607(runtimeexception, "f.A(" + false + ')');
		}
	}
	...
	final Class38_Sub20_Sub3_Sub1 method641(Class38_Sub20_Sub4 class38_sub20_sub4, int i, PlayerAppearance playerAppearance, int i_14_, boolean bool) {
		try {
			...
			if (i_15_ == 1 && i_16_ == -1)
				return null;
			Class38_Sub20_Sub3_Sub1 class38_sub20_sub3_sub1 = (Class38_Sub20_Sub3_Sub1) Class61.aClass83_1329.method591(-28825, (i_15_ << 16) + i_16_);
			if (class38_sub20_sub3_sub1 == null) {
				...
				if (i_15_ == 3) {
					if (playerAppearance == null)
						return null;
					Model class38_sub20_sub3_sub3 = playerAppearance.method133();
					if (class38_sub20_sub3_sub3 == null) {
						Class42.aBool965 = true;
						return null;
					}
				...
				Class61.aClass83_1329.method590((i_15_ << 16) + i_16_, (byte) -127, class38_sub20_sub3_sub1);
			}
			if (class38_sub20_sub4 != null)
				class38_sub20_sub3_sub1 = class38_sub20_sub4.method829(i_14_, class38_sub20_sub3_sub1);
	...
	final Class38_Sub20_Sub9_Sub3 method642(int i_17_) {
		try {
			Class42.aBool965 = false;
			...
			if (class38_sub20_sub9_sub3 != null)
				return class38_sub20_sub9_sub3;
			class38_sub20_sub9_sub3 = Class38_Sub6.method647(0, Class38_Sub19.aClass17_2230, i_18_, -1);
			if (class38_sub20_sub9_sub3 == null)
				Class42.aBool965 = true;
			else
			...
			throw Class38_Sub1.method607(runtimeexception, "f.M(" + 0 + ',' + i_17_ + ')');
		}
	}

	final void method643(RS2Buffer class38_sub23) {
		do {
			try {
				this.aBool1961 = false;
				this.anInt1868 = class38_sub23.getUByte();
				this.anInt1903 = class38_sub23.getUByte();
				this.anInt1958 = class38_sub23.readUnsignedShortLE();
				this.anInt1910 = this.anInt1942 = class38_sub23.method772();
				this.anInt1882 = this.anInt1968 = class38_sub23.method772();
				this.anInt1923 = class38_sub23.readUnsignedShortLE();
				this.anInt1886 = class38_sub23.readUnsignedShortLE();
				this.anInt1974 = class38_sub23.getUByte();
				this.anInt1977 = class38_sub23.readUnsignedShortLE();
				if (this.anInt1977 != 65535)
					this.anInt1977 = (this.anInt1856 & ~0xffff) + this.anInt1977;
				else
					this.anInt1977 = -1;
				this.anInt1865 = class38_sub23.readUnsignedShortLE();
				...
				if (i_19_ > 0) {
					...
					for (int i_20_ = 0; i_19_ > i_20_; i_20_++) {
						this.anIntArray1891[i_20_] = class38_sub23.getUByte();
						this.anIntArray1898[i_20_] = class38_sub23.readUnsignedShortLE();
					}
				}
				int i_21_ = class38_sub23.getUByte();
				if (i_21_ > 0) {
					...
					for (int i_22_ = 0; i_22_ < i_21_; i_22_++) {
						...
						for (int i_24_ = 0; i_24_ < i_23_; i_24_++) {
							this.anIntArrayArray1955[i_22_][i_24_] = class38_sub23.readUnsignedShortLE();
				...
				if (this.anInt1868 == 0) {
					this.anInt1933 = class38_sub23.readUnsignedShortLE();
					this.aBool1853 = class38_sub23.getUByte() == 1;
				}
				if (this.anInt1868 == 1) {
				...
				if (this.anInt1868 == 2) {
					...
					for (int i_29_ = 0; i_29_ < 20; i_29_++) {
						...
						if (i_30_ != 1)
							...
							this.anIntArray1922[i_29_] = class38_sub23.method772();
							this.anIntArray1858[i_29_] = class38_sub23.method772();
				...
				if (this.anInt1868 == 3)
					this.aBool1916 = class38_sub23.getUByte() == 1;
				if (this.anInt1868 == 4 || this.anInt1868 == 1) {
					this.anInt1954 = class38_sub23.getUByte();
					this.anInt1912 = class38_sub23.getUByte();
					this.anInt1951 = class38_sub23.getUByte();
					this.anInt1920 = class38_sub23.readUnsignedShortLE();
					if (this.anInt1920 == 65535)
						this.anInt1920 = -1;
					this.aBool1969 = class38_sub23.getUByte() == 1;
				}
				if (this.anInt1868 == 4) {
				...
				if (this.anInt1868 == 6) {
					this.anInt1883 = 1;
					this.anInt1962 = class38_sub23.readUnsignedShortLE();
					anInt1911 = 1;
					if (this.anInt1962 == 65535)
						this.anInt1962 = -1;
					anInt1924 = class38_sub23.readUnsignedShortLE();
					if (anInt1924 == 65535)
						anInt1924 = -1;
					this.anInt1878 = class38_sub23.readUnsignedShortLE();
					if (this.anInt1878 == 65535)
						this.anInt1878 = -1;
					this.anInt1900 = class38_sub23.readUnsignedShortLE();
					if (this.anInt1900 == 65535)
						this.anInt1900 = -1;
					this.anInt1921 = class38_sub23.readUnsignedShortLE();
					this.anInt1925 = class38_sub23.readUnsignedShortLE();
					this.anInt1987 = class38_sub23.readUnsignedShortLE();
				}
				if (this.anInt1868 == 7) {
					this.anIntArray1947 = new int[this.anInt1886 * this.anInt1923];
					...
					this.aBool1969 = class38_sub23.getUByte() == 1;
					this.anInt1889 = class38_sub23.readInt(true);
					this.anInt1931 = class38_sub23.method772();
					this.anInt1897 = class38_sub23.method772();
				...
				if (this.anInt1903 == 2 || this.anInt1868 == 2) {
					...
					int i_34_ = class38_sub23.readUnsignedShortLE() & 0x3f;
					this.anInt1881 |= i_34_ << 11;
				}
				...
				throw Class38_Sub1.method607(runtimeexception, "f.K(" + (class38_sub23 != null ? "{...}" : "null") + ',' + (byte) 115 + ')');
			}
			break;
		} while (false);
	}

	final void method644(int i, int i_35_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "f.N(" + i + ',' + true + ',' + i_35_ + ')');
		}
	}

	private Object[] method645(int i, RS2Buffer class38_sub23) {
		try {
			int i_37_ = class38_sub23.getUByte();
			if (i < 79)
				return null;
			if (i_37_ == 0)
				return null;
			...
			for (int i_38_ = 0; i_38_ < i_37_; i_38_++) {
				int i_39_ = class38_sub23.getUByte();
				if (i_39_ != 0) {
					if (i_39_ == 1)
						objects[i_38_] = class38_sub23.readString(1347418632);
				} else
					objects[i_38_] = class38_sub23.readInt(true);
			}
			this.aBool1960 = true;
			return objects;
		} catch (RuntimeException runtimeexception) {
	...
	final void method646(RS2Buffer class38_sub23) {
		try {
			class38_sub23.getUByte();
			this.aBool1961 = true;
			this.anInt1868 = class38_sub23.getUByte();
			...
			this.anInt1923 = class38_sub23.readUnsignedShortLE();
			if (this.anInt1868 == 9)
				this.anInt1886 = class38_sub23.method772();
			else
				this.anInt1886 = class38_sub23.readUnsignedShortLE();
			this.anInt1977 = class38_sub23.readUnsignedShortLE();
			if (this.anInt1977 == 65535)
			...
			this.aBool1853 = class38_sub23.getUByte() == 1;
			if (this.anInt1868 == 0) {
				this.anInt1973 = class38_sub23.readUnsignedShortLE();
				this.anInt1933 = class38_sub23.readUnsignedShortLE();
			}
			if (this.anInt1868 == 5) {
				this.anInt1932 = class38_sub23.readInt(true);
				this.anInt1890 = class38_sub23.readUnsignedShortLE();
				this.aBool1861 = class38_sub23.getUByte() == 1;
				this.anInt1974 = class38_sub23.getUByte();
				this.anInt1909 = class38_sub23.getUByte();
				this.anInt1930 = class38_sub23.readInt(true);
				this.aBool1927 = class38_sub23.getUByte() == 1;
				this.aBool1885 = class38_sub23.getUByte() == 1;
			}
			if (this.anInt1868 == 6) {
				this.anInt1883 = 1;
				this.anInt1962 = class38_sub23.readUnsignedShortLE();
				if (this.anInt1962 == 65535)
					this.anInt1962 = -1;
				this.anInt1929 = class38_sub23.method772();
				this.anInt1964 = class38_sub23.method772();
				this.anInt1925 = class38_sub23.readUnsignedShortLE();
				this.anInt1987 = class38_sub23.readUnsignedShortLE();
				this.anInt1863 = class38_sub23.readUnsignedShortLE();
				this.anInt1921 = class38_sub23.readUnsignedShortLE();
				this.anInt1878 = class38_sub23.readUnsignedShortLE();
				if (this.anInt1878 == 65535)
					this.anInt1878 = -1;
				this.aBool1966 = class38_sub23.getUByte() == 1;
			}
			if (this.anInt1868 == 4) {
				this.anInt1920 = class38_sub23.readUnsignedShortLE();
				if (this.anInt1920 == 65535)
					this.anInt1920 = -1;
				this.aClass19_1876 = class38_sub23.readString(-65536 + 1347484168);
				this.anInt1951 = class38_sub23.getUByte();
				this.anInt1954 = class38_sub23.getUByte();
				this.anInt1912 = class38_sub23.getUByte();
				this.aBool1969 = class38_sub23.getUByte() == 1;
			...
			this.anInt1873 = class38_sub23.getUByte();
			this.anInt1859 = class38_sub23.getUByte();
			this.aBool1975 = class38_sub23.getUByte() == 1;
			this.aClass19_1938 = class38_sub23.readString(1347418632);
			this.anObjectArray1980 = method645(-65536 + 65625, class38_sub23);
			...
			this.anObjectArray1950 = method645(-65536 ^ ~0xff88, class38_sub23);
			this.anObjectArray1913 = method645(81, class38_sub23);
			this.anObjectArray1864 = method645(-65536 + 65653, class38_sub23);
			...
			this.anObjectArray1949 = method645(-65536 + 65633, class38_sub23);
			...
			this.anObjectArray1984 = method645(-65536 + 65637, class38_sub23);
			this.anObjectArray1979 = method645(117, class38_sub23);
			this.anIntArray1934 = method635(class38_sub23);
			this.anIntArray1860 = method635(class38_sub23);
			this.anIntArray1988 = method635(class38_sub23);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "f.G(" + (class38_sub23 != null ? "{...}" : "null") + ',' + -65536 + ')');
		}
	}
}
