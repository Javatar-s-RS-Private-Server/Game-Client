package com.javatar;/* Class57 - Decompiled by JODE
...
final class Class57 {
	...
	private final int[] anIntArray1254 = new int[5];
	private final int[] anIntArray1255 = new int[5];
	private final int[] anIntArray1267;
	int anInt1262 = 0;
	int anInt1275;
	...
	final void method438(RS2Buffer class38_sub23) {
		...
		for (int i_0_ = 0; i_0_ < 10; i_0_++) {
			int i_1_ = class38_sub23.method726();
			if (i_1_ == 0)
				break;
			anIntArray1254[i_0_] = i_1_;
			anIntArray1267[i_0_] = class38_sub23.method737();
			anIntArray1255[i_0_] = class38_sub23.method726();
		}
		anInt1272 = class38_sub23.method726();
		anInt1268 = class38_sub23.method726();
		this.anInt1275 = class38_sub23.readUnsignedShortLE();
		this.anInt1262 = class38_sub23.readUnsignedShortLE();
	...
	private int method441(int i, int i_42_, int i_43_) {
		if (i_43_ == 1) {
			if ((i & 0x7fff) < 16384)
				return i_42_;
			return -i_42_;
