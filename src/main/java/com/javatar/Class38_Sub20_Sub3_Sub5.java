package com.javatar;/* Class38_Sub20_Sub3_Sub5 - Decompiled by JODE
...
final class Class38_Sub20_Sub3_Sub5 extends SceneModel {
	...
	static final Class38_Sub20_Sub9_Sub2 method1160(RSString class19, Class17 class17, RSString class19_19_) {
		try {
			if (false)
				Class38_Sub20_Sub3_Sub5.method1161(null, null, (byte) -1);
			int i = class17.method104(class19_19_);
			int i_20_ = class17.method118(class19, i, true);
			return Class33.method305(i_20_, i, class17);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "td.J(" + (class19 != null ? "{...}" : "null") + ',' + (class17 != null ? "{...}" : "null") + ',' + false + ',' + (class19_19_ != null ? "{...}" : "null") + ')');
		}
	}
	...
	final void method1162(int i_22_) {
		try {
			int i_23_ = -86 / ((-39 - (byte) -115) / 61);
			if (!this.aBool3377) {
				anInt3381 += i_22_;
			...
			throw Class38_Sub1.method607(runtimeexception, "td.I(" + (byte) -115 + ',' + i_22_ + ')');
		}
	}
	...
	final Class38_Sub20_Sub3_Sub1 method820() {
		try {
			...
			if (this.aBool3377)
				...
				class38_sub20_sub3_sub1 = class38_sub20_sub11.method984((byte) 109 + 17, anInt3385);
			return class38_sub20_sub3_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "td.E(" + (byte) 109 + ')');
		}
	}
}
