package com.javatar;/* Class38_Sub18 - Decompiled by JODE
...
final class Class38_Sub18 extends Node {
	...
	Class38_Sub18(byte[] is) {
		try {
			...
			for (int i_37_ = 0; i_37_ < 128; i_37_++) {
				i_35_ += class38_sub23.getUByte();
				this.aShortArray2212[i_37_] += i_35_ << 8;
			}
			int i_38_ = 0;
			int i_39_ = 0;
			int i_40_ = 0;
			for (int i_41_ = 0; i_41_ < 128; i_41_++) {
				if (i_38_ == 0) {
					if (i_40_ < is_33_.length)
						...
						i_38_ = -1;
					i_39_ = class38_sub23.method731();
				}
				i_38_--;
				this.aShortArray2212[i_41_] += Class38_Sub10_Sub3.method941(2, i_39_ - 1) << 14;
			...
			for (int i_45_ = 0; i_45_ < 128; i_45_++)
				if (anIntArray2222[i_45_] != 0) {
					if (i_38_ == 0) {
						i_44_ = class38_sub23.buffer[i_19_++] + 16 << 2;
			...
			if (is_30_ != null) {
				...
				for (int i_64_ = 0; i_64_ < i_62_; i_64_++)
					this.aByteArray2211[i_64_] = (byte) (i_63_ * this.aByteArray2211[i_64_] + 32 >> 6);
				int i_65_ = 2;
				while (is_30_.length > i_65_) {
					...
					for (int i_69_ = i_62_; i_66_ > i_69_; i_69_++) {
						int i_70_ = Entity.method1174(i_68_, i_66_ - i_62_);
						this.aByteArray2211[i_69_] = (byte) (this.aByteArray2211[i_69_] * i_70_ + 32 >> 6);
						i_68_ += i_67_ - i_63_;
					}
					i_62_ = i_66_;
					i_63_ = i_67_;
				...
				for (int i_71_ = i_62_; i_71_ < 128; i_71_++)
					this.aByteArray2211[i_71_] = (byte) (this.aByteArray2211[i_71_] * i_63_ + 32 >> 6);
			}
			if (is_32_ != null) {
				i_35_ = class38_sub23.getUByte();
				is_32_[0] = (byte) i_35_;
	...
	static final int method703(int i_10_, int i_11_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "kd.B(" + 0 + ',' + i_10_ + ',' + i_11_ + ')');
		}
	}

	final void method698() {
		try {
			anIntArray2222 = null;
			if (false)
				return;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "kd.A(" + false + ')');
		}
	}

	final boolean method701(Class79 class79, byte[] is, int[] is_5_) {
		try {
			boolean bool = true;
				...
				if (is == null || is[i_7_] != 0) {
					...
					if (i_8_ != 0) {
						if (i_6_ != i_8_) {
							i_6_ = i_8_;
							if ((--i_8_ & 0x1) == 0)
								class38_sub16_sub1 = class79.method572(i_8_ >> 2, is_5_);
							else
								class38_sub16_sub1 = class79.method573(is_5_, i_8_ >> 2);
			...
			throw Class38_Sub1.method607(runtimeexception, "kd.E(" + 1 + ',' + (class79 != null ? "{...}" : "null") + ',' + (is != null ? "{...}" : "null") + ',' + (is_5_ != null ? "{...}" : "null") + ')');
		}
	}
}
