package com.javatar;/* Class2 - Decompiled by JODE
...
abstract class Class2 {
	...
	static final void method16() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "gf.K(" + false + ')');
			}
			break;
		} while (false);
	}
	...
	abstract void method13(Graphics graphics);

	abstract void method15(int i, int i_2_, int i_3_, Component component);

	abstract void method17(Graphics graphics, int i_4_, int i_5_, int i_6_, int i_7_);
}
