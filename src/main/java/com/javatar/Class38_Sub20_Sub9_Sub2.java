package com.javatar;/* Class38_Sub20_Sub9_Sub2 - Decompiled by JODE
...
final class Class38_Sub20_Sub9_Sub2 extends Class38_Sub20_Sub9 {
	...
	private static void method1090(int[] is, byte[] is_12_, int[] is_13_, int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_) {
		int i_19_ = -(i_15_ >> 2);
		i_15_ = -(i_15_ & 0x3);
