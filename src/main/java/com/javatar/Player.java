package com.javatar;/* Class38_Sub20_Sub3_Sub7_Sub2 - Decompiled by JODE
...
final class Player extends Entity {
	...
	static final int method1206(int i_13_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ka.H(" + (byte) -98 + ','
					+ i_13_ + ')');
		}
	}
	...
	static final void method1207() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ka.G(" + (byte) 29 + ')');
		}
	}
	...
	final Class38_Sub20_Sub3_Sub1 method820() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "ka.E(" + (byte) 109 + ')');
		}
	}
