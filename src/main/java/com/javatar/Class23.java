package com.javatar;/* Class23 - Decompiled by JODE
...
final class Class23 {
	...
	static final void method199(int i, int i_1_, int i_2_, int i_3_) {
		try {
				...
				if (i_6_ != i_4_) {
					...
					if (i_7_ == 2 && RuntimeException_Sub1.aClass27_3292.method224(Client.height, i_8_, i_10_, i_6_) >= 0) {
						...
						if (Class42.anInt964 == 1)
							...
							if (Class44.aBool992)
								class19s = Class42.method361(class19s, -1 ^ ~0x3);
							if (class19s != null)
							...
							Class37.method328(class38_sub20_sub1.anInt2468 << 14, Class50.aClass19_1112, 3231, i_10_, 1002, Class9.method43(new RSString[] { Class38_Sub20_Sub11.aClass19_2928, class38_sub20_sub1.aClass19_2460 }, (byte) -20), i_8_);
						}
					}
					if (i_7_ == 1) {
						NPC class38_sub20_sub3_sub7_sub1 = Class53.aClass38_Sub20_Sub3_Sub7_Sub1Array1164[i_9_];
						if (class38_sub20_sub3_sub7_sub1.aClass38_Sub20_Sub5_3543.anInt2697 == 1 && (class38_sub20_sub3_sub7_sub1.anInt3493 & 0x7f) == 64 && (class38_sub20_sub3_sub7_sub1.anInt3444 & 0x7f) == 64) {
							for (int i_13_ = 0; i_13_ < Class4.anInt87; i_13_++) {
								...
								if (class38_sub20_sub3_sub7_sub1_14_ != null && class38_sub20_sub3_sub7_sub1_14_ != class38_sub20_sub3_sub7_sub1 && class38_sub20_sub3_sub7_sub1_14_.aClass38_Sub20_Sub5_3543.anInt2697 == 1 && class38_sub20_sub3_sub7_sub1.anInt3493 == class38_sub20_sub3_sub7_sub1_14_.anInt3493 && class38_sub20_sub3_sub7_sub1.anInt3444 == class38_sub20_sub3_sub7_sub1_14_.anInt3444)
									RSString.method154(i_8_, class38_sub20_sub3_sub7_sub1_14_.aClass38_Sub20_Sub5_3543, -1 ^ ~0x321, Class38_Sub10_Sub1.anIntArray2652[i_13_], i_10_);
							}
							for (int i_15_ = 0; ItemDefinition.anInt2783 > i_15_; i_15_++) {
								...
								if (class38_sub20_sub3_sub7_sub2 != null && class38_sub20_sub3_sub7_sub1.anInt3493 == class38_sub20_sub3_sub7_sub2.anInt3493 && class38_sub20_sub3_sub7_sub1.anInt3444 == class38_sub20_sub3_sub7_sub2.anInt3444)
					...
					if (i_7_ == 0) {
						...
						if ((class38_sub20_sub3_sub7_sub2.anInt3493 & 0x7f) == 64 && (class38_sub20_sub3_sub7_sub2.anInt3444 & 0x7f) == 64) {
							for (int i_16_ = 0; i_16_ < Class4.anInt87; i_16_++) {
								...
								if (class38_sub20_sub3_sub7_sub1 != null && class38_sub20_sub3_sub7_sub1.aClass38_Sub20_Sub5_3543.anInt2697 == 1 && class38_sub20_sub3_sub7_sub1.anInt3493 == class38_sub20_sub3_sub7_sub2.anInt3493 && class38_sub20_sub3_sub7_sub2.anInt3444 == class38_sub20_sub3_sub7_sub1.anInt3444)
							...
							for (int i_17_ = 0; i_17_ < ItemDefinition.anInt2783; i_17_++) {
								...
								if (class38_sub20_sub3_sub7_sub2_18_ != null && class38_sub20_sub3_sub7_sub2 != class38_sub20_sub3_sub7_sub2_18_ && class38_sub20_sub3_sub7_sub2_18_.anInt3493 == class38_sub20_sub3_sub7_sub2.anInt3493 && class38_sub20_sub3_sub7_sub2.anInt3444 == class38_sub20_sub3_sub7_sub2_18_.anInt3444)
									...
									if (!Class26.aBool614) {
										...
										for (int i_19_ = 4; i_19_ >= 0; i_19_--)
											if (class19s == null || class19s[i_19_] == null) {
												...
												if (i_19_ == 4)
													i_20_ = 36;
												Class37.method328(class38_sub20_sub3_sub4.anInt3348, class19s[i_19_], -1 ^ ~0xc9f, i_10_, i_20_, Class9.method43(new RSString[]{Class38_Sub11.aClass19_2082, class38_sub20_sub6.aClass19_2808}, (byte) -20), i_8_);
											}
			...
			throw Class38_Sub1.method607(runtimeexception, "mc.F(" + i + ',' + -1 + ',' + i_1_ + ',' + i_2_ + ',' + i_3_ + ')');
		}
	}

	static final void method200(int i, Class38_Sub6 class38_sub6, int i_21_, int i_22_, int i_24_, int i_25_, int i_26_) {
		do {
			try {
				if (114 > 105) {
				...
				throw Class38_Sub1.method607(runtimeexception, "mc.A(" + i + ',' + (class38_sub6 != null ? "{...}" : "null") + ',' + i_21_ + ',' + i_22_ + ',' + 114 + ',' + i_24_ + ',' + i_25_ + ',' + i_26_ + ')');
			}
			break;
		} while (false);
	}
	...
	static final Class38_Sub20_Sub13 method202(int i_31_) {
		try {
			...
			class38_sub20_sub13 = Class20.method190(Class47.aClass17_1061, Class82.aClass17_1643, i_31_);
			if (class38_sub20_sub13 != null)
			...
			throw Class38_Sub1.method607(runtimeexception, "mc.E(" + (byte) -122 + ',' + i_31_ + ')');
		}
	}

	static final void method203(Class17 class17, int i, boolean bool_32_, int i_33_, int i_34_, int i_35_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "mc.D(" + true + ',' + (class17 != null ? "{...}" : "null") + ',' + i + ',' + bool_32_ + ',' + i_33_ + ',' + i_34_ + ',' + i_35_ + ')');
		}
	}

	static final byte[] method204(byte[] is) {
		try {
			int i_36_ = is.length;
			...
			throw Class38_Sub1.method607(runtimeexception, "mc.B(" + 49 + ',' + (is != null ? "{...}" : "null") + ')');
		}
	}
}
