package com.javatar;/* Class25 - Decompiled by JODE
...
final class Class25 {
	...
	static final int method209(int i, int i_0_, int i_2_) {
		try {
			if ((byte) 35 != 35)
				Class25.method210(null, false, null, null, null);
			int i_3_ = -i_0_ + 256;
			return ((i & 0xff00ff) * i_0_ + (i_2_ & 0xff00ff) * i_3_ & ~0xff00ff) + (i_0_ * (i & 0xff00) + i_3_ * (i_2_ & 0xff00) & 0xff0000) >> 8;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "mb.B(" + i + ',' + i_0_ + ',' + (byte) 35 + ',' + i_2_ + ')');
		}
	}
	...
	static final void method211(Class38_Sub6[] class38_sub6s, int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
		try {
			...
			for (/**/; i_14_ < class38_sub6s.length; i_14_++) {
				...
				if (class38_sub6 != null && (!class38_sub6.aBool1961 || class38_sub6.anInt1868 == 0 || class38_sub6.aBool1960 || Class30.method283(-119, class38_sub6) != 0 || class38_sub6 == Class74.aClass38_Sub6_1463) && class38_sub6.anInt1977 == i_13_ && (!class38_sub6.aBool1961 || !Class43.method362(class38_sub6))) {
					...
					if (!class38_sub6.aBool1961 || i_18_ > i_17_ && i_19_ > i_20_)
						if (class38_sub6.anInt1958 == 1337)
							...
							Class33.method303(i_15_, i_16_);
						else {
							if (class38_sub6.anInt1868 == 0) {
								if (!class38_sub6.aBool1961 && Class43.method362(class38_sub6) && Class38_Sub2.aClass38_Sub6_1774 != class38_sub6)
									continue;
								...
								if (class38_sub8 != null)
									Projectile.method1168(class38_sub8.anInt2038, i_17_, i_20_, i_19_, i_16_, i_18_, i_15_);
							}
							...
							if (!class38_sub6.aBool1961) {
								...
								if (class38_sub6.anInt1933 > class38_sub6.anInt1886)
									Class23.method200(i_16_, class38_sub6, Class45.anInt1015, class38_sub6.anInt1923 + i_15_, class38_sub6.anInt1886, Class23.anInt543, class38_sub6.anInt1933);
							}
						}
				}
			}
