package com.javatar;/* Class42 - Decompiled by JODE
...
final class Class42 {
	...
	static final void method354() {
		try {
				...
				for (int i = 0; i < 256; i++)
					if (RS2Buffer.anInt2412 <= 768) {
						if (RS2Buffer.anInt2412 > 256)
							...
							Class83.anIntArray1652[i] = Class25.method209(Class44.anIntArray997[i], -RS2Buffer.anInt2412 + 256, Class38_Sub20_Sub11.anIntArray2962[i]);
					} else
						Class83.anIntArray1652[i] = Class25.method209(Class38_Sub20_Sub11.anIntArray2962[i], -RS2Buffer.anInt2412 + 1024, Class44.anIntArray997[i]);
			} else if (Class25.anInt594 > 0) {
				for (int i = 0; i < 256; i++)
					if (Class25.anInt594 > 768)
						Class83.anIntArray1652[i] = Class25.method209(Class67.anIntArray1385[i], -Class25.anInt594 + 1024, Class44.anIntArray997[i]);
					else if (Class25.anInt594 <= 256)
						Class83.anIntArray1652[i] = Class25.method209(Class44.anIntArray997[i], 256 - Class25.anInt594, Class67.anIntArray1385[i]);
					else
			...
			throw Class38_Sub1.method607(runtimeexception, "s.H(" + true + ')');
		}
	}

	private static RSString method355(int i, int i_18_) {
		try {
		...
		try {
			...
			for (/**/; class38_sub6s.length > i_28_; i_28_++) {
				...
				if (class38_sub6 != null && (i_22_ == class38_sub6.anInt1977 || i_22_ == -1412584499 && Class15.aClass38_Sub6_293 == class38_sub6)) {
					...
					if (!class38_sub6.aBool1961 || !Class43.method362(class38_sub6)) {
						if (class38_sub6.anInt1958 > 0)
							Class38_Sub20_Sub8.method951(class38_sub6);
						...
						if (!class38_sub6.aBool1961 || i_37_ > i_36_ && i_35_ < i_38_) {
							if (class38_sub6.anInt1958 != 0) {
								if (class38_sub6.anInt1958 == 1337) {
									...
									Class49.method394(class38_sub6.anInt1923, i_30_, class38_sub6.anInt1886, i_32_);
									Class38_Sub20_Sub9.method971(i_21_, i_26_, i_20_, i_27_);
									continue;
								}
							...
							if (!SceneModel.aBool2553 && i_36_ <= i_47_ && i_35_ <= i_48_ && i_37_ > i_47_ && i_38_ > i_48_)
								RuntimeException_Sub1.method1099(-i_32_ + i_48_, class38_sub6, i_47_ - i_30_);
							if (class38_sub6.anInt1868 == 0) {
								if (!class38_sub6.aBool1961 && Class43.method362(class38_sub6) && class38_sub6 != Class38_Sub2.aClass38_Sub6_1774)
									continue;
							...
							if (Class38_Sub20_Sub14.aBoolArray3036[i_29_] || Class38_Sub14.anInt2139 > 1) {
								...
								if (class38_sub6.anInt1868 != 1)
									if (class38_sub6.anInt1868 == 2) {
										...
										for (int i_50_ = 0; class38_sub6.anInt1886 > i_50_; i_50_++)
											for (int i_51_ = 0; i_51_ < class38_sub6.anInt1923; i_51_++) {
												...
												if (class38_sub6.anIntArray1947[i_49_] > 0) {
													...
													Class38_Sub20_Sub9_Sub3 class38_sub20_sub9_sub3 = class38_sub6.method642(i_49_);
													if (class38_sub20_sub9_sub3 == null) {
														if (Class42.aBool965)
										...
										Class38_Sub20_Sub9_Sub1_Sub1 class38_sub20_sub9_sub1_sub1 = class38_sub6.method637();
										if (class38_sub20_sub9_sub1_sub1 == null) {
											...
											if (!class38_sub6.aBool1961)
												class19 = Class29.method276(class38_sub6, class19);
										...
										if (class38_sub20_sub3_sub1 != null)
											if (!class38_sub6.aBool1961)
												class38_sub20_sub3_sub1.method1052(class38_sub6.anInt1987, 0, class38_sub6.anInt1925, 0, i_72_, i_73_);
											else {
												class38_sub20_sub3_sub1.method1043();
												if (class38_sub6.aBool1966)
													class38_sub20_sub3_sub1.method1048(class38_sub6.anInt1987, class38_sub6.anInt1863, class38_sub6.anInt1925, class38_sub6.anInt1929, i_71_ + i_72_ + class38_sub6.anInt1964, class38_sub6.anInt1964 + i_73_, class38_sub6.anInt1921);
												else
													class38_sub20_sub3_sub1.method1052(class38_sub6.anInt1987, class38_sub6.anInt1863, class38_sub6.anInt1925, class38_sub6.anInt1929, class38_sub6.anInt1964 + i_71_ + i_72_, i_73_ + class38_sub6.anInt1964);
											}
										...
										if (class38_sub6.anInt1868 == 9)
											if (class38_sub6.anInt1901 == 1)
												...
												int i_91_ = class38_sub6.anInt1923 >= 0 ? class38_sub6.anInt1923 : -class38_sub6.anInt1923;
												if (i_89_ > i_91_)
													i_91_ = i_89_;
												if (i_91_ != 0) {
			...
			try {
				if (i == -7) {
					if (Class38_Sub7.aClass77_2025 != null)
						Class38_Sub7.aClass77_2025.method556();
					if (Class38_Sub6.aClass77_1857 == null)
						break;
					Class38_Sub6.aClass77_1857.method556();
				}
			} catch (RuntimeException runtimeexception) {
			...
			try {
				for (Class38_Sub1 class38_sub1 = (Class38_Sub1) Class83.aClass13_1676.method65(91); class38_sub1 != null; class38_sub1 = (Class38_Sub1) Class83.aClass13_1676.method63(-3))
					if (class38_sub1.aClass38_Sub20_Sub1_1728 != null)
						class38_sub1.method609();
				if (true)
					break;
				Class42.method356(30, -81, 70, null, -128, 99, 108, -36, 22, 26);
			} catch (RuntimeException runtimeexception) {
				throw Class38_Sub1.method607(runtimeexception, "s.G(" + true + ')');
			}
			break;
		} while (false);
	}
