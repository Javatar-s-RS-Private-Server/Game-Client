package com.javatar;/* Class30 - Decompiled by JODE
...
final class Class30 {
	...
	static final int method283(int i, Class38_Sub6 class38_sub6) {
		try {
			if (i > -93)
				return 7;
			Class38_Sub11 class38_sub11 = (Class38_Sub11) Entity.aClass14_3514.method75(((long) class38_sub6.anInt1856 << 32) - -(long) class38_sub6.anInt1941);
	...
	private void method280() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "va.C(" + false + ')');
		}
	}
