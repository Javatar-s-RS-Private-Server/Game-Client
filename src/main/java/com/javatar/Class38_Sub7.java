package com.javatar;/* Class38_Sub7 - Decompiled by JODE
...
final class Class38_Sub7 extends Node {
	...
	static final int method655(int i, int i_0_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "e.A(" + i + ',' + i_0_ + ',' + true + ')');
		}
	}
