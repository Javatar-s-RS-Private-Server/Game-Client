package com.javatar;/* Class38_Sub11 - Decompiled by JODE
...
final class Class38_Sub11 extends Node {
	...
	static Class17_Sub1 indexFramemaps;
	...
	static final void method672(int i, int i_0_, int i_1_) {
		try {
			...
			if (Class15.anInt302 != 0 && i_0_ != -1) {
				Class38_Sub4.method628(Class38_Sub1.indexTrack2, -1, i_0_, Class15.anInt302, false, 0);
	...
	static final Class38_Sub20_Sub11 method673(int i, int i_2_) {
		try {
			...
			if (is != null)
				class38_sub20_sub11.method980(new RS2Buffer(is));
	...
	public static void method674(boolean bool) {
		try {
			...
			if (bool) {
				...
				Class38_Sub11.indexFramemaps = null;
