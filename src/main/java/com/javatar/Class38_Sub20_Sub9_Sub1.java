package com.javatar;/* Class38_Sub20_Sub9_Sub1 - Decompiled by JODE
...
abstract class Class38_Sub20_Sub9_Sub1 extends Class38_Sub20_Sub9 {
	...
	private static void method1063(byte[] is, int i, int i_25_, int i_26_, int i_27_, int i_28_) {
	...
	private static void method1077(byte[] is, int i, int i_114_, int i_115_, int i_116_, int i_117_, int i_118_) {
	...
	private static int method1087(byte[][] is, byte[][] is_181_, int[] is_182_, int[] is_183_, int[] is_184_, int i, int i_185_) {
		...
		for (int i_14_ = 0; i_14_ < class19.anInt478; i_14_++) {
			...
			if (i_15_ == 60)
				...
				if (i_15_ == 62 && i != -1) {
					...
					i = -1;
					if (class19_16_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3214))
						i_15_ = 60;
					else if (class19_16_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3221))
						i_15_ = 62;
					else {
						if (class19_16_.method165(Class38_Sub20_Sub9_Sub1.aClass19_3206))
							try {
	...
	private void method1064(RSString class19, int i) {
		int i_36_ = 0;
		boolean bool = false;
	...
	private void method1066(byte[] is) {
	...
	final void method1071(RSString class19, int i, int i_73_, int i_76_) {
		if (class19 != null) {
			method1073(16777215, 0);
	...
	private void method1072(RSString class19, int i, int i_79_, int[] is, int[] is_80_) {
		...
		for (int i_84_ = 0; i_84_ < class19.anInt478; i_84_++) {
			...
			if (i_85_ == 60)
				...
				if (i_85_ == 62 && i_81_ != -1) {
					...
					i_81_ = -1;
					if (class19_86_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3214))
						i_85_ = 60;
					else if (class19_86_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3221))
						i_85_ = 62;
					else {
						if (class19_86_.method165(Class38_Sub20_Sub9_Sub1.aClass19_3206))
							try {
								int i_87_;
								if (is != null)
									i_87_ = is[i_83_];
	...
	private void method1073(int i, int i_95_) {
		Class38_Sub20_Sub9_Sub1.anInt3226 = -1;
		Class38_Sub20_Sub9_Sub1.anInt3223 = -1;
	...
	private int method1074(RSString class19, int[] is, RSString[] class19s) {
		if (class19 == null)
			return 0;
		int i = 0;
		int i_96_ = 0;
		RSString class19_97_ = Class78.method564(100);
		int i_98_ = -1;
		int i_99_ = 0;
		int i_100_ = 0;
		int i_101_ = -1;
		...
		for (int i_105_ = 0; i_105_ < i_104_; i_105_++) {
			...
			if (i_106_ == 60)
				...
				if (i_106_ == 62 && i_101_ != -1) {
					...
					i_101_ = -1;
					class19_97_.method176(60);
					class19_97_.method146(class19_107_, (byte) 109);
					class19_97_.method176(62);
					if (class19_107_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3236)) {
						class19s[i_103_++] = class19_97_.method144((byte) 106, i_96_, class19_97_.method143((byte) 75));
						i_96_ = class19_97_.method143((byte) 37);
						i = 0;
						i_98_ = -1;
						i_102_ = -1;
					} else if (class19_107_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3214)) {
						i += method1068(60);
						if (aByteArray3230 != null && i_102_ != -1)
							i += aByteArray3230[(i_102_ << 8) + 60];
						i_102_ = 60;
					} else if (class19_107_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3221)) {
						i += method1068(62);
						if (aByteArray3230 != null && i_102_ != -1)
							i += aByteArray3230[(i_102_ << 8) + 62];
						i_102_ = 62;
					} else if (class19_107_.method165(Class38_Sub20_Sub9_Sub1.aClass19_3206))
						try {
	...
	final void method1075(RSString class19, int i, int i_109_, int i_110_, int i_112_) {
		if (class19 != null) {
			method1073(i_110_, 0);
			int[] is = new int[class19.anInt478];
	...
	private void method1076(RSString class19) {
		do {
			try {
				if (class19.method165(Class38_Sub20_Sub9_Sub1.aClass19_3207))
					Class38_Sub20_Sub9_Sub1.anInt3234 = class19.method171((byte) -30, 4).method159(16);
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3219))
					Class38_Sub20_Sub9_Sub1.anInt3234 = Class38_Sub20_Sub9_Sub1.anInt3211;
				else if (class19.method165(Class38_Sub20_Sub9_Sub1.aClass19_3225))
					Class38_Sub20_Sub9_Sub1.anInt3226 = class19.method171((byte) -75, 4).method159(16);
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3231))
					Class38_Sub20_Sub9_Sub1.anInt3226 = 8388608;
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3215))
					Class38_Sub20_Sub9_Sub1.anInt3226 = -1;
				else if (class19.method165(Class38_Sub20_Sub9_Sub1.aClass19_3218))
					Class38_Sub20_Sub9_Sub1.anInt3223 = class19.method171((byte) -61, 2).method159(16);
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3232))
					Class38_Sub20_Sub9_Sub1.anInt3223 = 0;
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3203))
					Class38_Sub20_Sub9_Sub1.anInt3223 = -1;
				else if (class19.method165(Class38_Sub20_Sub9_Sub1.aClass19_3212))
					Class38_Sub20_Sub9_Sub1.anInt3205 = class19.method171((byte) -40, 5).method159(16);
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3233))
					Class38_Sub20_Sub9_Sub1.anInt3205 = 0;
				else if (class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3224))
					Class38_Sub20_Sub9_Sub1.anInt3205 = Class38_Sub20_Sub9_Sub1.anInt3229;
				else {
					if (!class19.method175(Class38_Sub20_Sub9_Sub1.aClass19_3236))
						break;
	...
	private void method1078(RSString class19, int i, int i_126_) {
		...
		for (int i_129_ = 0; i_129_ < class19.anInt478; i_129_++) {
			...
			if (i_130_ == 60)
				...
				if (i_130_ == 62 && i_127_ != -1) {
					...
					i_127_ = -1;
					if (class19_131_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3214))
						i_130_ = 60;
					else if (class19_131_.method175(Class38_Sub20_Sub9_Sub1.aClass19_3221))
						i_130_ = 62;
					else {
						if (class19_131_.method165(Class38_Sub20_Sub9_Sub1.aClass19_3206))
							try {
	...
	final void method1080(RSString class19, int i, int i_140_, int i_141_, int i_143_) {
		if (class19 != null) {
			method1073(i_141_, 0);
			int[] is = new int[class19.anInt478];
	...
	final void method1083(RSString class19, int i, int i_150_, int i_151_, int i_153_, int i_154_) {
		if (class19 != null) {
			method1073(i_151_, 0);
