package com.javatar;/* Class58 - Decompiled by JODE
...
final class Class58 {
	...
	static final void method444(Class53 class53) {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "sd.C(" + (class53 != null ? "{...}" : "null") + ',' + 32767 + ')');
			}
			break;
		} while (false);
	}
	...
	static final Class38_Sub20_Sub9_Sub1_Sub1 method445(int i, Class17 class17, byte i_0_, Class17 class17_1_, int i_2_) {
		try {
			...
			return Class38_Sub10_Sub1.method853(class17.method109(i, i_2_, -109));
		} catch (RuntimeException runtimeexception) {
