package com.javatar;/* Class62 - Decompiled by JODE
...
final class Class62 {
	...
	static final void method461(int i, int i_0_, int i_1_, int i_3_) {
		try {
			int i_4_ = i;
			if (5037 == 5037)
			...
			throw Class38_Sub1.method607(runtimeexception, "lc.D(" + i + ',' + i_0_ + ',' + i_1_ + ',' + 5037 + ',' + i_3_ + ')');
		}
	}

	static final boolean method462(int i) {
		try {
			if ((byte) 19 <= 18)
				Class62.method465(34);
			return (i >= 97 && i <= 122) || (i >= 65 && i <= 90);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "lc.B(" + i + ',' + (byte) 19 + ')');
		}
	}

	static final void method463() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "lc.C(" + (byte) -82 + ')');
		}
	}

	static final void method464(RSString class19, int i_7_, RSString class19_8_) {
		try {
			if ((byte) 98 != 98)
				Class62.aClass17_1342 = null;
			Sequence.method914(class19_8_, i_7_, class19, null);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "lc.E(" + (byte) 98 + ',' + (class19 != null ? "{...}" : "null") + ',' + i_7_ + ',' + (class19_8_ != null ? "{...}" : "null") + ')');
		}
	}
