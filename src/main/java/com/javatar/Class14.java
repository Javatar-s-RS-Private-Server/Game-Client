package com.javatar;/* Class14 - Decompiled by JODE
...
final class Class14 {
	...
	private final Node[] aClass38Array268;
	...
	static final void method76() {
		try {
			...
			int i = Class15.inputStream.method785(1);
			if (true && i != 0) {
				int i_1_ = Class15.inputStream.method785(2);
				if (i_1_ == 0)
					...
					int i_7_ = Class15.inputStream.method785(7);
					int i_8_ = Class15.inputStream.method785(7);
	...
	static final boolean method79(int i, int i_14_, int i_15_) {
		try {
	...
	final void method80(long l, Node Node) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "wc.B(" + true + ','
					+ l + ',' + (Node != null ? "{...}" : "null") + ')');
		}
	}
	...
	final Node method81() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "wc.H(" + (byte) -36 + ')');
		}
	}
