package com.javatar;/* Class13 - Decompiled by JODE
...
final class Class13 {
	...
	static final boolean method64(int i) {
		try {
			if (-8956 != -8956)
				Class13.indexFonts = null;
			return (i >> 31 & 0x1) != 0;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "wd.L(" + i + ',' + -8956 + ')');
		}
	}

	static final boolean method66(int i) {
		try {
			if (i >= 97 && i <= 122)
				return true;
			if (-1 != -1)
			...
			throw Class38_Sub1.method607(runtimeexception, "wd.F(" + i + ',' + -1 + ')');
		}
	}
	...
	static final void method67() {
		do {
			try {
				...
				throw Class38_Sub1.method607(runtimeexception, "wd.A(" + false + ')');
			}
			break;
		} while (false);
	}
	...
	static final int method72(Class38_Sub6 class38_sub6, int i_23_) {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "wd.B(" + (byte) 23 + ',' + (class38_sub6 != null ? "{...}" : "null") + ',' + i_23_ + ')');
		}
	}
	...
	final void method58() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "wd.K(" + (byte) -19 + ')');
		}
	}
	...
	final Node method60() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "wd.H(" + (byte) 118 + ')');
		}
	}
	...
	final Node method62() {
		try {
			...
			throw Class38_Sub1.method607(runtimeexception, "wd.N(" + -1 + ')');
		}
	}
	...
	final void method70(Node Node, Node class38_22_) {
		try {
			if (Node.aClass38_890 != null)
				Node.method330(0);
			...
			throw Class38_Sub1.method607(runtimeexception, "wd.D(" + (Node != null ? "{...}" : "null") + ',' + (class38_22_ != null ? "{...}" : "null") + ',' + 119 + ')');
		}
	}
