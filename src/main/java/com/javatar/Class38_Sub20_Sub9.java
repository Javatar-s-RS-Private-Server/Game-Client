package com.javatar;/* Class38_Sub20_Sub9 - Decompiled by JODE
...
class Class38_Sub20_Sub9 extends NodeSub {
	...
	private static void method967(int i, int i_52_, int i_53_, int i_54_, int i_55_) {
	...
	private static void method972(int i, int i_77_, int i_78_, int i_79_, int i_80_) {
		if (i >= Class38_Sub20_Sub9.anInt2887 && i < Class38_Sub20_Sub9.anInt2890) {
	...
	static final void method974(int i, int i_96_, int[] is, int[] is_98_) {
		...
		for (i_96_ = 0; i_96_ < is.length; i_96_++) {
			...
			for (i = -is_98_[i_96_]; i < 0; i++)
				Class38_Sub20_Sub9.anIntArray2886[i_100_++] = 0;
