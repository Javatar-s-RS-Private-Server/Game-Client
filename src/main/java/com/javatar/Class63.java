package com.javatar;/* Class63 - Decompiled by JODE
...
public final class Class63 {
	private final File aFile1350;
	private final long aLong1353;
	private RandomAccessFile aRandomAccessFile1351;
	private long aLong1352;

	Class63(File file, long l) throws IOException {
		if (l == -1L)
			l = 9223372036854775807L;
		if (file.length() >= l)
			file.delete();
		aRandomAccessFile1351 = new RandomAccessFile(file, "rw");
		aLong1352 = 0L;
		aFile1350 = file;
		aLong1353 = l;
