package com.javatar;/* Class9 - Decompiled by JODE
...
final class Class9 {
	...
	static final void method44(Component component) {
		try {
			if (-24436 == -24436) {
			...
			throw Class38_Sub1.method607(runtimeexception, "hc.E(" + (component != null ? "{...}" : "null") + ',' + -24436 + ')');
		}
	}
	...
	static final Class38_Sub20_Sub9_Sub2 method49(Class17 class17, int i_6_) {
		try {
			if (!PacketBuffer.method791(class17, i_6_, (byte) 61))
				return null;
			if (-7450 != -7450)
				Class9.aClass19_159 = null;
			return Class44.method368();
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "hc.G(" + -7450 + ',' + (class17 != null ? "{...}" : "null") + ',' + i_6_ + ')');
		}
	}

	static final void method50(Class17 class17) {
		try {
			int i_7_ = -84 % ((-54 - (byte) -114) / 60);
			Class41.aClass17_933 = class17;
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "hc.C(" + (byte) -114 + ',' + (class17 != null ? "{...}" : "null") + ')');
		}
	}
	...
	static final void method51() {
		try {
			if (0 == 0)
				Class82.aClass83_1641.method596(0 + 33);
		} catch (RuntimeException runtimeexception) {
			throw Class38_Sub1.method607(runtimeexception, "hc.B(" + 0 + ')');
		}
	}
}
