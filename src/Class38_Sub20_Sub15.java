...
final class Class38_Sub20_Sub15 extends NodeSub {
	...
	static final void method1009(byte i) {
		try {
			...
			Class3.method19(client.myPlayer.anInt3444, client.myPlayer.anInt3493, Canvas_Sub1.anInt2529, 0, client.height);
			...
			if (i == -1)
				for (;;) {
					...
					if (class38_sub17 == null)
						break;
					class38_sub17.aClass17_Sub1_2196.method602(false, false, class38_sub17.aByteArray2191, (int) class38_sub17.aLong898, class38_sub17.aClass48_2187);
				}
		} catch (RuntimeException runtimeexception) {
